...
public class GetCurrentEventMasterResult implements IResult, Serializable {
	...
	public GetCurrentEventMasterResult withItem(CurrentEventMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentEventMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
