...
public class WithdrawByUserIdRequest extends Gs2BasicRequest<WithdrawByUserIdRequest> {
	...
	public WithdrawByUserIdRequest withWithdrawCount(Integer withdrawCount) {
		this.withdrawCount = withdrawCount;
		return this;
	}
    ...
    public static WithdrawByUserIdRequest fromJson(JsonNode data) {
        ...
        return new WithdrawByUserIdRequest()
            ...
            .withWithdrawCount(data.get("withdrawCount") == null || data.get("withdrawCount").isNull() ? null : data.get("withdrawCount").intValue())
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                ...
                put("slot", getSlot());
                put("withdrawCount", getWithdrawCount());
