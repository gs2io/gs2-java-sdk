...
public class AddLikesByUserIdRequest extends Gs2BasicRequest<AddLikesByUserIdRequest> {
	...
	public AddLikesByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public AddLikesByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public AddLikesByUserIdRequest withEntryModelNames(List<String> entryModelNames) {
		this.entryModelNames = entryModelNames;
		return this;
	}
	...
	public AddLikesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public AddLikesByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static AddLikesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
