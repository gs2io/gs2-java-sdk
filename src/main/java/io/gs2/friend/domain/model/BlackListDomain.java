...
public class BlackListDomain {
    ...
    public BlackListDomain register(
        RegisterBlackListByUserIdRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName)
            .withUserId(this.userId);
        RegisterBlackListByUserIdResult result = this.client.registerBlackListByUserId(
            request
        );
        ...
        if (result.getItem() != null) {
            cache.put(
                parentKey,
                io.gs2.friend.domain.model.BlackListDomain.createCacheKey(
                ),
                result.getItem(),
    ...
    public BlackListDomain unregister(
        UnregisterBlackListByUserIdRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName)
            .withUserId(this.userId);
        UnregisterBlackListByUserIdResult result = this.client.unregisterBlackListByUserId(
            request
        );
