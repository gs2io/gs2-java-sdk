...
public class GradeModelMaster implements IModel, Serializable, Comparable<GradeModelMaster> {
	...
	public GradeModelMaster withDefaultGrades(List<DefaultGradeModel> defaultGrades) {
		this.defaultGrades = defaultGrades;
		return this;
	}
	...
	public GradeModelMaster withGradeEntries(List<GradeEntryModel> gradeEntries) {
		this.gradeEntries = gradeEntries;
		return this;
	}
	...
	public GradeModelMaster withAcquireActionRates(List<AcquireActionRate> acquireActionRates) {
		this.acquireActionRates = acquireActionRates;
		return this;
	}
    ...
    public static GradeModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(GradeModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		GradeModelMaster other = (GradeModelMaster) o;
