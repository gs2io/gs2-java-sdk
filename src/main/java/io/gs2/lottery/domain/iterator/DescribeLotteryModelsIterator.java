...
public class DescribeLotteryModelsIterator implements Iterator<LotteryModel>, Iterable<LotteryModel> {
    CacheDatabase cache;
    ...
    public DescribeLotteryModelsIterator(
        CacheDatabase cache,
        Gs2LotteryRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeLotteryModelsResult r = this.client.describeLotteryModels(
