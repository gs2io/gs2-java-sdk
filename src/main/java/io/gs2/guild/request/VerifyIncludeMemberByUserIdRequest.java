...
public class VerifyIncludeMemberByUserIdRequest extends Gs2BasicRequest<VerifyIncludeMemberByUserIdRequest> {
    ...
    public static VerifyIncludeMemberByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
