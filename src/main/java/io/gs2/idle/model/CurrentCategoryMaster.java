...
public class CurrentCategoryMaster implements IModel, Serializable, Comparable<CurrentCategoryMaster> {
	...
	public CurrentCategoryMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentCategoryMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentCategoryMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentCategoryMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentCategoryMaster other = (CurrentCategoryMaster) o;
		if (namespaceId == null) {
