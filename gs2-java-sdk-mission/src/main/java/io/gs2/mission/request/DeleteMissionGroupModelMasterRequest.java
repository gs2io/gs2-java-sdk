...
public class DeleteMissionGroupModelMasterRequest extends Gs2BasicRequest<DeleteMissionGroupModelMasterRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ミッショングループマスターを削除
     */
     ...
     * ミッショングループ名を設定
     *
     * @param missionGroupName ミッショングループマスターを削除
     */
