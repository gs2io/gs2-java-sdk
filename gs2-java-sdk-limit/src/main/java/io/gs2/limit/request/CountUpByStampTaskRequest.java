...
public class CountUpByStampTaskRequest extends Gs2BasicRequest<CountUpByStampTaskRequest> {
     ...
     * スタンプタスクを設定
     *
     * @param stampTask スタンプシートでカウントアップ
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプシートでカウントアップ
     */
