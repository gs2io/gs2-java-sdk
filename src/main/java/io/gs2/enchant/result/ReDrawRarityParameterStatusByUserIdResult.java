...
public class ReDrawRarityParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public ReDrawRarityParameterStatusByUserIdResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}
	...
	public ReDrawRarityParameterStatusByUserIdResult withOld(RarityParameterStatus old) {
		this.old = old;
		return this;
	}

    public static ReDrawRarityParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
