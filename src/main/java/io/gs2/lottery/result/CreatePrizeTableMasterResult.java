...
public class CreatePrizeTableMasterResult implements IResult, Serializable {
	...
	public CreatePrizeTableMasterResult withItem(PrizeTableMaster item) {
		this.item = item;
		return this;
	}

    public static CreatePrizeTableMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
