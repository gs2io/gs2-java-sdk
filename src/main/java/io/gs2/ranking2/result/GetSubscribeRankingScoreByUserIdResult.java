...
public class GetSubscribeRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public GetSubscribeRankingScoreByUserIdResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static GetSubscribeRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
