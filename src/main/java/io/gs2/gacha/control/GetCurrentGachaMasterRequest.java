...
public class GetCurrentGachaMasterRequest extends Gs2BasicRequest<GetCurrentGachaMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetCurrentGachaMaster";
	}
	 ...
	 * @return this
	 */
	public GetCurrentGachaMasterRequest withGachaPoolName(String gachaPoolName) {
