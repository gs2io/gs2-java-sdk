...
public class VerifyGradeUpMaterialRequest extends Gs2BasicRequest<VerifyGradeUpMaterialRequest> {
    ...
    public static VerifyGradeUpMaterialRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
