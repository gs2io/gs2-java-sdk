...
public class DescribeMutexesByUserIdResult implements IResult, Serializable {
	...
	public DescribeMutexesByUserIdResult withItems(List<Mutex> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeMutexesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeMutexesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
