...
public class GetBalanceParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public GetBalanceParameterStatusByUserIdResult withItem(BalanceParameterStatus item) {
		this.item = item;
		return this;
	}

    public static GetBalanceParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
