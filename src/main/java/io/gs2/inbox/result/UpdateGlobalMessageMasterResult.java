...
public class UpdateGlobalMessageMasterResult implements IResult, Serializable {
	...
	public UpdateGlobalMessageMasterResult withItem(GlobalMessageMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateGlobalMessageMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
