...
public class DescribeQuestGroupModelMastersResult implements IResult, Serializable {
	...
	public DescribeQuestGroupModelMastersResult withItems(List<QuestGroupModelMaster> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeQuestGroupModelMastersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeQuestGroupModelMastersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeQuestGroupModelMastersResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<QuestGroupModelMaster>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<QuestGroupModelMaster>() :
