...
public class GetRarityParameterModelMasterRequest extends Gs2BasicRequest<GetRarityParameterModelMasterRequest> {
    ...
    public static GetRarityParameterModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
