...
public class DescribeFormsByUserIdRequest extends Gs2BasicRequest<DescribeFormsByUserIdRequest> {
	...
	public DescribeFormsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeFormsByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeFormsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
