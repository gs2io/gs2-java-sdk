...
public class StartStateMachineByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public StartStateMachineByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static StartStateMachineByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
