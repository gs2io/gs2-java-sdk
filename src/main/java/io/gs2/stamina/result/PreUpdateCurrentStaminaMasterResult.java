...
public class PreUpdateCurrentStaminaMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentStaminaMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentStaminaMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentStaminaMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
