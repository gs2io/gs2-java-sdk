...
public class ForceReDrawByUserIdRequest extends Gs2BasicRequest<ForceReDrawByUserIdRequest> {
	...
	public ForceReDrawByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static ForceReDrawByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
