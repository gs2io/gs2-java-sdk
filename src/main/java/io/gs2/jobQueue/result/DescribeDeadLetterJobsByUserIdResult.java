...
public class DescribeDeadLetterJobsByUserIdResult implements IResult, Serializable {
	...
	public DescribeDeadLetterJobsByUserIdResult withItems(List<DeadLetterJob> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeDeadLetterJobsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeDeadLetterJobsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeDeadLetterJobsByUserIdResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<DeadLetterJob>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<DeadLetterJob>() :
