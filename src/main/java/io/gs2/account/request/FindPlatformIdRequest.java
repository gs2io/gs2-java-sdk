...
public class FindPlatformIdRequest extends Gs2BasicRequest<FindPlatformIdRequest> {
	...
	public FindPlatformIdRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public FindPlatformIdRequest withType(Integer type) {
		this.type = type;
		return this;
	}
    ...
    public static FindPlatformIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
