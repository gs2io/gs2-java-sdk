...
public class AcquireActionsToPropertyFormPropertiesResult implements IResult, Serializable {
	...
	public AcquireActionsToPropertyFormPropertiesResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
	...
	public AcquireActionsToPropertyFormPropertiesResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public AcquireActionsToPropertyFormPropertiesResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public AcquireActionsToPropertyFormPropertiesResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public AcquireActionsToPropertyFormPropertiesResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public AcquireActionsToPropertyFormPropertiesResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static AcquireActionsToPropertyFormPropertiesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
