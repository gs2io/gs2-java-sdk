...
public class PreUpdateCurrentMissionMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentMissionMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentMissionMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentMissionMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
