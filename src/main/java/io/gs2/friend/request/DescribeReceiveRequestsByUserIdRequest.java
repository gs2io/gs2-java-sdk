...
public class DescribeReceiveRequestsByUserIdRequest extends Gs2BasicRequest<DescribeReceiveRequestsByUserIdRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return ユーザーIDを指定して受信したフレンドリクエストの一覧を取得
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定して受信したフレンドリクエストの一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定して受信したフレンドリクエストの一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定して受信したフレンドリクエストの一覧を取得
     */
