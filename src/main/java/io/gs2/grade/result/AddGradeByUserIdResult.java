...
public class AddGradeByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public AddGradeByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public AddGradeByUserIdResult withExperienceStatus(io.gs2.experience.model.Status experienceStatus) {
		this.experienceStatus = experienceStatus;
		return this;
	}

    public static AddGradeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
