...
public class DeleteRarityParameterModelMasterRequest extends Gs2BasicRequest<DeleteRarityParameterModelMasterRequest> {
    ...
    public static DeleteRarityParameterModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
