...
public class DeleteByStampTaskResult implements IResult, Serializable {
    private Job item;
	...
	public DeleteByStampTaskResult withItem(Job item) {
		this.item = item;
		return this;
	}
	...
	public DeleteByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static DeleteByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
