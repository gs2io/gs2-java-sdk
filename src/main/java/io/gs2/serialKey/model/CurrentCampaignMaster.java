...
public class CurrentCampaignMaster implements IModel, Serializable, Comparable<CurrentCampaignMaster> {
	...
	public CurrentCampaignMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentCampaignMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentCampaignMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentCampaignMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentCampaignMaster other = (CurrentCampaignMaster) o;
		if (namespaceId == null) {
