...
public class DescribeDataObjectHistoriesByUserIdResult implements IResult, Serializable {
	...
	public DescribeDataObjectHistoriesByUserIdResult withItems(List<DataObjectHistory> items) {
		this.items = items;
		return this;
	}
    ...
    public static DescribeDataObjectHistoriesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
