...
public class PreUpdateCurrentGuildMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentGuildMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentGuildMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentGuildMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
