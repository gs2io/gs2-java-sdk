...
public class GetGlobalRankingReceivedRewardRequest extends Gs2BasicRequest<GetGlobalRankingReceivedRewardRequest> {
    ...
    public static GetGlobalRankingReceivedRewardRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
