...
public class CreateStatusModelMasterResult implements IResult, Serializable {
	...
	public CreateStatusModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateStatusModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
