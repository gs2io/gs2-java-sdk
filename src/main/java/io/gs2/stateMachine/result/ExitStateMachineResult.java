...
public class ExitStateMachineResult implements IResult, Serializable {
    private Status item;
	...
	public ExitStateMachineResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static ExitStateMachineResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
