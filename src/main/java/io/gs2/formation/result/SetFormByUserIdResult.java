...
public class SetFormByUserIdResult implements IResult, Serializable {
    private Form item;
    private Mold mold;
	...
	public SetFormByUserIdResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public SetFormByUserIdResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public SetFormByUserIdResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public SetFormByUserIdResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static SetFormByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
