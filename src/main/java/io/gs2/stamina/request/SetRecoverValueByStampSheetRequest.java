...
public class SetRecoverValueByStampSheetRequest extends Gs2BasicRequest<SetRecoverValueByStampSheetRequest> {
    ...
    public static SetRecoverValueByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
