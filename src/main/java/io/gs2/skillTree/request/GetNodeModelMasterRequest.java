...
public class GetNodeModelMasterRequest extends Gs2BasicRequest<GetNodeModelMasterRequest> {
    ...
    public static GetNodeModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
