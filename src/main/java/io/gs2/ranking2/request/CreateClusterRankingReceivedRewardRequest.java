...
public class CreateClusterRankingReceivedRewardRequest extends Gs2BasicRequest<CreateClusterRankingReceivedRewardRequest> {
    ...
    public static CreateClusterRankingReceivedRewardRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
