...
public class GetClusterRankingModelResult implements IResult, Serializable {
	...
	public GetClusterRankingModelResult withItem(ClusterRankingModel item) {
		this.item = item;
		return this;
	}

    public static GetClusterRankingModelResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
