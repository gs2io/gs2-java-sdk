...
public class CreateTakeOverOpenIdConnectRequest extends Gs2BasicRequest<CreateTakeOverOpenIdConnectRequest> {
	...
	public CreateTakeOverOpenIdConnectRequest withType(Integer type) {
		this.type = type;
		return this;
	}
    ...
    public static CreateTakeOverOpenIdConnectRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
