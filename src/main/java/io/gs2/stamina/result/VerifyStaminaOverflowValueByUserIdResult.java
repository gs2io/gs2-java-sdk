...
public class VerifyStaminaOverflowValueByUserIdResult implements IResult, Serializable {
	...
	public VerifyStaminaOverflowValueByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}

    public static VerifyStaminaOverflowValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
