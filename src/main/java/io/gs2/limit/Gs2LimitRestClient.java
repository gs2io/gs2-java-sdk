...
public class Gs2LimitRestClient extends AbstractGs2Client<Gs2LimitRestClient> {
    ...
    class PreUpdateCurrentLimitMasterTask extends Gs2RestSessionTask<PreUpdateCurrentLimitMasterResult> {
        private PreUpdateCurrentLimitMasterRequest request;

        public PreUpdateCurrentLimitMasterTask(
            PreUpdateCurrentLimitMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentLimitMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentLimitMasterResult parse(JsonNode data) {
            return PreUpdateCurrentLimitMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentLimitMasterAsync(
            PreUpdateCurrentLimitMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentLimitMasterResult>> callback
    ) {
        PreUpdateCurrentLimitMasterTask task = new PreUpdateCurrentLimitMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentLimitMasterResult preUpdateCurrentLimitMaster(
            PreUpdateCurrentLimitMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentLimitMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentLimitMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentLimitMasterTask extends Gs2RestSessionTask<UpdateCurrentLimitMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentLimitMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentLimitMasterTask task = new PreUpdateCurrentLimitMasterTask(
