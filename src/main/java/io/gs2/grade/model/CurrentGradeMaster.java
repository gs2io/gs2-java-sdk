...
public class CurrentGradeMaster implements IModel, Serializable, Comparable<CurrentGradeMaster> {
	...
	public CurrentGradeMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentGradeMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentGradeMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentGradeMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentGradeMaster other = (CurrentGradeMaster) o;
		if (namespaceId == null) {
