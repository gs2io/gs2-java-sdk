...
public class ReceiveByStampSheetResult implements IResult, Serializable {
	...
	public ReceiveByStampSheetResult withItems(List<AcquireAction> items) {
		this.items = items;
		return this;
	}
	...
	public ReceiveByStampSheetResult withStatus(Status status) {
		this.status = status;
		return this;
	}
	...
	public ReceiveByStampSheetResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public ReceiveByStampSheetResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public ReceiveByStampSheetResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public ReceiveByStampSheetResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public ReceiveByStampSheetResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public ReceiveByStampSheetResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public ReceiveByStampSheetResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static ReceiveByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
