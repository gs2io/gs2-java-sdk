...
public class UpdateRoomResult implements IResult, Serializable {
    private Room item;
	...
	public UpdateRoomResult withItem(Room item) {
		this.item = item;
		return this;
	}

    public static UpdateRoomResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
