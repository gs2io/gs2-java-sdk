...
public class GetSalesItemMasterRequest extends Gs2BasicRequest<GetSalesItemMasterRequest> {
    ...
    public static GetSalesItemMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
