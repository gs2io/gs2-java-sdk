...
public class GetBuffEntryModelRequest extends Gs2BasicRequest<GetBuffEntryModelRequest> {
	...
	public GetBuffEntryModelRequest withBuffEntryName(String buffEntryName) {
		this.buffEntryName = buffEntryName;
		return this;
	}

    public static GetBuffEntryModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
