...
public class PrepareUpdateCurrentNewsMasterFromGitHubResult implements IResult, Serializable {
    ...
    public static PrepareUpdateCurrentNewsMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
