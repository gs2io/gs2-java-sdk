...
public class DeleteTriggerByStampTaskRequest extends Gs2BasicRequest<DeleteTriggerByStampTaskRequest> {
    ...
    public static DeleteTriggerByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
