...
public class DeleteBigInventoryModelMasterRequest extends Gs2BasicRequest<DeleteBigInventoryModelMasterRequest> {
	...
	public DeleteBigInventoryModelMasterRequest withInventoryName(String inventoryName) {
		this.inventoryName = inventoryName;
		return this;
	}

    public static DeleteBigInventoryModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
