...
public class AddSubscribeResult implements IResult, Serializable {
	...
	public AddSubscribeResult withItem(SubscribeUser item) {
		this.item = item;
		return this;
	}

    public static AddSubscribeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
