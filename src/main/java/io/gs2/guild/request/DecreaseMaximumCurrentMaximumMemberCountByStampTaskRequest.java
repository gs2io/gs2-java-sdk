...
public class DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest extends Gs2BasicRequest<DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest> {
	...
	public DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
