...
public class UpdateSimpleInventoryModelMasterResult implements IResult, Serializable {
	...
	public UpdateSimpleInventoryModelMasterResult withItem(SimpleInventoryModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateSimpleInventoryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
