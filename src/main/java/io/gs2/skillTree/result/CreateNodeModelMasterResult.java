...
public class CreateNodeModelMasterResult implements IResult, Serializable {
	...
	public CreateNodeModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateNodeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
