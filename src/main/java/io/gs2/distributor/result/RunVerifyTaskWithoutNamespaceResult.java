...
public class RunVerifyTaskWithoutNamespaceResult implements IResult, Serializable {
	...
	public RunVerifyTaskWithoutNamespaceResult withContextStack(String contextStack) {
		this.contextStack = contextStack;
		return this;
	}
	...
	public RunVerifyTaskWithoutNamespaceResult withStatusCode(Integer statusCode) {
		this.statusCode = statusCode;
		return this;
	}
	...
	public RunVerifyTaskWithoutNamespaceResult withResult(String result) {
		this.result = result;
		return this;
	}

    public static RunVerifyTaskWithoutNamespaceResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
