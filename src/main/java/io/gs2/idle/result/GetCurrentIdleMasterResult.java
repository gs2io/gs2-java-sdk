...
public class GetCurrentIdleMasterResult implements IResult, Serializable {
	...
	public GetCurrentIdleMasterResult withItem(CurrentCategoryMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentIdleMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
