...
public class DescribeKeysRequest extends Gs2BasicRequest<DescribeKeysRequest> {
	...
	public DescribeKeysRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeKeysRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeKeysRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
