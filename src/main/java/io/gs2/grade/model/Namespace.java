...
public class Namespace implements IModel, Serializable, Comparable<Namespace> {
	...
	public ScriptSetting getChangeGradeScript() {
		return changeGradeScript;
	}
	public void setChangeGradeScript(ScriptSetting changeGradeScript) {
		this.changeGradeScript = changeGradeScript;
	}
	public Namespace withChangeGradeScript(ScriptSetting changeGradeScript) {
		this.changeGradeScript = changeGradeScript;
		return this;
	}
    ...
    public static Namespace fromJson(JsonNode data) {
        ...
        return new Namespace()
            ...
            .withChangeGradeScript(data.get("changeGradeScript") == null || data.get("changeGradeScript").isNull() ? null : ScriptSetting.fromJson(data.get("changeGradeScript")))
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                ...
                put("changeGradeScript", getChangeGradeScript() != null ? getChangeGradeScript().toJson() : null);
	...
	public int hashCode() {
        ...
        result = prime * result + ((this.changeGradeScript == null) ? 0 : this.changeGradeScript.hashCode());
	...
	public boolean equals(Object o) {
		...
		if (changeGradeScript == null) {
			return other.changeGradeScript == null;
		} else if (!changeGradeScript.equals(other.changeGradeScript)) {
			return false;
		}
		if (logSetting == null) {
