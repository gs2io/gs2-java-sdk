...
public class WithdrawalByUserIdResult implements IResult, Serializable {
	...
	public void setItem(JoinedGuild item) {
		this.item = item;
	}

	public WithdrawalByUserIdResult withItem(JoinedGuild item) {
		this.item = item;
		return this;
	}
	...
	public WithdrawalByUserIdResult withGuild(Guild guild) {
		this.guild = guild;
		return this;
	}

    public static WithdrawalByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new WithdrawalByUserIdResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : JoinedGuild.fromJson(data.get("item")))
