...
public class CountExecuteStampSheetLogRequest extends Gs2BasicRequest<CountExecuteStampSheetLogRequest> {
	...
	public CountExecuteStampSheetLogRequest withService(String service) {
		this.service = service;
		return this;
	}
	...
	public CountExecuteStampSheetLogRequest withMethod(String method) {
		this.method = method;
		return this;
	}
	...
	public CountExecuteStampSheetLogRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public CountExecuteStampSheetLogRequest withAction(String action) {
		this.action = action;
		return this;
	}
