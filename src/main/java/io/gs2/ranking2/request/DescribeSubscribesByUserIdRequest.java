...
public class DescribeSubscribesByUserIdRequest extends Gs2BasicRequest<DescribeSubscribesByUserIdRequest> {
	...
	public DescribeSubscribesByUserIdRequest withRankingName(String rankingName) {
		this.rankingName = rankingName;
		return this;
	}
	...
	public DescribeSubscribesByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeSubscribesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeSubscribesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
