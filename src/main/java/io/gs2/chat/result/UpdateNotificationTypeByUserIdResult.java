...
public class UpdateNotificationTypeByUserIdResult implements IResult, Serializable {
    ...
    public static UpdateNotificationTypeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
