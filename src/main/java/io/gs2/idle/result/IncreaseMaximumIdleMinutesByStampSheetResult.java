...
public class IncreaseMaximumIdleMinutesByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public IncreaseMaximumIdleMinutesByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static IncreaseMaximumIdleMinutesByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
