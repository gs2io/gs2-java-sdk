...
public class GetCampaignModelMasterRequest extends Gs2BasicRequest<GetCampaignModelMasterRequest> {
    ...
    public static GetCampaignModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
