...
public class VerifyInventoryCurrentMaxCapacityByStampTaskResult implements IResult, Serializable {
	...
	public VerifyInventoryCurrentMaxCapacityByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyInventoryCurrentMaxCapacityByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
