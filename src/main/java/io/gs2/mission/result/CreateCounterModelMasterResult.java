...
public class CreateCounterModelMasterResult implements IResult, Serializable {
	...
	public CreateCounterModelMasterResult withItem(CounterModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateCounterModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new CreateCounterModelMasterResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : CounterModelMaster.fromJson(data.get("item")));
    }
