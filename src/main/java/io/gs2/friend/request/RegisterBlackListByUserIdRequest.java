...
public class RegisterBlackListByUserIdRequest extends Gs2BasicRequest<RegisterBlackListByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定してブラックリストに登録
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定してブラックリストに登録
     */
     ...
     * Noneを設定
     *
     * @param targetUserId ユーザーIDを指定してブラックリストに登録
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してブラックリストに登録
     */
