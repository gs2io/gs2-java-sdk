...
public class GetStampSheetResultRequest extends Gs2BasicRequest<GetStampSheetResultRequest> {
    ...
    public static GetStampSheetResultRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
