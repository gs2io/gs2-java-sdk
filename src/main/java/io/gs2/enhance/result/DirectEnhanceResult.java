...
public class DirectEnhanceResult implements IResult, Serializable {
	...
	public DirectEnhanceResult withItem(RateModel item) {
		this.item = item;
		return this;
	}
	...
	public DirectEnhanceResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public DirectEnhanceResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public DirectEnhanceResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public DirectEnhanceResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public DirectEnhanceResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}
	...
	public DirectEnhanceResult withAcquireExperience(Long acquireExperience) {
		this.acquireExperience = acquireExperience;
		return this;
	}
	...
	public DirectEnhanceResult withBonusRate(Float bonusRate) {
		this.bonusRate = bonusRate;
		return this;
	}

    public static DirectEnhanceResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
