...
public class SubRankCapByStampTaskResult implements IResult, Serializable {
	...
	public SubRankCapByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SubRankCapByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static SubRankCapByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
