...
public class GetLikeRequest extends Gs2BasicRequest<GetLikeRequest> {
	...
	public GetLikeRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetLikeRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public GetLikeRequest withEntryModelName(String entryModelName) {
		this.entryModelName = entryModelName;
		return this;
	}

    public static GetLikeRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
