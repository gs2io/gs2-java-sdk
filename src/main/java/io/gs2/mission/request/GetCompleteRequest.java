...
public class GetCompleteRequest extends Gs2BasicRequest<GetCompleteRequest> {
     ...
     * ミッショングループ名を設定
     *
     * @param missionGroupName 達成状況を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider 達成状況を取得
     */
