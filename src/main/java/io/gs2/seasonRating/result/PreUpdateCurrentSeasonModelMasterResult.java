...
public class PreUpdateCurrentSeasonModelMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentSeasonModelMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentSeasonModelMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentSeasonModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
