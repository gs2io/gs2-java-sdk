...
public class GetReceiveStatusResult implements IResult, Serializable {
	...
	public GetReceiveStatusResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public GetReceiveStatusResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static GetReceiveStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
