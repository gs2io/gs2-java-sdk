...
public class DeleteMemberResult implements IResult, Serializable {
    private Guild item;
	...
	public DeleteMemberResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static DeleteMemberResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
