...
public class DeleteGoldRequest extends Gs2BasicRequest<DeleteGoldRequest> {

	public static class Constant extends Gs2Gold.Constant {
		public static final String FUNCTION = "DeleteGold";
	}
	 ...
	 * @return this
	 */
	public DeleteGoldRequest withGoldName(String goldName) {
