...
public class SendMessageByUserIdResult implements IResult, Serializable {
	...
	public SendMessageByUserIdResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static SendMessageByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
