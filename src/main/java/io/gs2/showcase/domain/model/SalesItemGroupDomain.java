...
public class SalesItemGroupDomain {
    ...
    public SalesItemGroup model() {
        SalesItemGroup value = cache.get(
            parentKey,
            io.gs2.showcase.domain.model.SalesItemGroupDomain.createCacheKey(
            ),
            SalesItemGroup.class
        );
        return value;
    }
