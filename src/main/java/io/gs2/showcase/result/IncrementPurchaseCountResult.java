...
public class IncrementPurchaseCountResult implements IResult, Serializable {
	...
	public IncrementPurchaseCountResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}

    public static IncrementPurchaseCountResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
