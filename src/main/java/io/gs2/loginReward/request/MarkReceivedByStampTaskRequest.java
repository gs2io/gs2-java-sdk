...
public class MarkReceivedByStampTaskRequest extends Gs2BasicRequest<MarkReceivedByStampTaskRequest> {
    ...
    public static MarkReceivedByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
