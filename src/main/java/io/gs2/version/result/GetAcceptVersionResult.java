...
public class GetAcceptVersionResult implements IResult, Serializable {
	...
	public GetAcceptVersionResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static GetAcceptVersionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
