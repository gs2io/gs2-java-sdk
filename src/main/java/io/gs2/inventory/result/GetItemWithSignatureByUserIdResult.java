...
public class GetItemWithSignatureByUserIdResult implements IResult, Serializable {
	...
	public GetItemWithSignatureByUserIdResult withItems(List<ItemSet> items) {
		this.items = items;
		return this;
	}
	...
	public GetItemWithSignatureByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public GetItemWithSignatureByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}
	...
	public GetItemWithSignatureByUserIdResult withBody(String body) {
		this.body = body;
		return this;
	}
	...
	public GetItemWithSignatureByUserIdResult withSignature(String signature) {
		this.signature = signature;
		return this;
	}

    public static GetItemWithSignatureByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
