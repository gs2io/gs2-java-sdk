...
public class UpdateRoomFromBackendResult implements IResult, Serializable {
    private Room item;
	...
	public UpdateRoomFromBackendResult withItem(Room item) {
		this.item = item;
		return this;
	}

    public static UpdateRoomFromBackendResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
