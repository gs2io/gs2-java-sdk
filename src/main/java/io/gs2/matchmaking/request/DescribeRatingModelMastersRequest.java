...
public class DescribeRatingModelMastersRequest extends Gs2BasicRequest<DescribeRatingModelMastersRequest> {
	...
	public DescribeRatingModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeRatingModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeRatingModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
