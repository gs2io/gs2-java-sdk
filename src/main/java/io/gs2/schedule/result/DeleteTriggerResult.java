...
public class DeleteTriggerResult implements IResult, Serializable {
	...
	public DeleteTriggerResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static DeleteTriggerResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
