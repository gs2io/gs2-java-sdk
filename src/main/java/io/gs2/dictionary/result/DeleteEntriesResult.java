...
public class DeleteEntriesResult implements IResult, Serializable {
	...
	public DeleteEntriesResult withItems(List<Entry> items) {
		this.items = items;
		return this;
	}

    public static DeleteEntriesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
