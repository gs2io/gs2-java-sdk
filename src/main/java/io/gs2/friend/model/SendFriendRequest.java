...
public class SendFriendRequest implements IModel, Serializable, Comparable<SendFriendRequest> {
	...
	public SendFriendRequest withPublicProfile(String publicProfile) {
		this.publicProfile = publicProfile;
		return this;
	}

    public static SendFriendRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SendFriendRequest other = (SendFriendRequest) o;
		if (userId == null) {
