...
public class GetIgnoreUserByGuildNameResult implements IResult, Serializable {
	...
	public GetIgnoreUserByGuildNameResult withItem(IgnoreUser item) {
		this.item = item;
		return this;
	}

    public static GetIgnoreUserByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
