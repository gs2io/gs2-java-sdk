...
public class AllocateSubscriptionStatusByUserIdResult implements IResult, Serializable {
	...
	public AllocateSubscriptionStatusByUserIdResult withItem(SubscriptionStatus item) {
		this.item = item;
		return this;
	}

    public static AllocateSubscriptionStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
