...
public class UpdateCurrentMessageMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentMessageMasterResult withItem(CurrentMessageMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentMessageMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
