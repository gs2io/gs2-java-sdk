...
public class SkipResult implements IResult, Serializable {
    private Await item;
	...
	public SkipResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public SkipResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}

    public static SkipResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
