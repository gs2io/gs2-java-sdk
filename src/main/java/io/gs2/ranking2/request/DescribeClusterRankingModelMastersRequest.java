...
public class DescribeClusterRankingModelMastersRequest extends Gs2BasicRequest<DescribeClusterRankingModelMastersRequest> {
	...
	public DescribeClusterRankingModelMastersRequest withPageToken(String pageToken) {
		this.pageToken = pageToken;
		return this;
	}
	...
	public DescribeClusterRankingModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeClusterRankingModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
