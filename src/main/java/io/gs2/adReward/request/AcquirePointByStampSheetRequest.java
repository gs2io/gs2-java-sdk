...
public class AcquirePointByStampSheetRequest extends Gs2BasicRequest<AcquirePointByStampSheetRequest> {
    ...
    public static AcquirePointByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
