...
public class VerifyCurrentMaximumMemberCountRequest extends Gs2BasicRequest<VerifyCurrentMaximumMemberCountRequest> {
	...
	public VerifyCurrentMaximumMemberCountRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyCurrentMaximumMemberCountRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
