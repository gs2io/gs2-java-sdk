...
public class AcquireItemSetWithGradeByUserIdResult implements IResult, Serializable {
	...
	public AcquireItemSetWithGradeByUserIdResult withItem(ItemSet item) {
		this.item = item;
		return this;
	}
	...
	public AcquireItemSetWithGradeByUserIdResult withStatus(io.gs2.grade.model.Status status) {
		this.status = status;
		return this;
	}
	...
	public AcquireItemSetWithGradeByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public AcquireItemSetWithGradeByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}
    ...
    public static AcquireItemSetWithGradeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
