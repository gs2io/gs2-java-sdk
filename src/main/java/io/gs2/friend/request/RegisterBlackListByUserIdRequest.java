...
public class RegisterBlackListByUserIdRequest extends Gs2BasicRequest<RegisterBlackListByUserIdRequest> {
	...
	public RegisterBlackListByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static RegisterBlackListByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
