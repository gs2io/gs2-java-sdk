...
public class RejectByUserIdResult implements IResult, Serializable {
	...
	public RejectByUserIdResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static RejectByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
