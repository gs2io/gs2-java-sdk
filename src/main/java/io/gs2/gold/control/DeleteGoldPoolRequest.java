...
public class DeleteGoldPoolRequest extends Gs2BasicRequest<DeleteGoldPoolRequest> {

	public static class Constant extends Gs2Gold.Constant {
		public static final String FUNCTION = "DeleteGoldPool";
	}
	 ...
	 * @return this
	 */
	public DeleteGoldPoolRequest withGoldPoolName(String goldPoolName) {
