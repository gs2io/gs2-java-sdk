...
public class Gs2LotteryRestClient extends AbstractGs2Client<Gs2LotteryRestClient> {
    ...
    class PreUpdateCurrentLotteryMasterTask extends Gs2RestSessionTask<PreUpdateCurrentLotteryMasterResult> {
        private PreUpdateCurrentLotteryMasterRequest request;

        public PreUpdateCurrentLotteryMasterTask(
            PreUpdateCurrentLotteryMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentLotteryMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentLotteryMasterResult parse(JsonNode data) {
            return PreUpdateCurrentLotteryMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentLotteryMasterAsync(
            PreUpdateCurrentLotteryMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentLotteryMasterResult>> callback
    ) {
        PreUpdateCurrentLotteryMasterTask task = new PreUpdateCurrentLotteryMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentLotteryMasterResult preUpdateCurrentLotteryMaster(
            PreUpdateCurrentLotteryMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentLotteryMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentLotteryMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentLotteryMasterTask extends Gs2RestSessionTask<UpdateCurrentLotteryMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentLotteryMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentLotteryMasterTask task = new PreUpdateCurrentLotteryMasterTask(
