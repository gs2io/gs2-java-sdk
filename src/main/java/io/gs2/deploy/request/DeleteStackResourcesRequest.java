...
public class DeleteStackResourcesRequest extends Gs2BasicRequest<DeleteStackResourcesRequest> {
    ...
    public static DeleteStackResourcesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
