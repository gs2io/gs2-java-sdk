...
public class FreezeMasterDataByTimestampResult implements IResult, Serializable {
	...
	public FreezeMasterDataByTimestampResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static FreezeMasterDataByTimestampResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
