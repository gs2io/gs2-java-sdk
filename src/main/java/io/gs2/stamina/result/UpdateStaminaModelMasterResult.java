...
public class UpdateStaminaModelMasterResult implements IResult, Serializable {
	...
	public UpdateStaminaModelMasterResult withItem(StaminaModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateStaminaModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
