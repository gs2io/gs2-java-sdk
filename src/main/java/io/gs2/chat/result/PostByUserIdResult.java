...
public class PostByUserIdResult implements IResult, Serializable {
	...
	public PostByUserIdResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static PostByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
