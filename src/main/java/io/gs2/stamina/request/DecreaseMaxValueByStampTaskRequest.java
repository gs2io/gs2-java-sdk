...
public class DecreaseMaxValueByStampTaskRequest extends Gs2BasicRequest<DecreaseMaxValueByStampTaskRequest> {
    ...
    public static DecreaseMaxValueByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
