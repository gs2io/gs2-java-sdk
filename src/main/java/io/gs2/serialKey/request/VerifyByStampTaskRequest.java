...
public class VerifyByStampTaskRequest extends Gs2BasicRequest<VerifyByStampTaskRequest> {
	...
	public VerifyByStampTaskRequest withStampTask(String stampTask) {
		this.stampTask = stampTask;
		return this;
	}
	...
	public VerifyByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static VerifyByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
