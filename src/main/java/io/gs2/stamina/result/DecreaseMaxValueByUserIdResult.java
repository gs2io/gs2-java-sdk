...
public class DecreaseMaxValueByUserIdResult implements IResult, Serializable {
	...
	public DecreaseMaxValueByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseMaxValueByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static DecreaseMaxValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
