...
public class CheckEstimateScanByteByRoomRequest extends Gs2BasicRequest<CheckEstimateScanByteByRoomRequest> {
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withLobbyName(String lobbyName) {
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withRoomId(String roomId) {
		setRoomId(roomId);
		return this;
	}
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withMessage(String message) {
		setMessage(message);
		return this;
	}
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withMeta(String meta) {
		setMeta(meta);
		return this;
	}
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withBegin(Integer begin) {
		setBegin(begin);
		return this;
	}
	 ...
	 * @return this
	 */
	public CheckEstimateScanByteByRoomRequest withEnd(Integer end) {
		setEnd(end);
		return this;
	}
