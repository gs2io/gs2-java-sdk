...
import io.gs2.seasonRating.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentSeasonModelMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentSeasonModelMasterFromGitHubRequest> {
	...
	public UpdateCurrentSeasonModelMasterFromGitHubRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
    ...
    public static UpdateCurrentSeasonModelMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
