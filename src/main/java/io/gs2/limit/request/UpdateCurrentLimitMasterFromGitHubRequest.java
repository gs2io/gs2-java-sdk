...
import io.gs2.limit.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentLimitMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentLimitMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentLimitMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
