...
public class PreUpdateCurrentModelMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentModelMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentModelMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
