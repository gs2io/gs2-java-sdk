...
public class SubMoldCapacityByUserIdRequest extends Gs2BasicRequest<SubMoldCapacityByUserIdRequest> {
	...
	public SubMoldCapacityByUserIdRequest withMoldName(String moldName) {
		this.moldName = moldName;
		return this;
	}
	...
	public SubMoldCapacityByUserIdRequest withCapacity(Integer capacity) {
		this.capacity = capacity;
		return this;
	}
    ...
    public static SubMoldCapacityByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
