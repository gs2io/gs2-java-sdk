...
public class AddMoldCapacityByUserIdResult implements IResult, Serializable {
    private Mold item;
	...
	public AddMoldCapacityByUserIdResult withItem(Mold item) {
		this.item = item;
		return this;
	}
	...
	public AddMoldCapacityByUserIdResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}

    public static AddMoldCapacityByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
