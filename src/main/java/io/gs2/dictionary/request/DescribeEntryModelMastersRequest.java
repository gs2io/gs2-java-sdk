...
public class DescribeEntryModelMastersRequest extends Gs2BasicRequest<DescribeEntryModelMastersRequest> {
	...
	public DescribeEntryModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeEntryModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeEntryModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
