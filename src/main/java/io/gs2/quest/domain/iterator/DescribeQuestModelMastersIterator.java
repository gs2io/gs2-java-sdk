...
public class DescribeQuestModelMastersIterator implements Iterator<QuestModelMaster>, Iterable<QuestModelMaster> {
    CacheDatabase cache;
    ...
    public DescribeQuestModelMastersIterator(
        CacheDatabase cache,
        Gs2QuestRestClient client,
        String namespaceName,
        String questGroupName
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeQuestModelMastersResult r = this.client.describeQuestModelMasters(
