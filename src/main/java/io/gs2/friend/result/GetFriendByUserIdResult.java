...
public class GetFriendByUserIdResult implements IResult, Serializable {
	...
	public GetFriendByUserIdResult withItem(FriendUser item) {
		this.item = item;
		return this;
	}

    public static GetFriendByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
