...
public class SetMaxValueByStampSheetResult implements IResult, Serializable {
	...
	public SetMaxValueByStampSheetResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetMaxValueByStampSheetResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetMaxValueByStampSheetResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetMaxValueByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
