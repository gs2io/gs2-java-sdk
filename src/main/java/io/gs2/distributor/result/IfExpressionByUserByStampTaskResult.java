...
public class IfExpressionByUserByStampTaskResult implements IResult, Serializable {
	...
	public IfExpressionByUserByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static IfExpressionByUserByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
