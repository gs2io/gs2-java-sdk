...
public class ActivateRegionResult implements IResult, Serializable {
	...
	public ActivateRegionResult withItem(Project item) {
		this.item = item;
		return this;
	}

    public static ActivateRegionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
