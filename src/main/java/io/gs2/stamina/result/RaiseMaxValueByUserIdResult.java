...
public class RaiseMaxValueByUserIdResult implements IResult, Serializable {
	...
	public RaiseMaxValueByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public RaiseMaxValueByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static RaiseMaxValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
