...
public class CampaignModelMaster implements IModel, Serializable, Comparable<CampaignModelMaster> {
	...
	public CampaignModelMaster withEnableCampaignCode(Boolean enableCampaignCode) {
		this.enableCampaignCode = enableCampaignCode;
		return this;
	}
    ...
    public static CampaignModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CampaignModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CampaignModelMaster other = (CampaignModelMaster) o;
		if (campaignId == null) {
