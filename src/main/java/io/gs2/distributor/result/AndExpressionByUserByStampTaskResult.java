...
public class AndExpressionByUserByStampTaskResult implements IResult, Serializable {
    ...
    public static AndExpressionByUserByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
