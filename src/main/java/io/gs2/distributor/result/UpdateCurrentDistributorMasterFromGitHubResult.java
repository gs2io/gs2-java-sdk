...
public class UpdateCurrentDistributorMasterFromGitHubResult implements IResult, Serializable {
    ...
    public static UpdateCurrentDistributorMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
