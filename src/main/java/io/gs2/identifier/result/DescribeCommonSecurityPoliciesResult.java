...
public class DescribeCommonSecurityPoliciesResult implements IResult, Serializable {
	...
	public DescribeCommonSecurityPoliciesResult withItems(List<SecurityPolicy> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeCommonSecurityPoliciesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeCommonSecurityPoliciesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
