...
public class AddIgnoreUserByGuildNameResult implements IResult, Serializable {
	...
	public AddIgnoreUserByGuildNameResult withItem(IgnoreUser item) {
		this.item = item;
		return this;
	}
	...
	public AddIgnoreUserByGuildNameResult withGuild(Guild guild) {
		this.guild = guild;
		return this;
	}

    public static AddIgnoreUserByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
