...
public class GetFormWithSignatureByUserIdRequest extends Gs2BasicRequest<GetFormWithSignatureByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定して署名付きフォームを取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定して署名付きフォームを取得
     */
     ...
     * フォームの保存領域の名前を設定
     *
     * @param moldName ユーザIDを指定して署名付きフォームを取得
     */
     ...
     * 保存領域のインデックスを設定
     *
     * @param index ユーザIDを指定して署名付きフォームを取得
     */
     ...
     *
     * @param keyId ユーザIDを指定して署名付きフォームを取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定して署名付きフォームを取得
     */
