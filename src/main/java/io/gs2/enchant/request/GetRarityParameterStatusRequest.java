...
public class GetRarityParameterStatusRequest extends Gs2BasicRequest<GetRarityParameterStatusRequest> {
    ...
    public static GetRarityParameterStatusRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
