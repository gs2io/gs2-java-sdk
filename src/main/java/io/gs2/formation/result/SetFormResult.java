...
public class SetFormResult implements IResult, Serializable {
    private Form item;
    private Mold mold;
	...
	public SetFormResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public SetFormResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public SetFormResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public SetFormResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static SetFormResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
