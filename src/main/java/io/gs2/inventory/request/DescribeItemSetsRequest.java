...
public class DescribeItemSetsRequest extends Gs2BasicRequest<DescribeItemSetsRequest> {
	...
	public DescribeItemSetsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeItemSetsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
