...
public class DescribeRankingssByUserIdResult implements IResult, Serializable {
	...
	public DescribeRankingssByUserIdResult withItems(List<Ranking> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeRankingssByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeRankingssByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
