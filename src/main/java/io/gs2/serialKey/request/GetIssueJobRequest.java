...
public class GetIssueJobRequest extends Gs2BasicRequest<GetIssueJobRequest> {
	...
	public GetIssueJobRequest withCampaignModelName(String campaignModelName) {
		this.campaignModelName = campaignModelName;
		return this;
	}
	...
	public GetIssueJobRequest withIssueJobName(String issueJobName) {
		this.issueJobName = issueJobName;
		return this;
	}

    public static GetIssueJobRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
