...
import io.gs2.lock.model.*;public class Gs2LockRestClient extends AbstractGs2Client<Gs2LockRestClient> {
    ...
    class DescribeMutexesTask extends Gs2RestSessionTask<DescribeMutexesResult> {
        private DescribeMutexesRequest request;
    ...
    public DescribeMutexesResult describeMutexes(
        ...
        final AsyncResult<DescribeMutexesResult>[] resultAsyncResult = new AsyncResult[]{null};
    ...
    class DescribeMutexesByUserIdTask extends Gs2RestSessionTask<DescribeMutexesByUserIdResult> {
        private DescribeMutexesByUserIdRequest request;
    ...
    public DescribeMutexesByUserIdResult describeMutexesByUserId(
        ...
        final AsyncResult<DescribeMutexesByUserIdResult>[] resultAsyncResult = new AsyncResult[]{null};
    ...
    class LockTask extends Gs2RestSessionTask<LockResult> {
    ...
    public LockResult lock(
        ...
        final AsyncResult<LockResult>[] resultAsyncResult = new AsyncResult[]{null};
        lockAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
    ...
    class LockByUserIdTask extends Gs2RestSessionTask<LockByUserIdResult> {
        private LockByUserIdRequest request;
    ...
    public LockByUserIdResult lockByUserId(
        ...
        final AsyncResult<LockByUserIdResult>[] resultAsyncResult = new AsyncResult[]{null};
        lockByUserIdAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
    ...
    class UnlockTask extends Gs2RestSessionTask<UnlockResult> {
    ...
    public UnlockResult unlock(
        ...
        final AsyncResult<UnlockResult>[] resultAsyncResult = new AsyncResult[]{null};
        unlockAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
    ...
    class UnlockByUserIdTask extends Gs2RestSessionTask<UnlockByUserIdResult> {
        private UnlockByUserIdRequest request;
    ...
    public UnlockByUserIdResult unlockByUserId(
        ...
        final AsyncResult<UnlockByUserIdResult>[] resultAsyncResult = new AsyncResult[]{null};
        unlockByUserIdAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
    ...
    class GetMutexTask extends Gs2RestSessionTask<GetMutexResult> {
        private GetMutexRequest request;
    ...
    public GetMutexResult getMutex(
        ...
        final AsyncResult<GetMutexResult>[] resultAsyncResult = new AsyncResult[]{null};
        getMutexAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
    ...
    class GetMutexByUserIdTask extends Gs2RestSessionTask<GetMutexByUserIdResult> {
        private GetMutexByUserIdRequest request;
    ...
    public GetMutexByUserIdResult getMutexByUserId(
        ...
        final AsyncResult<GetMutexByUserIdResult>[] resultAsyncResult = new AsyncResult[]{null};
    ...
    class DeleteMutexByUserIdTask extends Gs2RestSessionTask<DeleteMutexByUserIdResult> {
        private DeleteMutexByUserIdRequest request;
    ...
    public DeleteMutexByUserIdResult deleteMutexByUserId(
        ...
        final AsyncResult<DeleteMutexByUserIdResult>[] resultAsyncResult = new AsyncResult[]{null};
