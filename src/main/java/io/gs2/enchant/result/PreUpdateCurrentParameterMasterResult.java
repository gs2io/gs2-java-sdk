...
public class PreUpdateCurrentParameterMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentParameterMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentParameterMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentParameterMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
