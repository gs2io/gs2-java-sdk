...
public class CurrentLotteryMaster implements IModel, Serializable, Comparable<CurrentLotteryMaster> {
    ...
    public static CurrentLotteryMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentLotteryMaster other = (CurrentLotteryMaster) o;
		if (namespaceId == null) {
