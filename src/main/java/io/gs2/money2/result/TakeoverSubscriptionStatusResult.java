...
public class TakeoverSubscriptionStatusResult implements IResult, Serializable {
	...
	public TakeoverSubscriptionStatusResult withItem(SubscriptionStatus item) {
		this.item = item;
		return this;
	}

    public static TakeoverSubscriptionStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
