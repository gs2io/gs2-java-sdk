...
public class DecreaseMaximumIdleMinutesByStampTaskResult implements IResult, Serializable {
    private Status item;
	...
	public DecreaseMaximumIdleMinutesByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseMaximumIdleMinutesByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static DecreaseMaximumIdleMinutesByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
