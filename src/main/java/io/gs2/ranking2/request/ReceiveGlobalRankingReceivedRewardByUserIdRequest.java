...
public class ReceiveGlobalRankingReceivedRewardByUserIdRequest extends Gs2BasicRequest<ReceiveGlobalRankingReceivedRewardByUserIdRequest> {
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static ReceiveGlobalRankingReceivedRewardByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
