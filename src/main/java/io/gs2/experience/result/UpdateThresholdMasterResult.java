...
public class UpdateThresholdMasterResult implements IResult, Serializable {
	...
	public UpdateThresholdMasterResult withItem(ThresholdMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateThresholdMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
