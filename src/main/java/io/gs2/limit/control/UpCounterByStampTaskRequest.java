...
public class UpCounterByStampTaskRequest extends Gs2UserRequest<UpCounterByStampTaskRequest> {
	 ...
	 * @return this
	 */
	public UpCounterByStampTaskRequest withTask(String task) {
		setTask(task);
		return this;
	}
	 ...
	 * @return this
	 */
	public UpCounterByStampTaskRequest withKeyName(String keyName) {
		setKeyName(keyName);
		return this;
	}
	 ...
	 * @return this
	 */
	public UpCounterByStampTaskRequest withTransactionId(String transactionId) {
