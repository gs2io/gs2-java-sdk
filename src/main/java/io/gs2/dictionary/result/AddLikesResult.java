...
public class AddLikesResult implements IResult, Serializable {
	...
	public AddLikesResult withItems(List<Like> items) {
		this.items = items;
		return this;
	}

    public static AddLikesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
