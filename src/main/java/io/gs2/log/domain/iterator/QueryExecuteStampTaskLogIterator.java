...
public class QueryExecuteStampTaskLogIterator implements Iterator<ExecuteStampTaskLog>, Iterable<ExecuteStampTaskLog> {
    CacheDatabase cache;
    ...
    String pageToken;
    boolean last;
    List<ExecuteStampTaskLog> result;
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            QueryExecuteStampTaskLogResult r = this.client.queryExecuteStampTaskLog(
            ...
            for (ExecuteStampTaskLog item : this.result) {
                this.cache.put(
                        parentKey,
                        io.gs2.log.domain.model.ExecuteStampTaskLogDomain.createCacheKey(
                        ),
                        item,
    ...
    @Override
    public ExecuteStampTaskLog next(
        ...
        ExecuteStampTaskLog ret = this.result.get(0);
    ...
    @Override
    public Iterator<ExecuteStampTaskLog> iterator() {
        return this;
    }
}
