...
public class RevertUseByStampSheetRequest extends Gs2BasicRequest<RevertUseByStampSheetRequest> {
	...
	public RevertUseByStampSheetRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static RevertUseByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
