...
public class DescribeRecoverValueTableMastersRequest extends Gs2BasicRequest<DescribeRecoverValueTableMastersRequest> {
	...
	public DescribeRecoverValueTableMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeRecoverValueTableMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeRecoverValueTableMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
