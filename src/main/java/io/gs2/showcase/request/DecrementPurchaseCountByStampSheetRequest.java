...
public class DecrementPurchaseCountByStampSheetRequest extends Gs2BasicRequest<DecrementPurchaseCountByStampSheetRequest> {
	...
	public DecrementPurchaseCountByStampSheetRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static DecrementPurchaseCountByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
