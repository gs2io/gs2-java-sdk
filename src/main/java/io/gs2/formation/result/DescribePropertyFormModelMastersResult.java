...
public class DescribePropertyFormModelMastersResult implements IResult, Serializable {
    private List<PropertyFormModelMaster> items;
    private String nextPageToken;

	public List<PropertyFormModelMaster> getItems() {
		return items;
	}

	public void setItems(List<PropertyFormModelMaster> items) {
		this.items = items;
	}

	public DescribePropertyFormModelMastersResult withItems(List<PropertyFormModelMaster> items) {
		this.items = items;
		return this;
	}
	...
	public DescribePropertyFormModelMastersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribePropertyFormModelMastersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
