...
public class GetMessageResult implements IResult, Serializable {
	...
	public GetMessageResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static GetMessageResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
