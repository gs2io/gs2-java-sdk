...
public class DescribeStaminasResult implements IResult, Serializable {
	...
	public DescribeStaminasResult withItems(List<Stamina> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeStaminasResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeStaminasResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
