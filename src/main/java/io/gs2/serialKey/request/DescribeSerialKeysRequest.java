...
public class DescribeSerialKeysRequest extends Gs2BasicRequest<DescribeSerialKeysRequest> {
	...
	public DescribeSerialKeysRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeSerialKeysRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
