...
public class UpdateCurrentIdleMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentIdleMasterFromGitHubResult withItem(CurrentCategoryMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentIdleMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
