...
public class CompleteResult implements IResult, Serializable {
	...
	public CompleteResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public CompleteResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static CompleteResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
