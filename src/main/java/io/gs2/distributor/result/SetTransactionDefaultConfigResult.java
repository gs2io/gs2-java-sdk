...
public class SetTransactionDefaultConfigResult implements IResult, Serializable {
	...
	public SetTransactionDefaultConfigResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static SetTransactionDefaultConfigResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
