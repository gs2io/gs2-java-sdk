...
public class DescribeSubscribeRankingScoresResult implements IResult, Serializable {
	...
	public DescribeSubscribeRankingScoresResult withItems(List<SubscribeRankingScore> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeSubscribeRankingScoresResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeSubscribeRankingScoresResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeSubscribeRankingScoresResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<SubscribeRankingScore>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<SubscribeRankingScore>() :
