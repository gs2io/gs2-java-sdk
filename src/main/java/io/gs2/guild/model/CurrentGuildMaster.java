...
public class CurrentGuildMaster implements IModel, Serializable, Comparable<CurrentGuildMaster> {
	...
	public CurrentGuildMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentGuildMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentGuildMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentGuildMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentGuildMaster other = (CurrentGuildMaster) o;
		if (namespaceId == null) {
