...
public class GetPropertyFormModelRequest extends Gs2BasicRequest<GetPropertyFormModelRequest> {
	...
	public GetPropertyFormModelRequest withPropertyFormModelName(String propertyFormModelName) {
		this.propertyFormModelName = propertyFormModelName;
		return this;
	}

    public static GetPropertyFormModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
