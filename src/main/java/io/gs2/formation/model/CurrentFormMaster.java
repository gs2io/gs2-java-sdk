...
public class CurrentFormMaster implements IModel, Serializable, Comparable<CurrentFormMaster> {
    ...
    public static CurrentFormMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentFormMaster o) {
