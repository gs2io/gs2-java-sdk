...
public class VerifyIncludeMemberResult implements IResult, Serializable {
    private Guild item;
	...
	public VerifyIncludeMemberResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static VerifyIncludeMemberResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
