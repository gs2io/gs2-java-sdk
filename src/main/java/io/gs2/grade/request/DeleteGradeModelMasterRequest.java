...
public class DeleteGradeModelMasterRequest extends Gs2BasicRequest<DeleteGradeModelMasterRequest> {
    ...
    public static DeleteGradeModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
