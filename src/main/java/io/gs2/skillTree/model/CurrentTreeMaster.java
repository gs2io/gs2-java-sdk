...
public class CurrentTreeMaster implements IModel, Serializable, Comparable<CurrentTreeMaster> {
    ...
    public static CurrentTreeMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentTreeMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentTreeMaster other = (CurrentTreeMaster) o;
		if (namespaceId == null) {
