...
public class GetFirebaseTokenResult implements IResult, Serializable {
	...
	public GetFirebaseTokenResult withItem(FirebaseToken item) {
		this.item = item;
		return this;
	}

    public static GetFirebaseTokenResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
