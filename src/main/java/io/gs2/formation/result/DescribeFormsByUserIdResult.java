...
public class DescribeFormsByUserIdResult implements IResult, Serializable {
	...
	public DescribeFormsByUserIdResult withItems(List<Form> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeFormsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeFormsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
