...
public class UseByUserIdResult implements IResult, Serializable {
	...
	public UseByUserIdResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}
	...
	public UseByUserIdResult withCampaignModel(CampaignModel campaignModel) {
		this.campaignModel = campaignModel;
		return this;
	}

    public static UseByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
