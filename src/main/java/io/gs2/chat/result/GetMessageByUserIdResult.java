...
public class GetMessageByUserIdResult implements IResult, Serializable {
	...
	public GetMessageByUserIdResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static GetMessageByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
