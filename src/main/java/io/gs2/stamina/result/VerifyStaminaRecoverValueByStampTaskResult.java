...
public class VerifyStaminaRecoverValueByStampTaskResult implements IResult, Serializable {
	...
	public VerifyStaminaRecoverValueByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyStaminaRecoverValueByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
