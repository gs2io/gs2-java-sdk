...
public class DeleteTriggerByUserIdRequest extends Gs2BasicRequest<DeleteTriggerByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してトリガーを削除
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してトリガーを削除
     */
     ...
     * トリガーの名前を設定
     *
     * @param triggerName ユーザIDを指定してトリガーを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してトリガーを削除
     */
