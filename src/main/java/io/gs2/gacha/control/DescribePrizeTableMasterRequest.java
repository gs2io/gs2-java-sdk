...
public class DescribePrizeTableMasterRequest extends Gs2BasicRequest<DescribePrizeTableMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DescribePrizeTableMaster";
	}
	 ...
	 * @return this
	 */
	public DescribePrizeTableMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DescribePrizeTableMasterRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribePrizeTableMasterRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
