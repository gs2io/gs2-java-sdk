...
public class DeleteLimitRequest extends Gs2BasicRequest<DeleteLimitRequest> {

	public static class Constant extends Gs2Limit.Constant {
		public static final String FUNCTION = "DeleteLimit";
	}
	 ...
	 * @return this
	 */
	public DeleteLimitRequest withLimitName(String limitName) {
