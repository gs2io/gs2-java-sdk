...
public class DeleteWalletByUserIdRequest extends Gs2BasicRequest<DeleteWalletByUserIdRequest> {

	public static class Constant extends Gs2Gold.Constant {
		public static final String FUNCTION = "DeleteWalletByUserId";
	}
	 ...
	 * @return this
	 */
	public DeleteWalletByUserIdRequest withGoldPoolName(String goldPoolName) {
	 ...
	 * @return this
	 */
	public DeleteWalletByUserIdRequest withGoldName(String goldName) {
	 ...
	 * @return this
	 */
	public DeleteWalletByUserIdRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
