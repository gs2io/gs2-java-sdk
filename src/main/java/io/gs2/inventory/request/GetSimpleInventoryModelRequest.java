...
public class GetSimpleInventoryModelRequest extends Gs2BasicRequest<GetSimpleInventoryModelRequest> {
    ...
    public static GetSimpleInventoryModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
