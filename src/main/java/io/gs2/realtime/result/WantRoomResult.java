...
public class WantRoomResult implements IResult, Serializable {
    private Room item;
	...
	public WantRoomResult withItem(Room item) {
		this.item = item;
		return this;
	}

    public static WantRoomResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
