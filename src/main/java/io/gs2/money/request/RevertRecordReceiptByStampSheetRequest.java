...
public class RevertRecordReceiptByStampSheetRequest extends Gs2BasicRequest<RevertRecordReceiptByStampSheetRequest> {
    ...
    public static RevertRecordReceiptByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
