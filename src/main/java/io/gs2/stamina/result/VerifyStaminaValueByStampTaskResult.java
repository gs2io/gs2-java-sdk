...
public class VerifyStaminaValueByStampTaskResult implements IResult, Serializable {
	...
	public VerifyStaminaValueByStampTaskResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public VerifyStaminaValueByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyStaminaValueByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
