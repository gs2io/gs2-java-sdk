...
public class ChallengeMfaResult implements IResult, Serializable {
	...
	public ChallengeMfaResult withItem(Account item) {
		this.item = item;
		return this;
	}

    public static ChallengeMfaResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
