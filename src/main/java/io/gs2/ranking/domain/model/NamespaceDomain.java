...
public class NamespaceDomain {
    ...
    public NamespaceDomain(
        ...
        this.parentKey = "ranking:Namespace";
    }
    ...
    private Namespace get(
        ...
        if (result.getItem() != null) {
            cache.put(
                parentKey,
                io.gs2.ranking.domain.model.NamespaceDomain.createCacheKey(
    ...
    public CategoryModelMasterDomain createCategoryModelMaster(
        CreateCategoryModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateCategoryModelMasterResult result = this.client.createCategoryModelMaster(
            request
        );
        ...
        CategoryModelMasterDomain domain = new CategoryModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public CurrentRankingMasterDomain currentRankingMaster(
    ) {
    ...
    public CategoryModelDomain categoryModel(
        String categoryName
    ) {
    ...
    public CategoryModelMasterDomain categoryModelMaster(
        String categoryName
    ) {
