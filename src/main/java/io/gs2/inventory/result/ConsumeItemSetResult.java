...
public class ConsumeItemSetResult implements IResult, Serializable {
	...
	public ConsumeItemSetResult withItems(List<ItemSet> items) {
		this.items = items;
		return this;
	}
	...
	public ConsumeItemSetResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public ConsumeItemSetResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static ConsumeItemSetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
