...
public class DeleteAreaModelMasterRequest extends Gs2BasicRequest<DeleteAreaModelMasterRequest> {
    ...
    public static DeleteAreaModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
