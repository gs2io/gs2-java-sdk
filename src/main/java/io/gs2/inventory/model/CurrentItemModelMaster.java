...
public class CurrentItemModelMaster implements IModel, Serializable, Comparable<CurrentItemModelMaster> {
    ...
    public static CurrentItemModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentItemModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentItemModelMaster other = (CurrentItemModelMaster) o;
		if (namespaceId == null) {
