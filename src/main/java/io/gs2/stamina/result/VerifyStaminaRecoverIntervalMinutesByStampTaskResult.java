...
public class VerifyStaminaRecoverIntervalMinutesByStampTaskResult implements IResult, Serializable {
	...
	public VerifyStaminaRecoverIntervalMinutesByStampTaskResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
    ...
    public static VerifyStaminaRecoverIntervalMinutesByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
