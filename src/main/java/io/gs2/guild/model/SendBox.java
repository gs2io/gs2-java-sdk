...
public class SendBox implements IModel, Serializable, Comparable<SendBox> {
	...
	private List<String> targetGuildNames;
	...
	public int hashCode() {
        ...
        result = prime * result + ((this.targetGuildNames == null) ? 0 : this.targetGuildNames.hashCode());
	...
	public boolean equals(Object o) {
		...
		if (targetGuildNames == null) {
			return other.targetGuildNames == null;
		} else if (!targetGuildNames.equals(other.targetGuildNames)) {
			return false;
		}
		if (createdAt == null) {
