...
public class SetPropertyFormRequest extends Gs2BasicRequest<SetPropertyFormRequest> {
	...
	public SetPropertyFormRequest withSlots(List<Slot> slots) {
		this.slots = slots;
		return this;
	}
    ...
    public static SetPropertyFormRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
