...
public class DescribeInventoriesByUserIdResult implements IResult, Serializable {
	...
	public DescribeInventoriesByUserIdResult withItems(List<Inventory> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeInventoriesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeInventoriesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
