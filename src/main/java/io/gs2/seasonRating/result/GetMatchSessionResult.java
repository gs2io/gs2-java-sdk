...
public class GetMatchSessionResult implements IResult, Serializable {
	...
	public GetMatchSessionResult withItem(MatchSession item) {
		this.item = item;
		return this;
	}

    public static GetMatchSessionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
