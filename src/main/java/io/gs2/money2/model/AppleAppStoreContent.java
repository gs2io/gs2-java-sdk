...
public class AppleAppStoreContent implements IModel, Serializable {
    ...
    public static AppleAppStoreContent fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		AppleAppStoreContent other = (AppleAppStoreContent) o;
		if (productId == null) {
