...
public class DeleteFormResult implements IResult, Serializable {
    private Form item;
    private Mold mold;
	...
	public DeleteFormResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public DeleteFormResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public DeleteFormResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public DeleteFormResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static DeleteFormResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
