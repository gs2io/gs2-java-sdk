...
public class DescribeCompletesByUserIdIterator implements Iterator<Complete>, Iterable<Complete> {
    CacheDatabase cache;
    ...
    public DescribeCompletesByUserIdIterator(
        CacheDatabase cache,
        Gs2MissionRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeCompletesByUserIdResult r = this.client.describeCompletesByUserId(
