...
public class DetachGuardRequest extends Gs2BasicRequest<DetachGuardRequest> {
	...
	public DetachGuardRequest withUserName(String userName) {
		this.userName = userName;
		return this;
	}
	...
	public DetachGuardRequest withClientId(String clientId) {
		this.clientId = clientId;
		return this;
	}
	...
	public DetachGuardRequest withGuardNamespaceId(String guardNamespaceId) {
		this.guardNamespaceId = guardNamespaceId;
		return this;
	}

    public static DetachGuardRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
