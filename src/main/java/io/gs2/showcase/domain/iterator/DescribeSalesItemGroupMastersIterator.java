...
public class DescribeSalesItemGroupMastersIterator implements Iterator<SalesItemGroupMaster>, Iterable<SalesItemGroupMaster> {
    CacheDatabase cache;
    ...
    public DescribeSalesItemGroupMastersIterator(
        CacheDatabase cache,
        Gs2ShowcaseRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeSalesItemGroupMastersResult r = this.client.describeSalesItemGroupMasters(
