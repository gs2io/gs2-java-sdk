...
public class ConsumePointByUserIdRequest extends Gs2BasicRequest<ConsumePointByUserIdRequest> {
	...
	public ConsumePointByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static ConsumePointByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
