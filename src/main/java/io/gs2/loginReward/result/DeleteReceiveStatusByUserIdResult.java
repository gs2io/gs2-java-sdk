...
public class DeleteReceiveStatusByUserIdResult implements IResult, Serializable {
	...
	public DeleteReceiveStatusByUserIdResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public DeleteReceiveStatusByUserIdResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static DeleteReceiveStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
