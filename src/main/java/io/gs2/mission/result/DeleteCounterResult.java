...
public class DeleteCounterResult implements IResult, Serializable {
	...
	public DeleteCounterResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static DeleteCounterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
