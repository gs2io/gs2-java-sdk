...
public class DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult implements IResult, Serializable {
    private Guild item;
	...
	public DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult withItem(Guild item) {
		this.item = item;
		return this;
	}
    ...
    public static DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
