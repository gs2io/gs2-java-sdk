...
public class DescribeRatingsByUserIdResult implements IResult, Serializable {
	...
	public DescribeRatingsByUserIdResult withItems(List<Rating> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeRatingsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeRatingsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
