...
public class FreezeMasterDataByUserIdRequest extends Gs2BasicRequest<FreezeMasterDataByUserIdRequest> {
	...
	public FreezeMasterDataByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
    ...
    public static FreezeMasterDataByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
