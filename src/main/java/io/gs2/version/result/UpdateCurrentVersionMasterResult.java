...
public class UpdateCurrentVersionMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentVersionMasterResult withItem(CurrentVersionMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentVersionMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
