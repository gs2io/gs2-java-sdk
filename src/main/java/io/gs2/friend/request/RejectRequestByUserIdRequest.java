...
public class RejectRequestByUserIdRequest extends Gs2BasicRequest<RejectRequestByUserIdRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return ユーザーIDを指定してフレンドリクエストを拒否
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定してフレンドリクエストを拒否
     */
     ...
     *
     * @param userId ユーザーIDを指定してフレンドリクエストを拒否
     */
     ...
     *
     * @param fromUserId ユーザーIDを指定してフレンドリクエストを拒否
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してフレンドリクエストを拒否
     */
