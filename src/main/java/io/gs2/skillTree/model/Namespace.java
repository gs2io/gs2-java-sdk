...
public class Namespace implements IModel, Serializable, Comparable<Namespace> {
	...
	public Namespace withReleaseScript(ScriptSetting releaseScript) {
		this.releaseScript = releaseScript;
		return this;
	}
	...
	public Namespace withRestrainScript(ScriptSetting restrainScript) {
		this.restrainScript = restrainScript;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		if (releaseScript == null) {
			return other.releaseScript == null;
		} else if (!releaseScript.equals(other.releaseScript)) {
			return false;
		}
		if (restrainScript == null) {
			return other.restrainScript == null;
		} else if (!restrainScript.equals(other.restrainScript)) {
			return false;
		}
		if (logSetting == null) {
