...
public class UpdateMemberMetadataByUserIdResult implements IResult, Serializable {
    private Guild item;
	...
	public UpdateMemberMetadataByUserIdResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static UpdateMemberMetadataByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
