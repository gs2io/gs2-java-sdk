...
public class UnlockByUserRequest extends Gs2BasicRequest<UnlockByUserRequest> {

	public static class Constant extends Gs2Lock.Constant {
		public static final String FUNCTION = "UnlockByUser";
	}
	 ...
	 * @return this
	 */
	public UnlockByUserRequest withLockPoolName(String lockPoolName) {
	 ...
	 * @return this
	 */
	public UnlockByUserRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
	 ...
	 * @return this
	 */
	public UnlockByUserRequest withTransactionId(String transactionId) {
	 ...
	 * @return this
	 */
	public UnlockByUserRequest withResourceName(String resourceName) {
