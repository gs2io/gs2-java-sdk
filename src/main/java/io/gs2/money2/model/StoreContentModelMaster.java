...
public class StoreContentModelMaster implements IModel, Serializable, Comparable<StoreContentModelMaster> {
	...
	public StoreContentModelMaster withAppleAppStore(AppleAppStoreContent appleAppStore) {
		this.appleAppStore = appleAppStore;
		return this;
	}
	...
	public StoreContentModelMaster withGooglePlay(GooglePlayContent googlePlay) {
		this.googlePlay = googlePlay;
		return this;
	}
    ...
    public static StoreContentModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(StoreContentModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		StoreContentModelMaster other = (StoreContentModelMaster) o;
