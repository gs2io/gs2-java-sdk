...
public class PrepareReUploadResult implements IResult, Serializable {
	...
	public PrepareReUploadResult withItem(DataObject item) {
		this.item = item;
		return this;
	}
    ...
    public static PrepareReUploadResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
