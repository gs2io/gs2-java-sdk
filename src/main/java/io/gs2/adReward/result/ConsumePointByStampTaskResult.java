...
public class ConsumePointByStampTaskResult implements IResult, Serializable {
    private Point item;
	...
	public ConsumePointByStampTaskResult withItem(Point item) {
		this.item = item;
		return this;
	}
	...
	public ConsumePointByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static ConsumePointByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new ConsumePointByStampTaskResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : Point.fromJson(data.get("item")))
