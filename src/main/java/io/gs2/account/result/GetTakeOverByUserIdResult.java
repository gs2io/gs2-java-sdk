...
public class GetTakeOverByUserIdResult implements IResult, Serializable {
	...
	public GetTakeOverByUserIdResult withItem(TakeOver item) {
		this.item = item;
		return this;
	}

    public static GetTakeOverByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
