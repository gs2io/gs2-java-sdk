...
public class DescribeCountersRequest extends Gs2BasicRequest<DescribeCountersRequest> {
	...
	public DescribeCountersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeCountersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
