...
public class BlackListAccessTokenDomain {
    ...
    public BlackListAccessTokenDomain register(
        RegisterBlackListRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName)
            .withAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        RegisterBlackListResult result = this.client.registerBlackList(
            request
        );
    ...
    public BlackListAccessTokenDomain unregister(
        UnregisterBlackListRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName)
            .withAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        UnregisterBlackListResult result = this.client.unregisterBlackList(
            request
        );
