...
public class GetShowcaseStatusRequest extends Gs2BasicRequest<GetShowcaseStatusRequest> {

	public static class Constant extends Gs2Showcase.Constant {
		public static final String FUNCTION = "GetShowcaseStatus";
	}
	 ...
	 * @return this
	 */
	public GetShowcaseStatusRequest withShowcaseName(String showcaseName) {
