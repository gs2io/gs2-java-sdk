...
public class PreUpdateCurrentLimitMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentLimitMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentLimitMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentLimitMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
