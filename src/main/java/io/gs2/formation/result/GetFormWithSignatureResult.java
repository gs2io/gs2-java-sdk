...
public class GetFormWithSignatureResult implements IResult, Serializable {
	...
	public GetFormWithSignatureResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public GetFormWithSignatureResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public GetFormWithSignatureResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public GetFormWithSignatureResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static GetFormWithSignatureResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
