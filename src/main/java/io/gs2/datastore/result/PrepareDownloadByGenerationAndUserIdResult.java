...
public class PrepareDownloadByGenerationAndUserIdResult implements IResult, Serializable {
	...
	public PrepareDownloadByGenerationAndUserIdResult withItem(DataObject item) {
		this.item = item;
		return this;
	}
	...
	public PrepareDownloadByGenerationAndUserIdResult withFileUrl(String fileUrl) {
		this.fileUrl = fileUrl;
		return this;
	}
	...
	public PrepareDownloadByGenerationAndUserIdResult withContentLength(Long contentLength) {
		this.contentLength = contentLength;
		return this;
	}

    public static PrepareDownloadByGenerationAndUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
