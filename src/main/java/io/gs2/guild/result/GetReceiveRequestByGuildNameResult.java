...
public class GetReceiveRequestByGuildNameResult implements IResult, Serializable {
	...
	public GetReceiveRequestByGuildNameResult withItem(ReceiveMemberRequest item) {
		this.item = item;
		return this;
	}

    public static GetReceiveRequestByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
