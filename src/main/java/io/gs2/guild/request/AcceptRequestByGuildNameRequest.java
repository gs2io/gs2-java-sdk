...
public class AcceptRequestByGuildNameRequest extends Gs2BasicRequest<AcceptRequestByGuildNameRequest> {
	...
	public AcceptRequestByGuildNameRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public AcceptRequestByGuildNameRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}
	...
	public AcceptRequestByGuildNameRequest withFromUserId(String fromUserId) {
		this.fromUserId = fromUserId;
		return this;
	}
	...
	public AcceptRequestByGuildNameRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static AcceptRequestByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
