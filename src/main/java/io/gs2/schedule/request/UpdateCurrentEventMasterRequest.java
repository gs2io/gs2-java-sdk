...
public class UpdateCurrentEventMasterRequest extends Gs2BasicRequest<UpdateCurrentEventMasterRequest> {
	...
	public UpdateCurrentEventMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentEventMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentEventMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
