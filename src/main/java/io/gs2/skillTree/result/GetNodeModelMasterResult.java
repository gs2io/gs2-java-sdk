...
public class GetNodeModelMasterResult implements IResult, Serializable {
	...
	public GetNodeModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetNodeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
