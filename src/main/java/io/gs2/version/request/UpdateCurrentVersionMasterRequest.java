...
public class UpdateCurrentVersionMasterRequest extends Gs2BasicRequest<UpdateCurrentVersionMasterRequest> {
	...
	public UpdateCurrentVersionMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentVersionMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentVersionMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
