...
public class UpdateClusterRankingModelMasterResult implements IResult, Serializable {
	...
	public UpdateClusterRankingModelMasterResult withItem(ClusterRankingModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateClusterRankingModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
