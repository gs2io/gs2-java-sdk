...
public class SendByStampSheetResult implements IResult, Serializable {
	...
	public SendByStampSheetResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static SendByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
