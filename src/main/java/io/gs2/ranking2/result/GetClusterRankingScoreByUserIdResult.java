...
public class GetClusterRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public GetClusterRankingScoreByUserIdResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static GetClusterRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
