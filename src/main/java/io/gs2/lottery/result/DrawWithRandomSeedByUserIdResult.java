...
public class DrawWithRandomSeedByUserIdResult implements IResult, Serializable {
	...
	public DrawWithRandomSeedByUserIdResult withItems(List<DrawnPrize> items) {
		this.items = items;
		return this;
	}
	...
	public DrawWithRandomSeedByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public DrawWithRandomSeedByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public DrawWithRandomSeedByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static DrawWithRandomSeedByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
