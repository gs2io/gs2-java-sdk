...
public class DescribeJobsByUserIdIterator implements Iterator<Job>, Iterable<Job> {
    CacheDatabase cache;
    ...
    public DescribeJobsByUserIdIterator(
        CacheDatabase cache,
        Gs2JobQueueRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeJobsByUserIdResult r = this.client.describeJobsByUserId(
