...
public class GetRandomShowcaseMasterRequest extends Gs2BasicRequest<GetRandomShowcaseMasterRequest> {
    ...
    public static GetRandomShowcaseMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
