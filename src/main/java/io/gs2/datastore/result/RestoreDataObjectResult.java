...
public class RestoreDataObjectResult implements IResult, Serializable {
	...
	public RestoreDataObjectResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static RestoreDataObjectResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
