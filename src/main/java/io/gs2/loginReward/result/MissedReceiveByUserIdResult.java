...
public class MissedReceiveByUserIdResult implements IResult, Serializable {
	...
	public MissedReceiveByUserIdResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public MissedReceiveByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static MissedReceiveByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
