...
public class DeleteByStampTaskRequest extends Gs2BasicRequest<DeleteByStampTaskRequest> {
	...
	public DeleteByStampTaskRequest withStampTask(String stampTask) {
		this.stampTask = stampTask;
		return this;
	}
	...
	public DeleteByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static DeleteByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
