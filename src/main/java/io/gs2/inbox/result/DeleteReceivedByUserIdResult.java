...
public class DeleteReceivedByUserIdResult implements IResult, Serializable {
	...
	public DeleteReceivedByUserIdResult withItem(Received item) {
		this.item = item;
		return this;
	}

    public static DeleteReceivedByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
