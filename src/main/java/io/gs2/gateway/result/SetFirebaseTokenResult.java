...
public class SetFirebaseTokenResult implements IResult, Serializable {
	...
	public SetFirebaseTokenResult withItem(FirebaseToken item) {
		this.item = item;
		return this;
	}

    public static SetFirebaseTokenResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
