...
public class RegisterBlackListResult implements IResult, Serializable {
	...
	public RegisterBlackListResult withItem(BlackList item) {
		this.item = item;
		return this;
	}

    public static RegisterBlackListResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
