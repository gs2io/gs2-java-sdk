...
public class SetMaxValueByUserIdResult implements IResult, Serializable {
	...
	public SetMaxValueByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetMaxValueByUserIdResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetMaxValueByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetMaxValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
