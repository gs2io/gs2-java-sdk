...
public class DescribeFriendsByUserIdRequest extends Gs2BasicRequest<DescribeFriendsByUserIdRequest> {
	...
	public DescribeFriendsByUserIdRequest withWithProfile(Boolean withProfile) {
		this.withProfile = withProfile;
		return this;
	}
	...
	public DescribeFriendsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeFriendsByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeFriendsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
