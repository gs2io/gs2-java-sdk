...
public class ReceiveGlobalRankingReceivedRewardByUserIdResult implements IResult, Serializable {
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdResult withItem(GlobalRankingModel item) {
		this.item = item;
		return this;
	}
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdResult withAcquireActions(List<AcquireAction> acquireActions) {
		this.acquireActions = acquireActions;
		return this;
	}
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public ReceiveGlobalRankingReceivedRewardByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static ReceiveGlobalRankingReceivedRewardByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
