...
public class ExtendTriggerByUserIdResult implements IResult, Serializable {
	...
	public ExtendTriggerByUserIdResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static ExtendTriggerByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
