...
public class CreateGuildResult implements IResult, Serializable {
    private Guild item;
	...
	public CreateGuildResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static CreateGuildResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
