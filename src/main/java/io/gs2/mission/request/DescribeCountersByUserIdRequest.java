...
public class DescribeCountersByUserIdRequest extends Gs2BasicRequest<DescribeCountersByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してカウンターの一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してカウンターの一覧を取得
     */
     ...
     *
     * @param pageToken ユーザIDを指定してカウンターの一覧を取得
     */
     ...
     * データの取得件数を設定
     *
     * @param limit ユーザIDを指定してカウンターの一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してカウンターの一覧を取得
     */
