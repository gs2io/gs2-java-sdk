...
public class SimpleItemModelMaster implements IModel, Serializable, Comparable<SimpleItemModelMaster> {
    ...
    public static SimpleItemModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(SimpleItemModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SimpleItemModelMaster other = (SimpleItemModelMaster) o;
		if (itemModelId == null) {
