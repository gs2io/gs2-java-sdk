...
public class GetBigItemResult implements IResult, Serializable {
	...
	public GetBigItemResult withItem(BigItem item) {
		this.item = item;
		return this;
	}
	...
	public GetBigItemResult withItemModel(BigItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}

    public static GetBigItemResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
