...
public class VerifyInventoryCurrentMaxCapacityByStampTaskRequest extends Gs2BasicRequest<VerifyInventoryCurrentMaxCapacityByStampTaskRequest> {
    ...
    public static VerifyInventoryCurrentMaxCapacityByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
