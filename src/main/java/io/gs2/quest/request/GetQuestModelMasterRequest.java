...
public class GetQuestModelMasterRequest extends Gs2BasicRequest<GetQuestModelMasterRequest> {
     ...
     * カテゴリ名を設定
     *
     * @param namespaceName クエストモデルマスターを取得
     */
     ...
     * クエストグループモデル名を設定
     *
     * @param questGroupName クエストモデルマスターを取得
     */
     ...
     * クエスト名を設定
     *
     * @param questName クエストモデルマスターを取得
     */
