...
public class SetExperienceByStampSheetRequest extends Gs2BasicRequest<SetExperienceByStampSheetRequest> {
	...
	public SetExperienceByStampSheetRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static SetExperienceByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
