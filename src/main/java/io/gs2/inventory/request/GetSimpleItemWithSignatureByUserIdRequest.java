...
public class GetSimpleItemWithSignatureByUserIdRequest extends Gs2BasicRequest<GetSimpleItemWithSignatureByUserIdRequest> {
    ...
    public static GetSimpleItemWithSignatureByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
