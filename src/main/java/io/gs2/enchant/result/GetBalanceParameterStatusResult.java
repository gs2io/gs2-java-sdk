...
public class GetBalanceParameterStatusResult implements IResult, Serializable {
	...
	public GetBalanceParameterStatusResult withItem(BalanceParameterStatus item) {
		this.item = item;
		return this;
	}

    public static GetBalanceParameterStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
