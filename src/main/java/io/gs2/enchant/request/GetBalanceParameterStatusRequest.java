...
public class GetBalanceParameterStatusRequest extends Gs2BasicRequest<GetBalanceParameterStatusRequest> {
    ...
    public static GetBalanceParameterStatusRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
