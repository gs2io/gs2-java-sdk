...
public class DoneUploadByUserIdResult implements IResult, Serializable {
	...
	public DoneUploadByUserIdResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static DoneUploadByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
