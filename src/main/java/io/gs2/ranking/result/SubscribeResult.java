...
public class SubscribeResult implements IResult, Serializable {
	...
	public SubscribeResult withItem(SubscribeUser item) {
		this.item = item;
		return this;
	}

    public static SubscribeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
