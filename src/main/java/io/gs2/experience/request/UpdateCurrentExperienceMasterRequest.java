...
public class UpdateCurrentExperienceMasterRequest extends Gs2BasicRequest<UpdateCurrentExperienceMasterRequest> {
	...
	public UpdateCurrentExperienceMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentExperienceMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentExperienceMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
