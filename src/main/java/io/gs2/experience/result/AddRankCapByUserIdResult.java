...
public class AddRankCapByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public AddRankCapByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static AddRankCapByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
