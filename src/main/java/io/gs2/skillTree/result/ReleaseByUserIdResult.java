...
public class ReleaseByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public ReleaseByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public ReleaseByUserIdResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public ReleaseByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static ReleaseByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
