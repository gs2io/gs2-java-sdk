...
public class GetRarityMasterRequest extends Gs2BasicRequest<GetRarityMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetRarityMaster";
	}
	 ...
	 * @return this
	 */
	public GetRarityMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public GetRarityMasterRequest withPrizeTableName(String prizeTableName) {
	 ...
	 * @return this
	 */
	public GetRarityMasterRequest withRarityName(String rarityName) {
