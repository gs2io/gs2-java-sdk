...
public class CountDownByUserIdResult implements IResult, Serializable {
	...
	public CountDownByUserIdResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static CountDownByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
