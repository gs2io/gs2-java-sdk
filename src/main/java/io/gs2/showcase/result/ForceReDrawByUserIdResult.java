...
public class ForceReDrawByUserIdResult implements IResult, Serializable {
	...
	public ForceReDrawByUserIdResult withItems(List<RandomDisplayItem> items) {
		this.items = items;
		return this;
	}

    public static ForceReDrawByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
