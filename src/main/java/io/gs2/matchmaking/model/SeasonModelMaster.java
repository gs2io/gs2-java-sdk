...
public class SeasonModelMaster implements IModel, Serializable, Comparable<SeasonModelMaster> {
	...
	public SeasonModelMaster withMaximumParticipants(Integer maximumParticipants) {
		this.maximumParticipants = maximumParticipants;
		return this;
	}
    ...
    public static SeasonModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(SeasonModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SeasonModelMaster other = (SeasonModelMaster) o;
