...
public class DeleteAwaitByUserIdResult implements IResult, Serializable {
    private Await item;
	...
	public DeleteAwaitByUserIdResult withItem(Await item) {
		this.item = item;
		return this;
	}

    public static DeleteAwaitByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
