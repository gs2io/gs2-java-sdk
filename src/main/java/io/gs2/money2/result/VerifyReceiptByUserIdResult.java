...
public class VerifyReceiptByUserIdResult implements IResult, Serializable {
    private Event item;
	...
	public VerifyReceiptByUserIdResult withItem(Event item) {
		this.item = item;
		return this;
	}

    public static VerifyReceiptByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
