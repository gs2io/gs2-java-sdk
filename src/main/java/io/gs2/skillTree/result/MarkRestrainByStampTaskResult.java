...
public class MarkRestrainByStampTaskResult implements IResult, Serializable {
    private Status item;
	...
	public MarkRestrainByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public MarkRestrainByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static MarkRestrainByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
