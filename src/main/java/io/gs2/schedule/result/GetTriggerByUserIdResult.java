...
public class GetTriggerByUserIdResult implements IResult, Serializable {
	...
	public GetTriggerByUserIdResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static GetTriggerByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
