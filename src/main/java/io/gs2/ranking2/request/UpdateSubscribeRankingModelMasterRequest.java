...
public class UpdateSubscribeRankingModelMasterRequest extends Gs2BasicRequest<UpdateSubscribeRankingModelMasterRequest> {
	...
	public UpdateSubscribeRankingModelMasterRequest withSum(Boolean sum) {
		this.sum = sum;
		return this;
	}
    ...
    public static UpdateSubscribeRankingModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
