...
public class NamespaceDomain {
    ...
    public NamespaceDomain(
        ...
        this.parentKey = "exchange:Namespace";
    }
    ...
    public RateModelMasterDomain createRateModelMaster(
        CreateRateModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateRateModelMasterResult result = this.client.createRateModelMaster(
            request
        );
        ...
        RateModelMasterDomain domain = new RateModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public RateModelMasterDomain rateModelMaster(
        String rateName
    ) {
    ...
    public CurrentRateMasterDomain currentRateMaster(
    ) {
    ...
    public RateModelDomain rateModel(
        String rateName
    ) {
