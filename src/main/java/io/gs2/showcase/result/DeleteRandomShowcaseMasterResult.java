...
public class DeleteRandomShowcaseMasterResult implements IResult, Serializable {
	...
	public DeleteRandomShowcaseMasterResult withItem(RandomShowcaseMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteRandomShowcaseMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
