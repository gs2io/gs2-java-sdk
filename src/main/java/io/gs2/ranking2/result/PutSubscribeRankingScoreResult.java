...
public class PutSubscribeRankingScoreResult implements IResult, Serializable {
	...
	public PutSubscribeRankingScoreResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static PutSubscribeRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
