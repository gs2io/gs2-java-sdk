...
public class DeleteBuffEntryModelMasterRequest extends Gs2BasicRequest<DeleteBuffEntryModelMasterRequest> {
    ...
    public static DeleteBuffEntryModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
