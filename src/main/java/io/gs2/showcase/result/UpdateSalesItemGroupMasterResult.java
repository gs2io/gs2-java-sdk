...
public class UpdateSalesItemGroupMasterResult implements IResult, Serializable {
	...
	public UpdateSalesItemGroupMasterResult withItem(SalesItemGroupMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateSalesItemGroupMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
