...
public class ResetCounterResult implements IResult, Serializable {
	...
	public ResetCounterResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static ResetCounterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
