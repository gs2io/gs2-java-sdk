...
public class QueryExecuteStampSheetLogResult implements IResult, Serializable {
    private List<ExecuteStampSheetLog> items;
    private String nextPageToken;
    private Long totalCount;
    private Long scanSize;

	public List<ExecuteStampSheetLog> getItems() {
		return items;
	}

	public void setItems(List<ExecuteStampSheetLog> items) {
		this.items = items;
	}

	public QueryExecuteStampSheetLogResult withItems(List<ExecuteStampSheetLog> items) {
		this.items = items;
		return this;
	}
    ...
    public static QueryExecuteStampSheetLogResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new QueryExecuteStampSheetLogResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<ExecuteStampSheetLog>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<ExecuteStampSheetLog>() :
