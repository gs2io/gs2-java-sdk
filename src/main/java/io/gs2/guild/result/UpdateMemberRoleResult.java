...
public class UpdateMemberRoleResult implements IResult, Serializable {
    private Guild item;
	...
	public UpdateMemberRoleResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static UpdateMemberRoleResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
