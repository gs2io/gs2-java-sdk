...
public class ConsumeSimpleItemsByStampTaskRequest extends Gs2BasicRequest<ConsumeSimpleItemsByStampTaskRequest> {
    ...
    public static ConsumeSimpleItemsByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
