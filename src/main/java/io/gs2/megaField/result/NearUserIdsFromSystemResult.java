...
public class NearUserIdsFromSystemResult implements IResult, Serializable {
	...
	public NearUserIdsFromSystemResult withItems(List<String> items) {
		this.items = items;
		return this;
	}

    public static NearUserIdsFromSystemResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
