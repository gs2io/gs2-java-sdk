...
public class ExitStateMachineByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public ExitStateMachineByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static ExitStateMachineByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
