...
public class DescribeLotteryModelMastersRequest extends Gs2BasicRequest<DescribeLotteryModelMastersRequest> {
	...
	public DescribeLotteryModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeLotteryModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeLotteryModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
