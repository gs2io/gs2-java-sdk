...
public class FreezeMasterDataBySignedTimestampResult implements IResult, Serializable {
	...
	public FreezeMasterDataBySignedTimestampResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static FreezeMasterDataBySignedTimestampResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
