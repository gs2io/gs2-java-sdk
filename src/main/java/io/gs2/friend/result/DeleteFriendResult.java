...
public class DeleteFriendResult implements IResult, Serializable {
	...
	public DeleteFriendResult withItem(FriendUser item) {
		this.item = item;
		return this;
	}

    public static DeleteFriendResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
