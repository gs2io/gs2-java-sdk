...
public class DescribeMatchmakingSeasonGatheringsRequest extends Gs2BasicRequest<DescribeMatchmakingSeasonGatheringsRequest> {
	...
	public DescribeMatchmakingSeasonGatheringsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeMatchmakingSeasonGatheringsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
