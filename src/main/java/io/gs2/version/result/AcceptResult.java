...
public class AcceptResult implements IResult, Serializable {
	...
	public AcceptResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static AcceptResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
