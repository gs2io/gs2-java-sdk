...
public class DeleteMoldByUserIdRequest extends Gs2BasicRequest<DeleteMoldByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定して保存したフォームを削除
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定して保存したフォームを削除
     */
     ...
     * フォームの保存領域の名前を設定
     *
     * @param moldName ユーザIDを指定して保存したフォームを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定して保存したフォームを削除
     */
