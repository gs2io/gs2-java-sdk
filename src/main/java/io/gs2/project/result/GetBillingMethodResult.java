...
public class GetBillingMethodResult implements IResult, Serializable {
	...
	public GetBillingMethodResult withItem(BillingMethod item) {
		this.item = item;
		return this;
	}

    public static GetBillingMethodResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
