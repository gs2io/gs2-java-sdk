...
public class SubGradeResult implements IResult, Serializable {
    private Status item;
	...
	public SubGradeResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SubGradeResult withExperienceNamespaceName(String experienceNamespaceName) {
		this.experienceNamespaceName = experienceNamespaceName;
		return this;
	}
	...
	public SubGradeResult withExperienceStatus(io.gs2.experience.model.Status experienceStatus) {
		this.experienceStatus = experienceStatus;
		return this;
	}

    public static SubGradeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
