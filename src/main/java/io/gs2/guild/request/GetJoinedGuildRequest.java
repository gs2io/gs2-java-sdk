...
public class GetJoinedGuildRequest extends Gs2BasicRequest<GetJoinedGuildRequest> {
	...
	public GetJoinedGuildRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetJoinedGuildRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public GetJoinedGuildRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public GetJoinedGuildRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}

    public static GetJoinedGuildRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
