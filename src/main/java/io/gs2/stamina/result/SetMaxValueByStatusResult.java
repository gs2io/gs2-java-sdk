...
public class SetMaxValueByStatusResult implements IResult, Serializable {
	...
	public SetMaxValueByStatusResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetMaxValueByStatusResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetMaxValueByStatusResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetMaxValueByStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
