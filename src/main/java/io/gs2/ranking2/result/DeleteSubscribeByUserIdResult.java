...
public class DeleteSubscribeByUserIdResult implements IResult, Serializable {
	...
	public DeleteSubscribeByUserIdResult withItem(SubscribeUser item) {
		this.item = item;
		return this;
	}

    public static DeleteSubscribeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
