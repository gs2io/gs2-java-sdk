...
public class GetCurrentMessageMasterResult implements IResult, Serializable {
	...
	public GetCurrentMessageMasterResult withItem(CurrentMessageMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentMessageMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
