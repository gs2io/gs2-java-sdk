...
public class DescribeTriggersResult implements IResult, Serializable {
	...
	public DescribeTriggersResult withItems(List<Trigger> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeTriggersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeTriggersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
