...
public class GetClusterRankingScoreResult implements IResult, Serializable {
	...
	public GetClusterRankingScoreResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static GetClusterRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
