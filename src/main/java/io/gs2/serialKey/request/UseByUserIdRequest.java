...
public class UseByUserIdRequest extends Gs2BasicRequest<UseByUserIdRequest> {
	...
	public UseByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public UseByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static UseByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
