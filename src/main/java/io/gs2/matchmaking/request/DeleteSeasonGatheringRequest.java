...
public class DeleteSeasonGatheringRequest extends Gs2BasicRequest<DeleteSeasonGatheringRequest> {
	...
	public DeleteSeasonGatheringRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteSeasonGatheringRequest withSeasonName(String seasonName) {
		this.seasonName = seasonName;
		return this;
	}
	...
	public DeleteSeasonGatheringRequest withSeason(Long season) {
		this.season = season;
		return this;
	}
	public Long getTier() {
	...
	public DeleteSeasonGatheringRequest withTier(Long tier) {
		this.tier = tier;
		return this;
	}
	...
	public DeleteSeasonGatheringRequest withSeasonGatheringName(String seasonGatheringName) {
		this.seasonGatheringName = seasonGatheringName;
		return this;
	}

    public static DeleteSeasonGatheringRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
