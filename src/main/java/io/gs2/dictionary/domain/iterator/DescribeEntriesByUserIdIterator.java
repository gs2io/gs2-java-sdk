...
public class DescribeEntriesByUserIdIterator implements Iterator<Entry>, Iterable<Entry> {
    CacheDatabase cache;
    ...
    public DescribeEntriesByUserIdIterator(
        CacheDatabase cache,
        Gs2DictionaryRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeEntriesByUserIdResult r = this.client.describeEntriesByUserId(
