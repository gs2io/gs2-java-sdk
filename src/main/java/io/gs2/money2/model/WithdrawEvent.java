...
public class WithdrawEvent implements IModel, Serializable {
	private Integer slot;
	private List<DepositTransaction> withdrawDetails;
	...
	public WithdrawEvent withSlot(Integer slot) {
		this.slot = slot;
		return this;
	}
	public List<DepositTransaction> getWithdrawDetails() {
		return withdrawDetails;
	}
	public void setWithdrawDetails(List<DepositTransaction> withdrawDetails) {
		this.withdrawDetails = withdrawDetails;
	}
	public WithdrawEvent withWithdrawDetails(List<DepositTransaction> withdrawDetails) {
		this.withdrawDetails = withdrawDetails;
		return this;
	}
	...
	public WithdrawEvent withStatus(WalletSummary status) {
		this.status = status;
		return this;
	}

    public static WithdrawEvent fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public int hashCode() {
        ...
        result = prime * result + ((this.withdrawDetails == null) ? 0 : this.withdrawDetails.hashCode());
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		WithdrawEvent other = (WithdrawEvent) o;
		if (slot == null) {
		...
		if (withdrawDetails == null) {
			return other.withdrawDetails == null;
		} else if (!withdrawDetails.equals(other.withdrawDetails)) {
			return false;
		}
		if (status == null) {
