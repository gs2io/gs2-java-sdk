...
public class EarlyCompleteByUserIdResult implements IResult, Serializable {
	...
	public EarlyCompleteByUserIdResult withItem(Gathering item) {
		this.item = item;
		return this;
	}

    public static EarlyCompleteByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
