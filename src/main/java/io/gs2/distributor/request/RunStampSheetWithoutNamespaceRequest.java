...
public class RunStampSheetWithoutNamespaceRequest extends Gs2BasicRequest<RunStampSheetWithoutNamespaceRequest> {
    ...
    public static RunStampSheetWithoutNamespaceRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
