...
public class IncrementPurchaseCountByUserIdResult implements IResult, Serializable {
	...
	public IncrementPurchaseCountByUserIdResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}

    public static IncrementPurchaseCountByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
