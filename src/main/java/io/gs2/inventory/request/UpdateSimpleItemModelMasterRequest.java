...
public class UpdateSimpleItemModelMasterRequest extends Gs2BasicRequest<UpdateSimpleItemModelMasterRequest> {
    ...
    public static UpdateSimpleItemModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
