...
public class CurrentBuffMaster implements IModel, Serializable, Comparable<CurrentBuffMaster> {
	...
	public CurrentBuffMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentBuffMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentBuffMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentBuffMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentBuffMaster other = (CurrentBuffMaster) o;
		if (namespaceId == null) {
