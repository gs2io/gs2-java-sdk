...
public class CreateSimpleInventoryModelMasterResult implements IResult, Serializable {
	...
	public CreateSimpleInventoryModelMasterResult withItem(SimpleInventoryModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateSimpleInventoryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
