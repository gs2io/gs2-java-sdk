...
public class DeleteSubscribeRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public DeleteSubscribeRankingScoreByUserIdResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static DeleteSubscribeRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
