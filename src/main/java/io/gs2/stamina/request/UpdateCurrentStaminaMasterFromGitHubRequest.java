...
import io.gs2.stamina.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentStaminaMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentStaminaMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentStaminaMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
