...
public class DescribeRatingModelMastersIterator implements Iterator<RatingModelMaster>, Iterable<RatingModelMaster> {
    CacheDatabase cache;
    ...
    public DescribeRatingModelMastersIterator(
        CacheDatabase cache,
        Gs2MatchmakingRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeRatingModelMastersResult r = this.client.describeRatingModelMasters(
