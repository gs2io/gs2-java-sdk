...
import io.gs2.enchant.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentParameterMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentParameterMasterFromGitHubRequest> {
	...
	public UpdateCurrentParameterMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentParameterMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
