...
public class SubRankCapResult implements IResult, Serializable {
    private Status item;
	...
	public SubRankCapResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static SubRankCapResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
