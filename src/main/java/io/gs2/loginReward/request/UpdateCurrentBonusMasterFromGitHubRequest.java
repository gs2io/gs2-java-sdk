...
import io.gs2.loginReward.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentBonusMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentBonusMasterFromGitHubRequest> {
	...
	public UpdateCurrentBonusMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentBonusMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
