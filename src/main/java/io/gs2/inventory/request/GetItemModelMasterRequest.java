...
public class GetItemModelMasterRequest extends Gs2BasicRequest<GetItemModelMasterRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName アイテムモデルマスターを取得
     */
     ...
     * インベントリの種類名を設定
     *
     * @param inventoryName アイテムモデルマスターを取得
     */
