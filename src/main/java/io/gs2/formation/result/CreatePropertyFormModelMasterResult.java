...
public class CreatePropertyFormModelMasterResult implements IResult, Serializable {
	...
	public CreatePropertyFormModelMasterResult withItem(PropertyFormModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreatePropertyFormModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
