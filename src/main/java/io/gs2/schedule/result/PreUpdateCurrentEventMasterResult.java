...
public class PreUpdateCurrentEventMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentEventMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentEventMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentEventMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
