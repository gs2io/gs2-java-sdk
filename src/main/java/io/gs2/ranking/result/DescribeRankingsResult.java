...
public class DescribeRankingsResult implements IResult, Serializable {
	...
	public DescribeRankingsResult withItems(List<Ranking> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeRankingsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeRankingsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeRankingsResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<Ranking>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<Ranking>() :
