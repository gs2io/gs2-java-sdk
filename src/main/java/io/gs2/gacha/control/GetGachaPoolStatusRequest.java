...
public class GetGachaPoolStatusRequest extends Gs2BasicRequest<GetGachaPoolStatusRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetGachaPoolStatus";
	}
	 ...
	 * @return this
	 */
	public GetGachaPoolStatusRequest withGachaPoolName(String gachaPoolName) {
