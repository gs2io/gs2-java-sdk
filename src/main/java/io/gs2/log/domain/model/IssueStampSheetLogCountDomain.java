...
public class IssueStampSheetLogCountDomain {
    ...
    public IssueStampSheetLogCountDomain(
        CacheDatabase cache,
    ...
    public IssueStampSheetLogCount model() {
        IssueStampSheetLogCount value = cache.get(
            parentKey,
            io.gs2.log.domain.model.IssueStampSheetLogCountDomain.createCacheKey(
            ),
            IssueStampSheetLogCount.class
        );
        return value;
    }
