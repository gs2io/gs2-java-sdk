...
public class VerifySubscribeRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public VerifySubscribeRankingScoreByUserIdResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static VerifySubscribeRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
