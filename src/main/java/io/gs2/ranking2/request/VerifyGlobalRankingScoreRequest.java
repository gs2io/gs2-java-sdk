...
public class VerifyGlobalRankingScoreRequest extends Gs2BasicRequest<VerifyGlobalRankingScoreRequest> {
	...
	public VerifyGlobalRankingScoreRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withRankingName(String rankingName) {
		this.rankingName = rankingName;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withSeason(Long season) {
		this.season = season;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withScore(Long score) {
		this.score = score;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyGlobalRankingScoreRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyGlobalRankingScoreRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
