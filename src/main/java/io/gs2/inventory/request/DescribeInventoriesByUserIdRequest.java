...
public class DescribeInventoriesByUserIdRequest extends Gs2BasicRequest<DescribeInventoriesByUserIdRequest> {
	...
	public DescribeInventoriesByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeInventoriesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeInventoriesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
