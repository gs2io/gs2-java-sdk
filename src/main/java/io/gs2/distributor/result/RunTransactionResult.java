...
public class RunTransactionResult implements IResult, Serializable {
	...
	public RunTransactionResult withItem(TransactionResult item) {
		this.item = item;
		return this;
	}

    public static RunTransactionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
