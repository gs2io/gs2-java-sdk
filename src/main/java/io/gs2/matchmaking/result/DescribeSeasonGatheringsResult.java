...
public class DescribeSeasonGatheringsResult implements IResult, Serializable {
	...
	public DescribeSeasonGatheringsResult withItems(List<SeasonGathering> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeSeasonGatheringsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeSeasonGatheringsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
