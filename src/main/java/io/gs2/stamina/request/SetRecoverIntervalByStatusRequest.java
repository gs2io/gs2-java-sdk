...
public class SetRecoverIntervalByStatusRequest extends Gs2BasicRequest<SetRecoverIntervalByStatusRequest> {
    ...
    public static SetRecoverIntervalByStatusRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
