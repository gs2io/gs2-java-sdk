...
import io.gs2.project.model.TwoFactorAuthenticationSetting;
import io.gs2.project.model.Account;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateAccountResult implements IResult, Serializable {
	...
	public UpdateAccountResult withItem(Account item) {
		this.item = item;
		return this;
	}

    public static UpdateAccountResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
