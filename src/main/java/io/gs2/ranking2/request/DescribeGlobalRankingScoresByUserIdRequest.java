...
public class DescribeGlobalRankingScoresByUserIdRequest extends Gs2BasicRequest<DescribeGlobalRankingScoresByUserIdRequest> {
	...
	public DescribeGlobalRankingScoresByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
    ...
    public static DescribeGlobalRankingScoresByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
