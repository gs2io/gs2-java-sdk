...
public class GetSubscriptionStatusByUserIdResult implements IResult, Serializable {
	...
	public GetSubscriptionStatusByUserIdResult withItem(SubscriptionStatus item) {
		this.item = item;
		return this;
	}

    public static GetSubscriptionStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
