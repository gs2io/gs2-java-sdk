...
public class UpdateCurrentRateMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentRateMasterFromGitHubResult withItem(CurrentRateMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentRateMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
