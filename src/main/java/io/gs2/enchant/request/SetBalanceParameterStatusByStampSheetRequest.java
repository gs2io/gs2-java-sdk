...
public class SetBalanceParameterStatusByStampSheetRequest extends Gs2BasicRequest<SetBalanceParameterStatusByStampSheetRequest> {
    ...
    public static SetBalanceParameterStatusByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
