...
public class PromoteSeniorMemberByGuildNameResult implements IResult, Serializable {
	...
	public PromoteSeniorMemberByGuildNameResult withItem(LastGuildMasterActivity item) {
		this.item = item;
		return this;
	}
	...
	public PromoteSeniorMemberByGuildNameResult withGuild(Guild guild) {
		this.guild = guild;
		return this;
	}

    public static PromoteSeniorMemberByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
