...
public class VerifyStaminaValueByUserIdResult implements IResult, Serializable {
	...
	public VerifyStaminaValueByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}

    public static VerifyStaminaValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
