...
public class DeleteBigItemByUserIdRequest extends Gs2BasicRequest<DeleteBigItemByUserIdRequest> {
	...
	public DeleteBigItemByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static DeleteBigItemByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
