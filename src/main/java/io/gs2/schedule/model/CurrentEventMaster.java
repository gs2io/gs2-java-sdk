...
public class CurrentEventMaster implements IModel, Serializable, Comparable<CurrentEventMaster> {
    ...
    public static CurrentEventMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentEventMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentEventMaster other = (CurrentEventMaster) o;
		if (namespaceId == null) {
