...
public class DecreaseMaximumIdleMinutesByUserIdRequest extends Gs2BasicRequest<DecreaseMaximumIdleMinutesByUserIdRequest> {
	...
	public Integer getDecreaseMinutes() {
		return decreaseMinutes;
	}
	public void setDecreaseMinutes(Integer decreaseMinutes) {
		this.decreaseMinutes = decreaseMinutes;
	}
	public DecreaseMaximumIdleMinutesByUserIdRequest withDecreaseMinutes(Integer decreaseMinutes) {
		this.decreaseMinutes = decreaseMinutes;
		return this;
	}
    ...
    public static DecreaseMaximumIdleMinutesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DecreaseMaximumIdleMinutesByUserIdRequest()
            ...
            .withDecreaseMinutes(data.get("decreaseMinutes") == null || data.get("decreaseMinutes").isNull() ? null : data.get("decreaseMinutes").intValue());
    }
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                ...
                put("decreaseMinutes", getDecreaseMinutes());
            }}
        );
    }
}