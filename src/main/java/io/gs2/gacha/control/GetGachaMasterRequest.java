...
public class GetGachaMasterRequest extends Gs2BasicRequest<GetGachaMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetGachaMaster";
	}
	 ...
	 * @return this
	 */
	public GetGachaMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public GetGachaMasterRequest withGachaName(String gachaName) {
