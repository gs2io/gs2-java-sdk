...
public class DecreaseMaxValueResult implements IResult, Serializable {
	...
	public DecreaseMaxValueResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseMaxValueResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static DecreaseMaxValueResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
