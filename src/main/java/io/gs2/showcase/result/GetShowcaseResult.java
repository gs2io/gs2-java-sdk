...
public class GetShowcaseResult implements IResult, Serializable {
	...
	public GetShowcaseResult withItem(Showcase item) {
		this.item = item;
		return this;
	}

    public static GetShowcaseResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
