...
public class Gs2DistributorRestClient extends AbstractGs2Client<Gs2DistributorRestClient> {
    ...
    class PreUpdateCurrentDistributorMasterTask extends Gs2RestSessionTask<PreUpdateCurrentDistributorMasterResult> {
        private PreUpdateCurrentDistributorMasterRequest request;

        public PreUpdateCurrentDistributorMasterTask(
            PreUpdateCurrentDistributorMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentDistributorMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentDistributorMasterResult parse(JsonNode data) {
            return PreUpdateCurrentDistributorMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentDistributorMasterAsync(
            PreUpdateCurrentDistributorMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentDistributorMasterResult>> callback
    ) {
        PreUpdateCurrentDistributorMasterTask task = new PreUpdateCurrentDistributorMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentDistributorMasterResult preUpdateCurrentDistributorMaster(
            PreUpdateCurrentDistributorMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentDistributorMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentDistributorMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentDistributorMasterTask extends Gs2RestSessionTask<UpdateCurrentDistributorMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentDistributorMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentDistributorMasterTask task = new PreUpdateCurrentDistributorMasterTask(
