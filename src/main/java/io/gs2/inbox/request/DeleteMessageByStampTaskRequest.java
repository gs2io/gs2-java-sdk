...
public class DeleteMessageByStampTaskRequest extends Gs2BasicRequest<DeleteMessageByStampTaskRequest> {
	...
	public DeleteMessageByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static DeleteMessageByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
