...
public class VerifyRarityParameterStatusResult implements IResult, Serializable {
	...
	public VerifyRarityParameterStatusResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}

    public static VerifyRarityParameterStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
