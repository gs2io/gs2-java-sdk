...
public class DescribeFriendsIterator implements Iterator<FriendUser>, Iterable<FriendUser> {
    CacheDatabase cache;
    ...
    public DescribeFriendsIterator(
        CacheDatabase cache,
        Gs2FriendRestClient client,
        String namespaceName,
        AccessToken accessToken,
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeFriendsResult r = this.client.describeFriends(
