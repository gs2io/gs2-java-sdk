...
public class CurrentRankingMaster implements IModel, Serializable, Comparable<CurrentRankingMaster> {
    ...
    public static CurrentRankingMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentRankingMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentRankingMaster other = (CurrentRankingMaster) o;
		if (namespaceId == null) {
