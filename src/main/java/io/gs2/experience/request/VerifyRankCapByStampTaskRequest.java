...
public class VerifyRankCapByStampTaskRequest extends Gs2BasicRequest<VerifyRankCapByStampTaskRequest> {
    ...
    public static VerifyRankCapByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
