...
public class GetCurrentBuffMasterResult implements IResult, Serializable {
	...
	public GetCurrentBuffMasterResult withItem(CurrentBuffMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentBuffMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
