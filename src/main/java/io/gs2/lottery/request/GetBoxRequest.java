...
public class GetBoxRequest extends Gs2BasicRequest<GetBoxRequest> {
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ボックスを取得
     */
