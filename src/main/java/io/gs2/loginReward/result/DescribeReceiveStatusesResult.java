...
public class DescribeReceiveStatusesResult implements IResult, Serializable {
	...
	public DescribeReceiveStatusesResult withItems(List<ReceiveStatus> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeReceiveStatusesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeReceiveStatusesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
