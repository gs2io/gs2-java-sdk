...
public class DescribeEntriesResult implements IResult, Serializable {
	...
	public DescribeEntriesResult withItems(List<Entry> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeEntriesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeEntriesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
