...
public class MissedReceiveResult implements IResult, Serializable {
	...
	public MissedReceiveResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public MissedReceiveResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}
	...
	public MissedReceiveResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public MissedReceiveResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public MissedReceiveResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public MissedReceiveResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static MissedReceiveResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
