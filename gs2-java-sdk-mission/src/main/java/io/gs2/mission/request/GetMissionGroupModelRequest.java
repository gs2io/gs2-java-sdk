...
public class GetMissionGroupModelRequest extends Gs2BasicRequest<GetMissionGroupModelRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ミッショングループを取得
     */
     ...
     * グループ名を設定
     *
     * @param missionGroupName ミッショングループを取得
     */
