...
public class DeleteCounterRequest extends Gs2BasicRequest<DeleteCounterRequest> {
	...
	public static class Constant extends Gs2Limit.Constant {
		public static final String FUNCTION = "DeleteCounter";
	}
	 ...
	 * @return this
	 */
	public DeleteCounterRequest withLimitName(String limitName) {
	 ...
	 * @return this
	 */
	public DeleteCounterRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
