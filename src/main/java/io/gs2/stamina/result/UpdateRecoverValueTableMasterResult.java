...
public class UpdateRecoverValueTableMasterResult implements IResult, Serializable {
	...
	public UpdateRecoverValueTableMasterResult withItem(RecoverValueTableMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateRecoverValueTableMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
