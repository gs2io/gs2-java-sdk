...
public class VerifyStaminaRecoverIntervalMinutesRequest extends Gs2BasicRequest<VerifyStaminaRecoverIntervalMinutesRequest> {
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaRecoverIntervalMinutesRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaRecoverIntervalMinutesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
