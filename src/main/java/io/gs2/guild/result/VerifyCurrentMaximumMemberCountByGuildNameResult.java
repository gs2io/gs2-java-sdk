...
public class VerifyCurrentMaximumMemberCountByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public VerifyCurrentMaximumMemberCountByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static VerifyCurrentMaximumMemberCountByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
