...
public class FederationResult implements IResult, Serializable {
	...
	public FederationResult withToken(String token) {
		this.token = token;
		return this;
	}
	...
	public FederationResult withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public FederationResult withExpire(Long expire) {
		this.expire = expire;
		return this;
	}

    public static FederationResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
