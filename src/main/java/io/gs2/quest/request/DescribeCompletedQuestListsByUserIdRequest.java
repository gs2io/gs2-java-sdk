...
public class DescribeCompletedQuestListsByUserIdRequest extends Gs2BasicRequest<DescribeCompletedQuestListsByUserIdRequest> {
     ...
     * カテゴリ名を設定
     *
     * @param namespaceName ユーザIDを指定してクエスト進行の一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してクエスト進行の一覧を取得
     */
     ...
     *
     * @param pageToken ユーザIDを指定してクエスト進行の一覧を取得
     */
     ...
     * データの取得件数を設定
     *
     * @param limit ユーザIDを指定してクエスト進行の一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してクエスト進行の一覧を取得
     */
