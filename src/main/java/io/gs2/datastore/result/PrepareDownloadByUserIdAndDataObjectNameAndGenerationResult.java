...
public class PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult implements IResult, Serializable {
	/** データオブジェクト */
	 ...
	 * データオブジェクトを設定
	 *
	 * @param item ユーザIDを指定してデータオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 *
	 * @param fileUrl ユーザIDを指定してデータオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 * ファイルの容量を設定
	 *
	 * @param contentLength ユーザIDを指定してデータオブジェクトを世代を指定してダウンロード準備する
	 */
