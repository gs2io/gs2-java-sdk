...
public class UseResult implements IResult, Serializable {
	...
	public UseResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}
	...
	public UseResult withCampaignModel(CampaignModel campaignModel) {
		this.campaignModel = campaignModel;
		return this;
	}

    public static UseResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
