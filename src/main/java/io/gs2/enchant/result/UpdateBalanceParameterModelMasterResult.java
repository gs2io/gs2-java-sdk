...
public class UpdateBalanceParameterModelMasterResult implements IResult, Serializable {
	...
	public UpdateBalanceParameterModelMasterResult withItem(BalanceParameterModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateBalanceParameterModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
