...
public class DescribeMutexesByUserIdRequest extends Gs2BasicRequest<DescribeMutexesByUserIdRequest> {
	...
	public DescribeMutexesByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeMutexesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeMutexesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
