...
public class Namespace implements IModel, Serializable, Comparable<Namespace> {
	...
	public Namespace withStartScript(ScriptSetting startScript) {
		this.startScript = startScript;
		return this;
	}
	...
	public Namespace withPassScript(ScriptSetting passScript) {
		this.passScript = passScript;
		return this;
	}
	...
	public Namespace withErrorScript(ScriptSetting errorScript) {
		this.errorScript = errorScript;
		return this;
	}
	...
	public int hashCode() {
        ...
        result = prime * result + ((this.lowestStateMachineVersion == null) ? 0 : this.lowestStateMachineVersion.hashCode());
	...
	public boolean equals(Object o) {
		...
		if (supportSpeculativeExecution == null) {
			return other.supportSpeculativeExecution == null;
		} else if (!supportSpeculativeExecution.equals(other.supportSpeculativeExecution)) {
			return false;
		}
		...
		if (startScript == null) {
			return other.startScript == null;
		} else if (!startScript.equals(other.startScript)) {
			return false;
		}
		if (passScript == null) {
			return other.passScript == null;
		} else if (!passScript.equals(other.passScript)) {
			return false;
		}
		if (errorScript == null) {
			return other.errorScript == null;
		} else if (!errorScript.equals(other.errorScript)) {
			return false;
		}
		if (lowestStateMachineVersion == null) {
			return other.lowestStateMachineVersion == null;
		} else if (!lowestStateMachineVersion.equals(other.lowestStateMachineVersion)) {
			return false;
		}
		if (logSetting == null) {
