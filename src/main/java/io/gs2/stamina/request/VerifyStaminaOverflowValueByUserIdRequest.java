...
public class VerifyStaminaOverflowValueByUserIdRequest extends Gs2BasicRequest<VerifyStaminaOverflowValueByUserIdRequest> {
	...
	public VerifyStaminaOverflowValueByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaOverflowValueByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
