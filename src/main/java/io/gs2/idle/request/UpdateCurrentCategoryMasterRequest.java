...
public class UpdateCurrentCategoryMasterRequest extends Gs2BasicRequest<UpdateCurrentCategoryMasterRequest> {
	...
	public UpdateCurrentCategoryMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentCategoryMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentCategoryMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
