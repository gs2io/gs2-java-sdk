...
public class ApplyBuffResult implements IResult, Serializable {
	...
	public ApplyBuffResult withItems(List<BuffEntryModel> items) {
		this.items = items;
		return this;
	}
    ...
    public static ApplyBuffResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
