...
public class GetGuildModelRequest extends Gs2BasicRequest<GetGuildModelRequest> {
	...
	public GetGuildModelRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetGuildModelRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}

    public static GetGuildModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
