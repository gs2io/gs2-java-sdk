...
public class GetInventoryByUserIdResult implements IResult, Serializable {
	...
	public GetInventoryByUserIdResult withItem(Inventory item) {
		this.item = item;
		return this;
	}

    public static GetInventoryByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
