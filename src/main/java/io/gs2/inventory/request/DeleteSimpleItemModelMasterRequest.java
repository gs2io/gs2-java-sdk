...
public class DeleteSimpleItemModelMasterRequest extends Gs2BasicRequest<DeleteSimpleItemModelMasterRequest> {
    ...
    public static DeleteSimpleItemModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
