...
public class VerifyReceiptResult implements IResult, Serializable {
    private Event item;
	...
	public VerifyReceiptResult withItem(Event item) {
		this.item = item;
		return this;
	}

    public static VerifyReceiptResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
