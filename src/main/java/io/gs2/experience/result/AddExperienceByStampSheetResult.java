...
public class AddExperienceByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public AddExperienceByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static AddExperienceByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
