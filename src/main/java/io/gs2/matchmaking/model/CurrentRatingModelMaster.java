...
public class CurrentRatingModelMaster implements IModel, Serializable, Comparable<CurrentRatingModelMaster> {
    ...
    public static CurrentRatingModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentRatingModelMaster other = (CurrentRatingModelMaster) o;
		if (namespaceId == null) {
