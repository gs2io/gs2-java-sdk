...
public class VerifyCounterResult implements IResult, Serializable {
	...
	public VerifyCounterResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static VerifyCounterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
