...
public class DescribeAcceptVersionsRequest extends Gs2BasicRequest<DescribeAcceptVersionsRequest> {
	...
	public DescribeAcceptVersionsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeAcceptVersionsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
