...
public class IncreaseMaximumIdleMinutesByStampSheetRequest extends Gs2BasicRequest<IncreaseMaximumIdleMinutesByStampSheetRequest> {
    ...
    public static IncreaseMaximumIdleMinutesByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
