...
public class VerifyIncludeParticipantByStampTaskResult implements IResult, Serializable {
	...
	public VerifyIncludeParticipantByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyIncludeParticipantByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
