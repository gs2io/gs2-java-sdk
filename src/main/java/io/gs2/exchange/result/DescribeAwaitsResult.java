...
public class DescribeAwaitsResult implements IResult, Serializable {
	...
	public DescribeAwaitsResult withItems(List<Await> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeAwaitsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeAwaitsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
