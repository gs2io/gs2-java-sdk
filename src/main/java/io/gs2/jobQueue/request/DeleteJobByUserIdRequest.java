...
public class DeleteJobByUserIdRequest extends Gs2BasicRequest<DeleteJobByUserIdRequest> {
	...
	public DeleteJobByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static DeleteJobByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
