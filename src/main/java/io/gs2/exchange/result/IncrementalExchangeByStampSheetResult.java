...
import io.gs2.exchange.model.IncrementalRateModel;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class IncrementalExchangeByStampSheetResult implements IResult, Serializable {
    private IncrementalRateModel item;
	...
	public IncrementalRateModel getItem() {
		return item;
	}

	public void setItem(IncrementalRateModel item) {
		this.item = item;
	}

	public IncrementalExchangeByStampSheetResult withItem(IncrementalRateModel item) {
		this.item = item;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public IncrementalExchangeByStampSheetResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static IncrementalExchangeByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new IncrementalExchangeByStampSheetResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : IncrementalRateModel.fromJson(data.get("item")))
