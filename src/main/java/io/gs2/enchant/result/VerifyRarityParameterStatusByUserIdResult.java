...
public class VerifyRarityParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public VerifyRarityParameterStatusByUserIdResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}

    public static VerifyRarityParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
