...
public class UpdateStaminaByUserIdResult implements IResult, Serializable {
	...
	public UpdateStaminaByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public UpdateStaminaByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static UpdateStaminaByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
