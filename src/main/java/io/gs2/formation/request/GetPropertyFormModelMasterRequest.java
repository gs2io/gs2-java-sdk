...
public class GetPropertyFormModelMasterRequest extends Gs2BasicRequest<GetPropertyFormModelMasterRequest> {
	...
	public GetPropertyFormModelMasterRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetPropertyFormModelMasterRequest withPropertyFormModelName(String propertyFormModelName) {
		this.propertyFormModelName = propertyFormModelName;
		return this;
	}

    public static GetPropertyFormModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
