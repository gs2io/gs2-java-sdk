...
public class DescribeFormModelMastersRequest extends Gs2BasicRequest<DescribeFormModelMastersRequest> {
	...
	public DescribeFormModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeFormModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeFormModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
