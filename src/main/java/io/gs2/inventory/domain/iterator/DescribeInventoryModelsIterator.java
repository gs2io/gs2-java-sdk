...
public class DescribeInventoryModelsIterator implements Iterator<InventoryModel>, Iterable<InventoryModel> {
    CacheDatabase cache;
    ...
    public DescribeInventoryModelsIterator(
        CacheDatabase cache,
        Gs2InventoryRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeInventoryModelsResult r = this.client.describeInventoryModels(
