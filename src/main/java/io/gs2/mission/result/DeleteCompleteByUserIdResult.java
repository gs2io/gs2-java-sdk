...
public class DeleteCompleteByUserIdResult implements IResult, Serializable {
	...
	public DeleteCompleteByUserIdResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static DeleteCompleteByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
