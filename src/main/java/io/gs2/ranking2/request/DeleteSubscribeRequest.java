...
public class DeleteSubscribeRequest extends Gs2BasicRequest<DeleteSubscribeRequest> {
	...
	public DeleteSubscribeRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteSubscribeRequest withRankingName(String rankingName) {
		this.rankingName = rankingName;
		return this;
	}
	...
	public DeleteSubscribeRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public DeleteSubscribeRequest withTargetUserId(String targetUserId) {
		this.targetUserId = targetUserId;
		return this;
	}
	...
	public DeleteSubscribeRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeleteSubscribeRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
