...
import io.gs2.guild.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentGuildMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentGuildMasterFromGitHubRequest> {
	...
	public UpdateCurrentGuildMasterFromGitHubRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public UpdateCurrentGuildMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentGuildMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
