...
import io.gs2.enhance.model.UnleashRateModel;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UnleashByStampSheetResult implements IResult, Serializable {
    private UnleashRateModel item;
	...
	public UnleashRateModel getItem() {
		return item;
	}

	public void setItem(UnleashRateModel item) {
		this.item = item;
	}

	public UnleashByStampSheetResult withItem(UnleashRateModel item) {
		this.item = item;
		return this;
	}
	...
	public UnleashByStampSheetResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public UnleashByStampSheetResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public UnleashByStampSheetResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public UnleashByStampSheetResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public UnleashByStampSheetResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public UnleashByStampSheetResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public UnleashByStampSheetResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static UnleashByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new UnleashByStampSheetResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : UnleashRateModel.fromJson(data.get("item")))
