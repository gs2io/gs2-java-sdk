...
public class GetSalesItemGroupMasterResult implements IResult, Serializable {
	...
	public GetSalesItemGroupMasterResult withItem(SalesItemGroupMaster item) {
		this.item = item;
		return this;
	}

    public static GetSalesItemGroupMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
