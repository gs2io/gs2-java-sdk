...
public class UpdateCurrentRateMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentRateMasterResult withItem(CurrentRateMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentRateMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
