...
public class WaitImportUserDataRequest extends Gs2BasicRequest<WaitImportUserDataRequest> {
    ...
    public static WaitImportUserDataRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
