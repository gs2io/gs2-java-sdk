...
public class DescribeReferenceOfByUserIdRequest extends Gs2BasicRequest<DescribeReferenceOfByUserIdRequest> {
	...
	public DescribeReferenceOfByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeReferenceOfByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
