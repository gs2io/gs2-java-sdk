...
public class DescribeGachaMasterRequest extends Gs2BasicRequest<DescribeGachaMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DescribeGachaMaster";
	}
	 ...
	 * @return this
	 */
	public DescribeGachaMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DescribeGachaMasterRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeGachaMasterRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
