...
public class GetEventByTransactionIdResult implements IResult, Serializable {
    private Event item;
	...
	public GetEventByTransactionIdResult withItem(Event item) {
		this.item = item;
		return this;
	}

    public static GetEventByTransactionIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
