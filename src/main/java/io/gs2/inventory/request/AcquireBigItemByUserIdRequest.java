...
public class AcquireBigItemByUserIdRequest extends Gs2BasicRequest<AcquireBigItemByUserIdRequest> {
	...
	public String getAcquireCount() {
		return acquireCount;
	}
	public void setAcquireCount(String acquireCount) {
    ...
    public static AcquireBigItemByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
