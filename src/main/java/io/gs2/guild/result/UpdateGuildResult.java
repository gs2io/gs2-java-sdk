...
public class UpdateGuildResult implements IResult, Serializable {
    private Guild item;
	...
	public UpdateGuildResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static UpdateGuildResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
