...
public class VerifyBigItemByUserIdRequest extends Gs2BasicRequest<VerifyBigItemByUserIdRequest> {
	...
	public VerifyBigItemByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyBigItemByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
