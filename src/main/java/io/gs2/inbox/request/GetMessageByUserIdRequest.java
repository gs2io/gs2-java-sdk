...
public class GetMessageByUserIdRequest extends Gs2BasicRequest<GetMessageByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定してメッセージを取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定してメッセージを取得
     */
     ...
     * メッセージIDを設定
     *
     * @param messageName ユーザーIDを指定してメッセージを取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してメッセージを取得
     */
