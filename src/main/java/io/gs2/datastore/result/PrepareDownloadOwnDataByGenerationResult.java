...
public class PrepareDownloadOwnDataByGenerationResult implements IResult, Serializable {
	...
	public PrepareDownloadOwnDataByGenerationResult withItem(DataObject item) {
		this.item = item;
		return this;
	}
	...
	public PrepareDownloadOwnDataByGenerationResult withFileUrl(String fileUrl) {
		this.fileUrl = fileUrl;
		return this;
	}
	...
	public PrepareDownloadOwnDataByGenerationResult withContentLength(Long contentLength) {
		this.contentLength = contentLength;
		return this;
	}

    public static PrepareDownloadOwnDataByGenerationResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
