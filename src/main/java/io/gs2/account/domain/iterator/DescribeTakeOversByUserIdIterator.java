...
public class DescribeTakeOversByUserIdIterator implements Iterator<TakeOver>, Iterable<TakeOver> {
    CacheDatabase cache;
    ...
    public DescribeTakeOversByUserIdIterator(
        CacheDatabase cache,
        Gs2AccountRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeTakeOversByUserIdResult r = this.client.describeTakeOversByUserId(
