...
public class UpdateNamespaceRequest extends Gs2BasicRequest<UpdateNamespaceRequest> {
	...
	public UpdateNamespaceRequest withBigItemAcquireScript(ScriptSetting bigItemAcquireScript) {
		this.bigItemAcquireScript = bigItemAcquireScript;
		return this;
	}
	...
	public UpdateNamespaceRequest withBigItemConsumeScript(ScriptSetting bigItemConsumeScript) {
		this.bigItemConsumeScript = bigItemConsumeScript;
		return this;
	}
