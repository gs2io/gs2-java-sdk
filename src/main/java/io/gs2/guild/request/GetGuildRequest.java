...
public class GetGuildRequest extends Gs2BasicRequest<GetGuildRequest> {
	...
	public GetGuildRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetGuildRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public GetGuildRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public GetGuildRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}

    public static GetGuildRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
