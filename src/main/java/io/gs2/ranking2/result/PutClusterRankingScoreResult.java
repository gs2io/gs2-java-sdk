...
public class PutClusterRankingScoreResult implements IResult, Serializable {
	...
	public PutClusterRankingScoreResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static PutClusterRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
