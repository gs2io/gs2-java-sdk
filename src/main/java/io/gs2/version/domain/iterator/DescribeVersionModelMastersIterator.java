...
public class DescribeVersionModelMastersIterator implements Iterator<VersionModelMaster>, Iterable<VersionModelMaster> {
    CacheDatabase cache;
    ...
    public DescribeVersionModelMastersIterator(
        CacheDatabase cache,
        Gs2VersionRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeVersionModelMastersResult r = this.client.describeVersionModelMasters(
