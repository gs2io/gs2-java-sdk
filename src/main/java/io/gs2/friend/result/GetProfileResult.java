...
public class GetProfileResult implements IResult, Serializable {
	...
	public GetProfileResult withItem(Profile item) {
		this.item = item;
		return this;
	}

    public static GetProfileResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
