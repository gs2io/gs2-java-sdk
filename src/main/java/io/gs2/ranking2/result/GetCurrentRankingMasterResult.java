...
public class GetCurrentRankingMasterResult implements IResult, Serializable {
	...
	public GetCurrentRankingMasterResult withItem(CurrentRankingMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentRankingMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
