...
public class VerifyAction implements IModel, Serializable {
	...
	public VerifyAction withAction(String action) {
		this.action = action;
		return this;
	}
	...
	public VerifyAction withRequest(String request) {
		this.request = request;
		return this;
	}

    public static VerifyAction fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		VerifyAction other = (VerifyAction) o;
		if (action == null) {
