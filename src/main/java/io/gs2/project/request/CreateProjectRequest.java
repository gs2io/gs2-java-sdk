...
public class CreateProjectRequest extends Gs2BasicRequest<CreateProjectRequest> {
    ...
    private String activateRegionName;
	...
	public String getActivateRegionName() {
		return activateRegionName;
	}
	public void setActivateRegionName(String activateRegionName) {
    ...
    public static CreateProjectRequest fromJson(JsonNode data) {
        ...
        return new CreateProjectRequest()
            ...
            .withActivateRegionName(data.get("activateRegionName") == null || data.get("activateRegionName").isNull() ? null : data.get("activateRegionName").asText())
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                ...
                put("activateRegionName", getActivateRegionName());
