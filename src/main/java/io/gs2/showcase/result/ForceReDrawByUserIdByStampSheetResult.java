...
public class ForceReDrawByUserIdByStampSheetResult implements IResult, Serializable {
	...
	public ForceReDrawByUserIdByStampSheetResult withItems(List<RandomDisplayItem> items) {
		this.items = items;
		return this;
	}

    public static ForceReDrawByUserIdByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
