...
public class DeleteAcceptVersionByUserIdRequest extends Gs2BasicRequest<DeleteAcceptVersionByUserIdRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return ユーザーIDを指定して承認したバージョンを削除
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定して承認したバージョンを削除
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定して承認したバージョンを削除
     */
     ...
     * 承認したバージョン名を設定
     *
     * @param versionName ユーザーIDを指定して承認したバージョンを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定して承認したバージョンを削除
     */
