...
public class DeleteGuildModelMasterRequest extends Gs2BasicRequest<DeleteGuildModelMasterRequest> {
	...
	public DeleteGuildModelMasterRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}

    public static DeleteGuildModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
