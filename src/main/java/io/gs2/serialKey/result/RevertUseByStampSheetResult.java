...
public class RevertUseByStampSheetResult implements IResult, Serializable {
	...
	public RevertUseByStampSheetResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}
	...
	public RevertUseByStampSheetResult withCampaignModel(CampaignModel campaignModel) {
		this.campaignModel = campaignModel;
		return this;
	}

    public static RevertUseByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
