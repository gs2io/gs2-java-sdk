...
public class AcquireForceByUserIdResult implements IResult, Serializable {
    private Await item;
	...
	public AcquireForceByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public AcquireForceByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public AcquireForceByUserIdResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public AcquireForceByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static AcquireForceByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
