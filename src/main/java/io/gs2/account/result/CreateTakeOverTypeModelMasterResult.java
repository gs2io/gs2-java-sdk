...
public class CreateTakeOverTypeModelMasterResult implements IResult, Serializable {
	...
	public CreateTakeOverTypeModelMasterResult withItem(TakeOverTypeModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateTakeOverTypeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
