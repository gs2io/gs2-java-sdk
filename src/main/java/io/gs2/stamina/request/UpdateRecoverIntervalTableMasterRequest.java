...
public class UpdateRecoverIntervalTableMasterRequest extends Gs2BasicRequest<UpdateRecoverIntervalTableMasterRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName スタミナ回復間隔テーブルマスターを更新
     */
     ...
     * スタミナ回復間隔テーブル名を設定
     *
     * @param recoverIntervalTableName スタミナ回復間隔テーブルマスターを更新
     */
     ...
     *
     * @param description スタミナ回復間隔テーブルマスターを更新
     */
     ...
     *
     * @param metadata スタミナ回復間隔テーブルマスターを更新
     */
     ...
     * 経験値の種類マスター のGRNを設定
     *
     * @param experienceModelId スタミナ回復間隔テーブルマスターを更新
     */
     ...
     *
     * @param values スタミナ回復間隔テーブルマスターを更新
     */
