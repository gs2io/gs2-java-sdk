...
public class GetRatingModelMasterRequest extends Gs2BasicRequest<GetRatingModelMasterRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName レーティングモデルマスターを取得
     */
     ...
     * レーティングの種類名を設定
     *
     * @param ratingName レーティングモデルマスターを取得
     */
