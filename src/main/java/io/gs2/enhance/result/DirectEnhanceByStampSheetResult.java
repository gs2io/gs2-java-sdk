...
public class DirectEnhanceByStampSheetResult implements IResult, Serializable {
	 ...
	 *
	 * @param stampSheet スタンプシートで強化を実行
	 */
	 ...
	 *
	 * @param stampSheetEncryptionKeyId スタンプシートで強化を実行
	 */
	 ...
	 * 獲得経験値量を設定
	 *
	 * @param acquireExperience スタンプシートで強化を実行
	 */
