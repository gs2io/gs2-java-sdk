...
public class RejectRequestRequest extends Gs2BasicRequest<RejectRequestRequest> {
	...
	public RejectRequestRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
    ...
    public static RejectRequestRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
