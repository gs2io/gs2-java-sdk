...
import io.gs2.grade.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentGradeMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentGradeMasterFromGitHubRequest> {
	...
	public UpdateCurrentGradeMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentGradeMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
