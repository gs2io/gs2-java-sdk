...
public class AcquirePointByUserIdRequest extends Gs2BasicRequest<AcquirePointByUserIdRequest> {
    ...
    public static AcquirePointByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
