...
public class FreezeMasterDataByTimestampRequest extends Gs2BasicRequest<FreezeMasterDataByTimestampRequest> {
	...
	public FreezeMasterDataByTimestampRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public FreezeMasterDataByTimestampRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
    ...
    public static FreezeMasterDataByTimestampRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
