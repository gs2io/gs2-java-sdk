...
public class IncrementalExchangeResult implements IResult, Serializable {
	...
	public IncrementalExchangeResult withItem(IncrementalRateModel item) {
		this.item = item;
		return this;
	}
	...
	public IncrementalExchangeResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public IncrementalExchangeResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public IncrementalExchangeResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public IncrementalExchangeResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public IncrementalExchangeResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public IncrementalExchangeResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public IncrementalExchangeResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static IncrementalExchangeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
