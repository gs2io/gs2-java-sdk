...
public class UnmarkReceivedByStampSheetResult implements IResult, Serializable {
	...
	public UnmarkReceivedByStampSheetResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public UnmarkReceivedByStampSheetResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static UnmarkReceivedByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
