...
public class NamespaceDomain {
    ...
    public NamespaceDomain(
        ...
        this.parentKey = "schedule:Namespace";
    }
    ...
    private Namespace get(
        ...
        if (result.getItem() != null) {
            cache.put(
                parentKey,
                io.gs2.schedule.domain.model.NamespaceDomain.createCacheKey(
    ...
    public EventMasterDomain createEventMaster(
        CreateEventMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateEventMasterResult result = this.client.createEventMaster(
            request
        );
        ...
        EventMasterDomain domain = new EventMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public EventMasterDomain eventMaster(
        String eventName
    ) {
