...
public class UpdateResourceTypeMasterRequest extends Gs2BasicRequest<UpdateResourceTypeMasterRequest> {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withResourceTypeName(String resourceTypeName) {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withMeta(String meta) {
		setMeta(meta);
		return this;
	}
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withLevelTableName(String levelTableName) {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withDefaultExperience(Long defaultExperience) {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withDefaultLevelCap(Integer defaultLevelCap) {
	 ...
	 * @return this
	 */
	public UpdateResourceTypeMasterRequest withMaxLevelCap(Integer maxLevelCap) {
