...
public class AddRankCapByStampSheetRequest extends Gs2BasicRequest<AddRankCapByStampSheetRequest> {
    ...
    public static AddRankCapByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
