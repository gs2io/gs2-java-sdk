...
public class DescribeIgnoreUsersByGuildNameResult implements IResult, Serializable {
	...
	public DescribeIgnoreUsersByGuildNameResult withItems(List<IgnoreUser> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeIgnoreUsersByGuildNameResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeIgnoreUsersByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
