...
public class GetSubscribeRankingModelRequest extends Gs2BasicRequest<GetSubscribeRankingModelRequest> {
    ...
    public static GetSubscribeRankingModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
