...
public class GetBalanceParameterModelMasterResult implements IResult, Serializable {
	...
	public GetBalanceParameterModelMasterResult withItem(BalanceParameterModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetBalanceParameterModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
