...
public class DescribeNewsByUserIdRequest extends Gs2BasicRequest<DescribeNewsByUserIdRequest> {
     ...
     * ネームスペースの名前を設定
     *
     * @param namespaceName ユーザIDを指定してお知らせ記事の一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してお知らせ記事の一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してお知らせ記事の一覧を取得
     */
