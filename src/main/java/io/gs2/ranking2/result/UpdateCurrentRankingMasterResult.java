...
public class UpdateCurrentRankingMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentRankingMasterResult withItem(CurrentRankingMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentRankingMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
