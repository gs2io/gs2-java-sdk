...
public class EmitByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public EmitByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static EmitByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
