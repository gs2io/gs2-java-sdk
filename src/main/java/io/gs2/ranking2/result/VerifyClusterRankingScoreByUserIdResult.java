...
public class VerifyClusterRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public VerifyClusterRankingScoreByUserIdResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static VerifyClusterRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
