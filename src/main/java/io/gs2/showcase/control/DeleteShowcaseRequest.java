...
public class DeleteShowcaseRequest extends Gs2BasicRequest<DeleteShowcaseRequest> {

	public static class Constant extends Gs2Showcase.Constant {
		public static final String FUNCTION = "DeleteShowcase";
	}
	 ...
	 * @return this
	 */
	public DeleteShowcaseRequest withShowcaseName(String showcaseName) {
