...
public class Gs2EnchantRestClient extends AbstractGs2Client<Gs2EnchantRestClient> {
    ...
    class PreUpdateCurrentParameterMasterTask extends Gs2RestSessionTask<PreUpdateCurrentParameterMasterResult> {
        private PreUpdateCurrentParameterMasterRequest request;

        public PreUpdateCurrentParameterMasterTask(
            PreUpdateCurrentParameterMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentParameterMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentParameterMasterResult parse(JsonNode data) {
            return PreUpdateCurrentParameterMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentParameterMasterAsync(
            PreUpdateCurrentParameterMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentParameterMasterResult>> callback
    ) {
        PreUpdateCurrentParameterMasterTask task = new PreUpdateCurrentParameterMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentParameterMasterResult preUpdateCurrentParameterMaster(
            PreUpdateCurrentParameterMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentParameterMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentParameterMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentParameterMasterTask extends Gs2RestSessionTask<UpdateCurrentParameterMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentParameterMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentParameterMasterTask task = new PreUpdateCurrentParameterMasterTask(
