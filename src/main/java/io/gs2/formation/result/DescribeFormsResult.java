...
public class DescribeFormsResult implements IResult, Serializable {
	...
	public DescribeFormsResult withItems(List<Form> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeFormsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeFormsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeFormsResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<Form>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<Form>() :
