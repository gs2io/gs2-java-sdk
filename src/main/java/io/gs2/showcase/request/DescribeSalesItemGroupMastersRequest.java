...
public class DescribeSalesItemGroupMastersRequest extends Gs2BasicRequest<DescribeSalesItemGroupMastersRequest> {
	...
	public DescribeSalesItemGroupMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeSalesItemGroupMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeSalesItemGroupMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
