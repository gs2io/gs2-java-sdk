...
public class ExitStateMachineByUserIdRequest extends Gs2BasicRequest<ExitStateMachineByUserIdRequest> {
	...
	public ExitStateMachineByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static ExitStateMachineByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
