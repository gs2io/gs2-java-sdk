...
public class PreUpdateCurrentQuestMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentQuestMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentQuestMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentQuestMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
