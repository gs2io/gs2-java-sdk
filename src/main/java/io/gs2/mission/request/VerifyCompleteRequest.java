...
public class VerifyCompleteRequest extends Gs2BasicRequest<VerifyCompleteRequest> {
	...
	public VerifyCompleteRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyCompleteRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
