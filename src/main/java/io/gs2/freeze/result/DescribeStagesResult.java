...
public class DescribeStagesResult implements IResult, Serializable {
	...
	public DescribeStagesResult withItems(List<Stage> items) {
		this.items = items;
		return this;
	}

    public static DescribeStagesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
