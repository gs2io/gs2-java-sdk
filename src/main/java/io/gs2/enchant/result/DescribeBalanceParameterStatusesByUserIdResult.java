...
public class DescribeBalanceParameterStatusesByUserIdResult implements IResult, Serializable {
	...
	public DescribeBalanceParameterStatusesByUserIdResult withItems(List<BalanceParameterStatus> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeBalanceParameterStatusesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeBalanceParameterStatusesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
