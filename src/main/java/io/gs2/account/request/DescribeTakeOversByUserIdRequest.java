...
public class DescribeTakeOversByUserIdRequest extends Gs2BasicRequest<DescribeTakeOversByUserIdRequest> {
	...
	public DescribeTakeOversByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeTakeOversByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeTakeOversByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
