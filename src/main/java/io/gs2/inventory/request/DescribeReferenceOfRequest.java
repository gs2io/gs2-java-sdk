...
public class DescribeReferenceOfRequest extends Gs2BasicRequest<DescribeReferenceOfRequest> {
    ...
    public static DescribeReferenceOfRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
