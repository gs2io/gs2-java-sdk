...
public class DeleteAcceptVersionByUserIdRequest extends Gs2BasicRequest<DeleteAcceptVersionByUserIdRequest> {
	...
	public DeleteAcceptVersionByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static DeleteAcceptVersionByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
