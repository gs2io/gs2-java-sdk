...
import io.gs2.serialKey.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentCampaignMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentCampaignMasterFromGitHubRequest> {
	...
	public UpdateCurrentCampaignMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentCampaignMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
