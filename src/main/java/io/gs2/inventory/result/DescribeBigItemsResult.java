...
public class DescribeBigItemsResult implements IResult, Serializable {
	...
	public DescribeBigItemsResult withItems(List<BigItem> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeBigItemsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeBigItemsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
