...
public class CreateBillingMethodResult implements IResult, Serializable {
	...
	public CreateBillingMethodResult withItem(BillingMethod item) {
		this.item = item;
		return this;
	}

    public static CreateBillingMethodResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
