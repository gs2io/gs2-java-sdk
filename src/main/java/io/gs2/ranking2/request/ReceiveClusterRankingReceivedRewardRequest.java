...
public class ReceiveClusterRankingReceivedRewardRequest extends Gs2BasicRequest<ReceiveClusterRankingReceivedRewardRequest> {
	...
	public ReceiveClusterRankingReceivedRewardRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static ReceiveClusterRankingReceivedRewardRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
