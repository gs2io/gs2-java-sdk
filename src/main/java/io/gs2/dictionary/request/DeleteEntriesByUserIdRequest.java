...
public class DeleteEntriesByUserIdRequest extends Gs2BasicRequest<DeleteEntriesByUserIdRequest> {
	...
	public DeleteEntriesByUserIdRequest withEntryModelNames(List<String> entryModelNames) {
		this.entryModelNames = entryModelNames;
		return this;
	}
    ...
    public static DeleteEntriesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
