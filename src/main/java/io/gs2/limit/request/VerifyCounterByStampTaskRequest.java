...
public class VerifyCounterByStampTaskRequest extends Gs2BasicRequest<VerifyCounterByStampTaskRequest> {
    ...
    public static VerifyCounterByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
