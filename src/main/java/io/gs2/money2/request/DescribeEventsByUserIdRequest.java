...
public class DescribeEventsByUserIdRequest extends Gs2BasicRequest<DescribeEventsByUserIdRequest> {
	...
	public DescribeEventsByUserIdRequest withBegin(Long begin) {
		this.begin = begin;
		return this;
	}
	public Long getEnd() {
	...
	public DescribeEventsByUserIdRequest withEnd(Long end) {
		this.end = end;
		return this;
	}
	...
	public DescribeEventsByUserIdRequest withPageToken(String pageToken) {
		this.pageToken = pageToken;
		return this;
	}
	...
	public DescribeEventsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeEventsByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeEventsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
