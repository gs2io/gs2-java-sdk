...
public class UpdateCurrentRateMasterRequest extends Gs2BasicRequest<UpdateCurrentRateMasterRequest> {
	...
	public UpdateCurrentRateMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentRateMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentRateMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
