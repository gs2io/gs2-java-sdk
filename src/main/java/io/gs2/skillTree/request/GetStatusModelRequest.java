...
public class GetStatusModelRequest extends Gs2BasicRequest<GetStatusModelRequest> {
	...
	public GetStatusModelRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetStatusModelRequest withNodeModelName(String nodeModelName) {
		this.nodeModelName = nodeModelName;
		return this;
	}

    public static GetStatusModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
