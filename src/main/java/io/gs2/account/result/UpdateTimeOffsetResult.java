...
public class UpdateTimeOffsetResult implements IResult, Serializable {
	...
	public UpdateTimeOffsetResult withItem(Account item) {
		this.item = item;
		return this;
	}

    public static UpdateTimeOffsetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
