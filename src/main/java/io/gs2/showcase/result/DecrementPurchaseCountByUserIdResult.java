...
public class DecrementPurchaseCountByUserIdResult implements IResult, Serializable {
	...
	public DecrementPurchaseCountByUserIdResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}

    public static DecrementPurchaseCountByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
