...
public class PreUpdateCurrentEntryMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentEntryMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentEntryMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentEntryMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
