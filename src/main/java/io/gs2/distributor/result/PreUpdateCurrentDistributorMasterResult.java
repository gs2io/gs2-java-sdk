...
public class PreUpdateCurrentDistributorMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentDistributorMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentDistributorMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentDistributorMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
