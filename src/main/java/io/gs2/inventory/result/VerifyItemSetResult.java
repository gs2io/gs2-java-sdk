...
public class VerifyItemSetResult implements IResult, Serializable {
	...
	public VerifyItemSetResult withItems(List<ItemSet> items) {
		this.items = items;
		return this;
	}

    public static VerifyItemSetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
