...
public class PrepareDownloadOwnDataRequest extends Gs2BasicRequest<PrepareDownloadOwnDataRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName データオブジェクトをダウンロード準備する
     */
     ...
     * データの名前を設定
     *
     * @param dataObjectName データオブジェクトをダウンロード準備する
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider データオブジェクトをダウンロード準備する
     */
