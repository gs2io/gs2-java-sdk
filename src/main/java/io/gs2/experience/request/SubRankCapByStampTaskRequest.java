...
public class SubRankCapByStampTaskRequest extends Gs2BasicRequest<SubRankCapByStampTaskRequest> {
    ...
    public static SubRankCapByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
