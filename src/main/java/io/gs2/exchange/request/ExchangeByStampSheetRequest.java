...
public class ExchangeByStampSheetRequest extends Gs2BasicRequest<ExchangeByStampSheetRequest> {
     ...
     * スタンプシートを設定
     *
     * @param stampSheet スタンプシートで交換を実行
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプシートで交換を実行
     */
