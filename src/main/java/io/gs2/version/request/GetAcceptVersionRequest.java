...
public class GetAcceptVersionRequest extends Gs2BasicRequest<GetAcceptVersionRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName 承認したバージョンを取得
     */
     ...
     * 承認したバージョン名を設定
     *
     * @param versionName 承認したバージョンを取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider 承認したバージョンを取得
     */
