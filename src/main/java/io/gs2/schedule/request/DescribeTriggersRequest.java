...
public class DescribeTriggersRequest extends Gs2BasicRequest<DescribeTriggersRequest> {
	...
	public DescribeTriggersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeTriggersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
