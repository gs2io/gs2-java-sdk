...
public class RollbackStageResult implements IResult, Serializable {
    private Stage item;
	...
	public RollbackStageResult withItem(Stage item) {
		this.item = item;
		return this;
	}

    public static RollbackStageResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
