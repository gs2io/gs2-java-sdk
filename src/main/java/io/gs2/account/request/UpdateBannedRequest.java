...
public class UpdateBannedRequest extends Gs2BasicRequest<UpdateBannedRequest> {
	...
	public UpdateBannedRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static UpdateBannedRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
