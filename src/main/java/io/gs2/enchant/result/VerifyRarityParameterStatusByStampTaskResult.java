...
public class VerifyRarityParameterStatusByStampTaskResult implements IResult, Serializable {
	...
	public VerifyRarityParameterStatusByStampTaskResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}
	...
	public VerifyRarityParameterStatusByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyRarityParameterStatusByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
