...
public class GetLotteryModelMasterResult implements IResult, Serializable {
	...
	public GetLotteryModelMasterResult withItem(LotteryModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetLotteryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
