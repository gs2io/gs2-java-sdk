...
public class VerifyCurrentMaximumMemberCountByGuildNameRequest extends Gs2BasicRequest<VerifyCurrentMaximumMemberCountByGuildNameRequest> {
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyCurrentMaximumMemberCountByGuildNameRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyCurrentMaximumMemberCountByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
