...
public class CloseMessageByUserIdResult implements IResult, Serializable {
	...
	public CloseMessageByUserIdResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static CloseMessageByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
