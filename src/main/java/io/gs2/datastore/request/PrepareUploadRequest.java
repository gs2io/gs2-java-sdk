...
public class PrepareUploadRequest extends Gs2BasicRequest<PrepareUploadRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName データオブジェクトをアップロード準備する
     */
     ...
     * データの名前を設定
     *
     * @param name データオブジェクトをアップロード準備する
     */
     ...
     *
     * @param contentType データオブジェクトをアップロード準備する
     */
     ...
     * ファイルのアクセス権を設定
     *
     * @param scope データオブジェクトをアップロード準備する
     */
     ...
     * 公開するユーザIDリストを設定
     *
     * @param allowUserIds データオブジェクトをアップロード準備する
     */
     ...
     *
     * @param updateIfExists データオブジェクトをアップロード準備する
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider データオブジェクトをアップロード準備する
     */
