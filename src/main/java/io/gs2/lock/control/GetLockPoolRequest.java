...
public class GetLockPoolRequest extends Gs2BasicRequest<GetLockPoolRequest> {

	public static class Constant extends Gs2Lock.Constant {
		public static final String FUNCTION = "GetLockPool";
	}
	 ...
	 * @return this
	 */
	public GetLockPoolRequest withLockPoolName(String lockPoolName) {
