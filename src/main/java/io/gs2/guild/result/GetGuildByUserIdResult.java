...
public class GetGuildByUserIdResult implements IResult, Serializable {
    private Guild item;
	...
	public GetGuildByUserIdResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static GetGuildByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
