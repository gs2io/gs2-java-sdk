...
public class UnregisterBlackListRequest extends Gs2BasicRequest<UnregisterBlackListRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ブラックリストからユーザを削除
     */
     ...
     * Noneを設定
     *
     * @param targetUserId ブラックリストからユーザを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ブラックリストからユーザを削除
     */
