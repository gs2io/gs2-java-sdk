...
public class ExtendTriggerByStampSheetResult implements IResult, Serializable {
	...
	public ExtendTriggerByStampSheetResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static ExtendTriggerByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
