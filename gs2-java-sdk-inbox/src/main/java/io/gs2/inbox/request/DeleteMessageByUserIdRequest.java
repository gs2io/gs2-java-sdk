...
public class DeleteMessageByUserIdRequest extends Gs2BasicRequest<DeleteMessageByUserIdRequest> {
     ...
     * プレゼントボックス名を設定
     *
     * @param namespaceName ユーザーIDを指定してメッセージを削除
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定してメッセージを削除
     */
     ...
     * メッセージIDを設定
     *
     * @param messageName ユーザーIDを指定してメッセージを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してメッセージを削除
     */
