...
public class CurrentBonusMaster implements IModel, Serializable, Comparable<CurrentBonusMaster> {
	...
	public CurrentBonusMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentBonusMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentBonusMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentBonusMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentBonusMaster other = (CurrentBonusMaster) o;
		if (namespaceId == null) {
