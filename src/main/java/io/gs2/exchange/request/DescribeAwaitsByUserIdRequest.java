...
public class DescribeAwaitsByUserIdRequest extends Gs2BasicRequest<DescribeAwaitsByUserIdRequest> {
	...
	public DescribeAwaitsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeAwaitsByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeAwaitsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
