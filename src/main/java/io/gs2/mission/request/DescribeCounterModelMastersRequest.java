...
public class DescribeCounterModelMastersRequest extends Gs2BasicRequest<DescribeCounterModelMastersRequest> {
	...
	public DescribeCounterModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeCounterModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeCounterModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
