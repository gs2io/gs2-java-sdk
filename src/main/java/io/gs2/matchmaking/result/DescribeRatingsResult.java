...
public class DescribeRatingsResult implements IResult, Serializable {
	...
	public DescribeRatingsResult withItems(List<Rating> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeRatingsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeRatingsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeRatingsResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<Rating>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<Rating>() :
