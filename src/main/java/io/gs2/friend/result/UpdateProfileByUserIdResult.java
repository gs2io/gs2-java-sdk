...
public class UpdateProfileByUserIdResult implements IResult, Serializable {
	...
	public UpdateProfileByUserIdResult withItem(Profile item) {
		this.item = item;
		return this;
	}

    public static UpdateProfileByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
