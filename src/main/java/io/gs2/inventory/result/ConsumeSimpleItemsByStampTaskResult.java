...
public class ConsumeSimpleItemsByStampTaskResult implements IResult, Serializable {
	...
	public ConsumeSimpleItemsByStampTaskResult withItems(List<SimpleItem> items) {
		this.items = items;
		return this;
	}
    ...
    public static ConsumeSimpleItemsByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
