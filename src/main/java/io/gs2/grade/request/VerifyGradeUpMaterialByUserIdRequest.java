...
public class VerifyGradeUpMaterialByUserIdRequest extends Gs2BasicRequest<VerifyGradeUpMaterialByUserIdRequest> {
    ...
    public static VerifyGradeUpMaterialByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
