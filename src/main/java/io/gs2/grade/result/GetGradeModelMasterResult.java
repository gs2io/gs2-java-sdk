...
public class GetGradeModelMasterResult implements IResult, Serializable {
	...
	public GetGradeModelMasterResult withItem(GradeModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetGradeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
