...
public class AcquireSimpleItemsByStampSheetRequest extends Gs2BasicRequest<AcquireSimpleItemsByStampSheetRequest> {
    ...
    public static AcquireSimpleItemsByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
