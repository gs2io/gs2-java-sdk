...
import io.gs2.version.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentVersionMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentVersionMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentVersionMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
