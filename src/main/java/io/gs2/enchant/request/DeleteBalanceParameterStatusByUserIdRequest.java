...
public class DeleteBalanceParameterStatusByUserIdRequest extends Gs2BasicRequest<DeleteBalanceParameterStatusByUserIdRequest> {
    ...
    public static DeleteBalanceParameterStatusByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
