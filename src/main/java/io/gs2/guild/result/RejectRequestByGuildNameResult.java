...
public class RejectRequestByGuildNameResult implements IResult, Serializable {
	...
	public RejectRequestByGuildNameResult withItem(ReceiveMemberRequest item) {
		this.item = item;
		return this;
	}

    public static RejectRequestByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
