...
public class UpdateCurrentMessageMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentMessageMasterFromGitHubResult withItem(CurrentMessageMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentMessageMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
