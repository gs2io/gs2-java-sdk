...
public class DescribeDailyTransactionHistoriesByCurrencyRequest extends Gs2BasicRequest<DescribeDailyTransactionHistoriesByCurrencyRequest> {
	...
	public DescribeDailyTransactionHistoriesByCurrencyRequest withYear(Integer year) {
		this.year = year;
		return this;
	}
	...
	public DescribeDailyTransactionHistoriesByCurrencyRequest withMonth(Integer month) {
		this.month = month;
		return this;
	}
	...
	public DescribeDailyTransactionHistoriesByCurrencyRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeDailyTransactionHistoriesByCurrencyRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
