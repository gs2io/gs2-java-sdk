...
public class MarkRestrainByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public MarkRestrainByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static MarkRestrainByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
