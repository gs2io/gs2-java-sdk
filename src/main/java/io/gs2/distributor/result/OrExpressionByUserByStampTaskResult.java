...
public class OrExpressionByUserByStampTaskResult implements IResult, Serializable {
	...
	public OrExpressionByUserByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static OrExpressionByUserByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
