...
public class ResetBoxResult implements IResult, Serializable {
	...
	public ResetBoxResult withItem(BoxItems item) {
		this.item = item;
		return this;
	}

    public static ResetBoxResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
