...
public class DeleteReceiveStatusByStampSheetResult implements IResult, Serializable {
	...
	public DeleteReceiveStatusByStampSheetResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public DeleteReceiveStatusByStampSheetResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static DeleteReceiveStatusByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
