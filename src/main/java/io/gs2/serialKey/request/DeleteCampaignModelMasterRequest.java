...
public class DeleteCampaignModelMasterRequest extends Gs2BasicRequest<DeleteCampaignModelMasterRequest> {
    ...
    public static DeleteCampaignModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
