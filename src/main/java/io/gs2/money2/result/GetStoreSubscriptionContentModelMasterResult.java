...
public class GetStoreSubscriptionContentModelMasterResult implements IResult, Serializable {
	...
	public GetStoreSubscriptionContentModelMasterResult withItem(StoreSubscriptionContentModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetStoreSubscriptionContentModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
