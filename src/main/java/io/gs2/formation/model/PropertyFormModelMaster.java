...
public class PropertyFormModelMaster implements IModel, Serializable, Comparable<PropertyFormModelMaster> {
	...
	public PropertyFormModelMaster withSlots(List<SlotModel> slots) {
		this.slots = slots;
		return this;
	}
    ...
    public static PropertyFormModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(PropertyFormModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		PropertyFormModelMaster other = (PropertyFormModelMaster) o;
