...
public class VerifyRankByUserIdRequest extends Gs2BasicRequest<VerifyRankByUserIdRequest> {
	...
	public VerifyRankByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyRankByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
