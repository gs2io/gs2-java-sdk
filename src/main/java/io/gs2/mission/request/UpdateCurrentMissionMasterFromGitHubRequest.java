...
import io.gs2.mission.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentMissionMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentMissionMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentMissionMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
