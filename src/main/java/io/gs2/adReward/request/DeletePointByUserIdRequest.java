...
public class DeletePointByUserIdRequest extends Gs2BasicRequest<DeletePointByUserIdRequest> {
	...
	public DeletePointByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeletePointByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
