...
public class UserAccessTokenDomain {
    ...
    public DescribeCountersIterator counters(
    )
    {
    ...
    public CounterAccessTokenDomain counter(
        String counterName
    ) {
    ...
    public DescribeCompletesIterator completes(
    )
    {
    ...
    public CompleteAccessTokenDomain complete(
