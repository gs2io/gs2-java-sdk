...
public class CreateExperienceModelMasterResult implements IResult, Serializable {
	...
	public CreateExperienceModelMasterResult withItem(ExperienceModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateExperienceModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
