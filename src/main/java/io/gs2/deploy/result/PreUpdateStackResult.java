...
public class PreUpdateStackResult implements IResult, Serializable {
	...
	public PreUpdateStackResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateStackResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateStackResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
