...
public class ConsumeCount implements IModel, Serializable {
	...
	public ConsumeCount withCount(Long count) {
		this.count = count;
		return this;
	}

    public static ConsumeCount fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		ConsumeCount other = (ConsumeCount) o;
		if (itemName == null) {
