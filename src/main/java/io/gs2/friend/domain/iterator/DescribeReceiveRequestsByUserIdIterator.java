...
public class DescribeReceiveRequestsByUserIdIterator implements Iterator<FriendRequest>, Iterable<FriendRequest> {
    CacheDatabase cache;
    ...
    public DescribeReceiveRequestsByUserIdIterator(
        CacheDatabase cache,
        Gs2FriendRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeReceiveRequestsByUserIdResult r = this.client.describeReceiveRequestsByUserId(
