...
public class PreUpdateCurrentShowcaseMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentShowcaseMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentShowcaseMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentShowcaseMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
