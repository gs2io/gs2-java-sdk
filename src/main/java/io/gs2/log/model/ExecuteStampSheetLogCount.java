...
public class ExecuteStampSheetLogCount implements IModel, Serializable {
    ...
    public static ExecuteStampSheetLogCount fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		ExecuteStampSheetLogCount other = (ExecuteStampSheetLogCount) o;
		if (service == null) {
