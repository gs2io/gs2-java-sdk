...
public class GetPrizeTableResult implements IResult, Serializable {
    private PrizeTable item;
    ...
    public static GetPrizeTableResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new GetPrizeTableResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : PrizeTable.fromJson(data.get("item")));
    }
