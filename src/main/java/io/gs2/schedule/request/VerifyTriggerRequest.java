...
public class VerifyTriggerRequest extends Gs2BasicRequest<VerifyTriggerRequest> {
	...
	public VerifyTriggerRequest withElapsedMinutes(Integer elapsedMinutes) {
		this.elapsedMinutes = elapsedMinutes;
		return this;
	}
    ...
    public static VerifyTriggerRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
