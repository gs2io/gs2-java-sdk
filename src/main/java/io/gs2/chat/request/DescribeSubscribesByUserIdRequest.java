...
public class DescribeSubscribesByUserIdRequest extends Gs2BasicRequest<DescribeSubscribesByUserIdRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return ユーザIDを指定して購読しているルームの一覧取得
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定して購読しているルームの一覧取得
     */
     ...
     * 購読するユーザIDを設定
     *
     * @param userId ユーザIDを指定して購読しているルームの一覧取得
     */
     ...
     *
     * @param pageToken ユーザIDを指定して購読しているルームの一覧取得
     */
     ...
     * データの取得件数を設定
     *
     * @param limit ユーザIDを指定して購読しているルームの一覧取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定して購読しているルームの一覧取得
     */
