...
public class GetSimpleItemResult implements IResult, Serializable {
	...
	public GetSimpleItemResult withItem(SimpleItem item) {
		this.item = item;
		return this;
	}
	...
	public GetSimpleItemResult withItemModel(SimpleItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}

    public static GetSimpleItemResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
