...
public class DescribeReferenceOfResult implements IResult, Serializable {
	...
	public DescribeReferenceOfResult withItems(List<String> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeReferenceOfResult withItemSet(ItemSet itemSet) {
		this.itemSet = itemSet;
		return this;
	}
	...
	public DescribeReferenceOfResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public DescribeReferenceOfResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static DescribeReferenceOfResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
