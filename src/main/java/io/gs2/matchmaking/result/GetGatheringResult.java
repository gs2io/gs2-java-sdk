...
public class GetGatheringResult implements IResult, Serializable {
	...
	public GetGatheringResult withItem(Gathering item) {
		this.item = item;
		return this;
	}

    public static GetGatheringResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
