...
import io.gs2.money2.model.Wallet;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class WithdrawByStampTaskResult implements IResult, Serializable {
    private Wallet item;
    private List<DepositTransaction> withdrawTransactions;
	...
	public List<DepositTransaction> getWithdrawTransactions() {
		return withdrawTransactions;
	}

	public void setWithdrawTransactions(List<DepositTransaction> withdrawTransactions) {
		this.withdrawTransactions = withdrawTransactions;
	}

	public WithdrawByStampTaskResult withWithdrawTransactions(List<DepositTransaction> withdrawTransactions) {
		this.withdrawTransactions = withdrawTransactions;
		return this;
	}
