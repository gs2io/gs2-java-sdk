...
public class GetCounterByUserIdRequest extends Gs2BasicRequest<GetCounterByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してカウンターを取得
     */
     ...
     * 回数制限の種類の名前を設定
     *
     * @param limitName ユーザIDを指定してカウンターを取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してカウンターを取得
     */
     ...
     * カウンターの名前を設定
     *
     * @param counterName ユーザIDを指定してカウンターを取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してカウンターを取得
     */
