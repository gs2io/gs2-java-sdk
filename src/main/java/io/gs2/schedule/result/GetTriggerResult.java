...
public class GetTriggerResult implements IResult, Serializable {
	...
	public GetTriggerResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static GetTriggerResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
