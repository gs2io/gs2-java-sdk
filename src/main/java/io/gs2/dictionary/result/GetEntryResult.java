...
public class GetEntryResult implements IResult, Serializable {
    private Entry item;
	...
	public GetEntryResult withItem(Entry item) {
		this.item = item;
		return this;
	}

    public static GetEntryResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
