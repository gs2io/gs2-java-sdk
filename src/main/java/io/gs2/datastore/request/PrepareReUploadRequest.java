...
public class PrepareReUploadRequest extends Gs2BasicRequest<PrepareReUploadRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName データオブジェクトを再アップロード準備する
     */
     ...
     * データの名前を設定
     *
     * @param dataObjectName データオブジェクトを再アップロード準備する
     */
     ...
     *
     * @param contentType データオブジェクトを再アップロード準備する
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider データオブジェクトを再アップロード準備する
     */
