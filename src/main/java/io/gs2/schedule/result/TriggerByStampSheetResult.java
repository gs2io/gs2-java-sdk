...
public class TriggerByStampSheetResult implements IResult, Serializable {
	...
	public TriggerByStampSheetResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static TriggerByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
