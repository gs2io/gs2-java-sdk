...
public class DecrementPurchaseCountByStampSheetResult implements IResult, Serializable {
	...
	public DecrementPurchaseCountByStampSheetResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}

    public static DecrementPurchaseCountByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
