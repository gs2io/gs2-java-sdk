...
public class VerifySimpleItemByUserIdResult implements IResult, Serializable {
	...
	public VerifySimpleItemByUserIdResult withItem(SimpleItem item) {
		this.item = item;
		return this;
	}

    public static VerifySimpleItemByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
