...
public class GetDataObjectHistoryResult implements IResult, Serializable {
	...
	public GetDataObjectHistoryResult withItem(DataObjectHistory item) {
		this.item = item;
		return this;
	}

    public static GetDataObjectHistoryResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
