...
public class RestrainByUserIdRequest extends Gs2BasicRequest<RestrainByUserIdRequest> {
	...
	public RestrainByUserIdRequest withNodeModelNames(List<String> nodeModelNames) {
		this.nodeModelNames = nodeModelNames;
		return this;
	}
	...
	public RestrainByUserIdRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static RestrainByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
