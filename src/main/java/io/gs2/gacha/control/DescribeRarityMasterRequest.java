...
public class DescribeRarityMasterRequest extends Gs2BasicRequest<DescribeRarityMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DescribeRarityMaster";
	}
	 ...
	 * @return this
	 */
	public DescribeRarityMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DescribeRarityMasterRequest withPrizeTableName(String prizeTableName) {
	 ...
	 * @return this
	 */
	public DescribeRarityMasterRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeRarityMasterRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
