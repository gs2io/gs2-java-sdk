...
public class DescribeSecurityPoliciesIterator implements Iterator<SecurityPolicy>, Iterable<SecurityPolicy> {
    CacheDatabase cache;
    ...
    public DescribeSecurityPoliciesIterator(
        CacheDatabase cache,
        Gs2IdentifierRestClient client
    ) {
        this.cache = cache;
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeSecurityPoliciesResult r = this.client.describeSecurityPolicies(
