...
public class UnregisterBlackListResult implements IResult, Serializable {
	...
	public UnregisterBlackListResult withItem(BlackList item) {
		this.item = item;
		return this;
	}

    public static UnregisterBlackListResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
