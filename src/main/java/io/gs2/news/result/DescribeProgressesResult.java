...
import io.gs2.news.model.Progress;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class DescribeProgressesResult implements IResult, Serializable {
	...
	public DescribeProgressesResult withItems(List<Progress> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeProgressesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeProgressesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
