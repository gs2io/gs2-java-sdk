...
public class VerifyGradeUpMaterialByStampTaskResult implements IResult, Serializable {
	...
	public VerifyGradeUpMaterialByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyGradeUpMaterialByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
