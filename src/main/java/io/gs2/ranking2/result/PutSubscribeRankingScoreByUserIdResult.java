...
public class PutSubscribeRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public PutSubscribeRankingScoreByUserIdResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static PutSubscribeRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
