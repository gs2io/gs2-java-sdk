...
public class DeleteStaminaByUserIdRequest extends Gs2BasicRequest<DeleteStaminaByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してスタミナを削除
     */
     ...
     * スタミナの種類名を設定
     *
     * @param staminaName ユーザIDを指定してスタミナを削除
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してスタミナを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してスタミナを削除
     */
