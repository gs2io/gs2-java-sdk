...
public class GetSubscriptionStatusResult implements IResult, Serializable {
	...
	public GetSubscriptionStatusResult withItem(SubscriptionStatus item) {
		this.item = item;
		return this;
	}

    public static GetSubscriptionStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
