...
public class MarkRestrainByStampTaskRequest extends Gs2BasicRequest<MarkRestrainByStampTaskRequest> {
    ...
    public static MarkRestrainByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
