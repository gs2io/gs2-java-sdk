...
public class UpdateCurrentEventMasterFromGitHubResult implements IResult, Serializable {
    ...
    public static UpdateCurrentEventMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
