...
public class UpdateCurrentIdleMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentIdleMasterResult withItem(CurrentCategoryMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentIdleMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
