...
public class VerifyStaminaValueByUserIdRequest extends Gs2BasicRequest<VerifyStaminaValueByUserIdRequest> {
	...
	public VerifyStaminaValueByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public VerifyStaminaValueByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaValueByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
