...
public class GetGuildResult implements IResult, Serializable {
    private Guild item;
	...
	public GetGuildResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static GetGuildResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
