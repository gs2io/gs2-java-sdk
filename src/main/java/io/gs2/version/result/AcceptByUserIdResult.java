...
public class AcceptByUserIdResult implements IResult, Serializable {
	...
	public AcceptByUserIdResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static AcceptByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
