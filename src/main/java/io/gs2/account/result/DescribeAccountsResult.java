...
public class DescribeAccountsResult implements IResult, Serializable {
	...
	public DescribeAccountsResult withItems(List<Account> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeAccountsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeAccountsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeAccountsResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<Account>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<Account>() :
