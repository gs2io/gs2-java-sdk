...
public class OpenMessageResult implements IResult, Serializable {
	...
	public OpenMessageResult withItem(Message item) {
		this.item = item;
		return this;
	}

    public static OpenMessageResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
