...
public class CurrentStaminaMaster implements IModel, Serializable, Comparable<CurrentStaminaMaster> {
	...
	public CurrentStaminaMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
    ...
    public static CurrentStaminaMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentStaminaMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentStaminaMaster other = (CurrentStaminaMaster) o;
		if (namespaceId == null) {
