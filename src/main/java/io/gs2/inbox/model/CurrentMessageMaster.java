...
public class CurrentMessageMaster implements IModel, Serializable, Comparable<CurrentMessageMaster> {
	...
	public CurrentMessageMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
    ...
    public static CurrentMessageMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentMessageMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentMessageMaster other = (CurrentMessageMaster) o;
		if (namespaceId == null) {
