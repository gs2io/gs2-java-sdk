...
public class PingByUserIdResult implements IResult, Serializable {
	...
	public PingByUserIdResult withItem(Gathering item) {
		this.item = item;
		return this;
	}

    public static PingByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
