...
public class DisplayItemMasterDomain {
    ...
    public DisplayItemMasterDomain(
        CacheDatabase cache,
    ...
    public DisplayItemMaster model() {
        DisplayItemMaster value = cache.get(
            parentKey,
            io.gs2.showcase.domain.model.DisplayItemMasterDomain.createCacheKey(
            ),
            DisplayItemMaster.class
        );
        return value;
    }
