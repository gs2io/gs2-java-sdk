...
public class SubGradeByStampTaskRequest extends Gs2BasicRequest<SubGradeByStampTaskRequest> {
	...
	public SubGradeByStampTaskRequest withStampTask(String stampTask) {
		this.stampTask = stampTask;
		return this;
	}
	...
	public SubGradeByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static SubGradeByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
