...
public class DeleteTakeOverResult implements IResult, Serializable {
	...
	public DeleteTakeOverResult withItem(TakeOver item) {
		this.item = item;
		return this;
	}

    public static DeleteTakeOverResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
