...
public class UpdateCurrentItemModelMasterRequest extends Gs2BasicRequest<UpdateCurrentItemModelMasterRequest> {
	...
	public UpdateCurrentItemModelMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentItemModelMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentItemModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
