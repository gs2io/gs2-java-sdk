...
public class CreateStoreSubscriptionContentModelMasterResult implements IResult, Serializable {
	...
	public CreateStoreSubscriptionContentModelMasterResult withItem(StoreSubscriptionContentModelMaster item) {
		this.item = item;
		return this;
	}

    public static CreateStoreSubscriptionContentModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
