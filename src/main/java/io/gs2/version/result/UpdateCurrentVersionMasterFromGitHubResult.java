...
public class UpdateCurrentVersionMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentVersionMasterFromGitHubResult withItem(CurrentVersionMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentVersionMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
