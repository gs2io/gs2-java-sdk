...
public class DescribeBlackListIterator implements Iterator<String>, Iterable<String> {
    CacheDatabase cache;
    ...
    public DescribeBlackListIterator(
        CacheDatabase cache,
        Gs2FriendRestClient client,
        String namespaceName,
        AccessToken accessToken
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeBlackListResult r = this.client.describeBlackList(
