...
public class SubRankCapByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public SubRankCapByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static SubRankCapByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
