...
public class SubCapacityByStampTaskRequest extends Gs2BasicRequest<SubCapacityByStampTaskRequest> {
	...
	public SubCapacityByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static SubCapacityByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
