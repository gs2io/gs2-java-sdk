...
public class SetFirebaseTokenByUserIdResult implements IResult, Serializable {
	...
	public SetFirebaseTokenByUserIdResult withItem(FirebaseToken item) {
		this.item = item;
		return this;
	}

    public static SetFirebaseTokenByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
