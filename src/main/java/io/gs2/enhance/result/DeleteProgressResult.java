...
public class DeleteProgressResult implements IResult, Serializable {
	...
	public DeleteProgressResult withItem(Progress item) {
		this.item = item;
		return this;
	}

    public static DeleteProgressResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
