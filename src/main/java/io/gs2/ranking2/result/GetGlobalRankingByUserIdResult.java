...
public class GetGlobalRankingByUserIdResult implements IResult, Serializable {
	...
	public GetGlobalRankingByUserIdResult withItem(GlobalRankingData item) {
		this.item = item;
		return this;
	}

    public static GetGlobalRankingByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
