...
public class DeleteIgnoreUserByGuildNameResult implements IResult, Serializable {
	...
	public DeleteIgnoreUserByGuildNameResult withItem(IgnoreUser item) {
		this.item = item;
		return this;
	}

    public static DeleteIgnoreUserByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
