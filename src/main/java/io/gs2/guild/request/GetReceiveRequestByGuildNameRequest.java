...
public class GetReceiveRequestByGuildNameRequest extends Gs2BasicRequest<GetReceiveRequestByGuildNameRequest> {
	...
	public GetReceiveRequestByGuildNameRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetReceiveRequestByGuildNameRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public GetReceiveRequestByGuildNameRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}
	...
	public GetReceiveRequestByGuildNameRequest withFromUserId(String fromUserId) {
		this.fromUserId = fromUserId;
		return this;
	}

    public static GetReceiveRequestByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
