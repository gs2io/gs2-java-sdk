...
public class GetStatusResult implements IResult, Serializable {
    private Status item;
	...
	public GetStatusResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static GetStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
