...
public class PreUpdateCurrentLotteryMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentLotteryMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentLotteryMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentLotteryMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
