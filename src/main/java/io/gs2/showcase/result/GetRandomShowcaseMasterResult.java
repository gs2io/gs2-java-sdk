...
public class GetRandomShowcaseMasterResult implements IResult, Serializable {
	...
	public GetRandomShowcaseMasterResult withItem(RandomShowcaseMaster item) {
		this.item = item;
		return this;
	}

    public static GetRandomShowcaseMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
