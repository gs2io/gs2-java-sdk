...
public class CreateDistributorModelMasterResult implements IResult, Serializable {
    ...
    public static CreateDistributorModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
