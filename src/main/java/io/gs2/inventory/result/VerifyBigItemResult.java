...
public class VerifyBigItemResult implements IResult, Serializable {
	...
	public VerifyBigItemResult withItem(BigItem item) {
		this.item = item;
		return this;
	}

    public static VerifyBigItemResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
