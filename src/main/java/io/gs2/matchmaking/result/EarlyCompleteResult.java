...
public class EarlyCompleteResult implements IResult, Serializable {
	...
	public EarlyCompleteResult withItem(Gathering item) {
		this.item = item;
		return this;
	}

    public static EarlyCompleteResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
