...
public class DeleteBonusModelMasterRequest extends Gs2BasicRequest<DeleteBonusModelMasterRequest> {
	...
	public DeleteBonusModelMasterRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteBonusModelMasterRequest withBonusModelName(String bonusModelName) {
		this.bonusModelName = bonusModelName;
		return this;
	}

    public static DeleteBonusModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
