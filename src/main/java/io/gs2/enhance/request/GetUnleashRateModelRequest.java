...
public class GetUnleashRateModelRequest extends Gs2BasicRequest<GetUnleashRateModelRequest> {
	...
	public GetUnleashRateModelRequest withRateName(String rateName) {
		this.rateName = rateName;
		return this;
	}

    public static GetUnleashRateModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
