...
public class DeleteQuestModelMasterRequest extends Gs2BasicRequest<DeleteQuestModelMasterRequest> {
     ...
     * カテゴリ名を設定
     *
     * @param namespaceName クエストモデルマスターを削除
     */
     ...
     * クエストグループモデル名を設定
     *
     * @param questGroupName クエストモデルマスターを削除
     */
     ...
     * クエスト名を設定
     *
     * @param questName クエストモデルマスターを削除
     */
