...
public class DescribeAcceptVersionsResult implements IResult, Serializable {
	...
	public DescribeAcceptVersionsResult withItems(List<AcceptVersion> items) {
		this.items = items;
		return this;
	}
    ...
    public static DescribeAcceptVersionsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
