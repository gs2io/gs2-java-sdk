...
public class DeletePrizeTableMasterResult implements IResult, Serializable {
	...
	public DeletePrizeTableMasterResult withItem(PrizeTableMaster item) {
		this.item = item;
		return this;
	}

    public static DeletePrizeTableMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
