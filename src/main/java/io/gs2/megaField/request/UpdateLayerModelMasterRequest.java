...
public class UpdateLayerModelMasterRequest extends Gs2BasicRequest<UpdateLayerModelMasterRequest> {
    ...
    public static UpdateLayerModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
