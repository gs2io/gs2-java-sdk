...
public class SubscribeByUserIdResult implements IResult, Serializable {
	...
	public SubscribeByUserIdResult withItem(Subscribe item) {
		this.item = item;
		return this;
	}

    public static SubscribeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
