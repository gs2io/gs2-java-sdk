...
public class DescribeBonusModelMastersRequest extends Gs2BasicRequest<DescribeBonusModelMastersRequest> {
	...
	public DescribeBonusModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeBonusModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeBonusModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
