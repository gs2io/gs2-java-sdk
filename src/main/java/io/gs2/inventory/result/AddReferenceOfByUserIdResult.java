...
public class AddReferenceOfByUserIdResult implements IResult, Serializable {
	...
	public AddReferenceOfByUserIdResult withItem(List<String> item) {
		this.item = item;
		return this;
	}
	...
	public AddReferenceOfByUserIdResult withItemSet(ItemSet itemSet) {
		this.itemSet = itemSet;
		return this;
	}
	...
	public AddReferenceOfByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public AddReferenceOfByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static AddReferenceOfByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
