...
public class DescribeTakeOversRequest extends Gs2BasicRequest<DescribeTakeOversRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName 引き継ぎ設定の一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider 引き継ぎ設定の一覧を取得
     */
