...
public class DeleteRarityMasterRequest extends Gs2BasicRequest<DeleteRarityMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DeleteRarityMaster";
	}
	 ...
	 * @return this
	 */
	public DeleteRarityMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DeleteRarityMasterRequest withPrizeTableName(String prizeTableName) {
	 ...
	 * @return this
	 */
	public DeleteRarityMasterRequest withRarityName(String rarityName) {
