...
public class GetPropertyFormModelMasterResult implements IResult, Serializable {
	...
	public GetPropertyFormModelMasterResult withItem(PropertyFormModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetPropertyFormModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
