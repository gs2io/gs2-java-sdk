...
public class AcquireBigItemByUserIdResult implements IResult, Serializable {
	...
	public AcquireBigItemByUserIdResult withItem(BigItem item) {
		this.item = item;
		return this;
	}

    public static AcquireBigItemByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
