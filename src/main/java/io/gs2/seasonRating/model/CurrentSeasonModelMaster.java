...
public class CurrentSeasonModelMaster implements IModel, Serializable, Comparable<CurrentSeasonModelMaster> {
	...
	public CurrentSeasonModelMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentSeasonModelMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentSeasonModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentSeasonModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentSeasonModelMaster other = (CurrentSeasonModelMaster) o;
		if (namespaceId == null) {
