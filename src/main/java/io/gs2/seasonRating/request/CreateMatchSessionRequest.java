...
public class CreateMatchSessionRequest extends Gs2BasicRequest<CreateMatchSessionRequest> {
    ...
    public static CreateMatchSessionRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new CreateMatchSessionRequest()
            ...
            .withTtlSeconds(data.get("ttlSeconds") == null || data.get("ttlSeconds").isNull() ? null : data.get("ttlSeconds").intValue());
    }
