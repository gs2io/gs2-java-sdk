...
public class CountExecuteStampTaskLogIterator implements Iterator<ExecuteStampTaskLogCount>, Iterable<ExecuteStampTaskLogCount> {
    CacheDatabase cache;
    ...
    public CountExecuteStampTaskLogIterator(
        CacheDatabase cache,
        Gs2LogRestClient client,
        String namespaceName,
        Boolean service,
    ...
    private void load() {
        ...
        CountExecuteStampTaskLogResult r = this.client.countExecuteStampTaskLog(
