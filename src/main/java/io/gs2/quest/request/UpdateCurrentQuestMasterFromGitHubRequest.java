...
import io.gs2.quest.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentQuestMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentQuestMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentQuestMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
