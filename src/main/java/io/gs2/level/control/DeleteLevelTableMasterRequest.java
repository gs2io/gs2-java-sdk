...
public class DeleteLevelTableMasterRequest extends Gs2BasicRequest<DeleteLevelTableMasterRequest> {

	public static class Constant extends Gs2Level.Constant {
		public static final String FUNCTION = "DeleteLevelTableMaster";
	}
	 ...
	 * @return this
	 */
	public DeleteLevelTableMasterRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public DeleteLevelTableMasterRequest withLevelTableName(String levelTableName) {
