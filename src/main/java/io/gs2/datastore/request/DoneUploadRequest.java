...
public class DoneUploadRequest extends Gs2BasicRequest<DoneUploadRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return データオブジェクトのアップロード完了を報告する
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName データオブジェクトのアップロード完了を報告する
     */
     ...
     * データの名前を設定
     *
     * @param dataObjectName データオブジェクトのアップロード完了を報告する
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider データオブジェクトのアップロード完了を報告する
     */
