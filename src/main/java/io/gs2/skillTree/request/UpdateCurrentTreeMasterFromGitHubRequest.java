...
import io.gs2.skillTree.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentTreeMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentTreeMasterFromGitHubRequest> {
	...
	public UpdateCurrentTreeMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentTreeMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
