...
public class ReceiveGlobalMessageResult implements IResult, Serializable {
	...
	public ReceiveGlobalMessageResult withItem(List<Message> item) {
		this.item = item;
		return this;
	}

    public static ReceiveGlobalMessageResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
