...
public class Gs2QuestRestClient extends AbstractGs2Client<Gs2QuestRestClient> {
    ...
    class CreateNamespaceTask extends Gs2RestSessionTask<CreateNamespaceResult> {
        ...
        protected void executeImpl() {
            ...
            if (this.request.getStartQuestTriggerScriptId() != null) {
                json.put("startQuestTriggerScriptId", this.request.getStartQuestTriggerScriptId());
            }
            if (this.request.getStartQuestDoneTriggerScriptId() != null) {
                json.put("startQuestDoneTriggerScriptId", this.request.getStartQuestDoneTriggerScriptId());
            }
            if (this.request.getStartQuestDoneTriggerQueueNamespaceId() != null) {
                json.put("startQuestDoneTriggerQueueNamespaceId", this.request.getStartQuestDoneTriggerQueueNamespaceId());
            }
            if (this.request.getCompleteQuestTriggerScriptId() != null) {
                json.put("completeQuestTriggerScriptId", this.request.getCompleteQuestTriggerScriptId());
            }
            if (this.request.getCompleteQuestDoneTriggerScriptId() != null) {
                json.put("completeQuestDoneTriggerScriptId", this.request.getCompleteQuestDoneTriggerScriptId());
            }
            if (this.request.getCompleteQuestDoneTriggerQueueNamespaceId() != null) {
                json.put("completeQuestDoneTriggerQueueNamespaceId", this.request.getCompleteQuestDoneTriggerQueueNamespaceId());
            }
            if (this.request.getFailedQuestTriggerScriptId() != null) {
                json.put("failedQuestTriggerScriptId", this.request.getFailedQuestTriggerScriptId());
            }
            if (this.request.getFailedQuestDoneTriggerScriptId() != null) {
                json.put("failedQuestDoneTriggerScriptId", this.request.getFailedQuestDoneTriggerScriptId());
            }
            if (this.request.getFailedQuestDoneTriggerQueueNamespaceId() != null) {
                json.put("failedQuestDoneTriggerQueueNamespaceId", this.request.getFailedQuestDoneTriggerQueueNamespaceId());
            }
