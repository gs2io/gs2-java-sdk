...
public class AutoRunTransactionSetting implements IModel, Serializable {
    ...
    public static AutoRunTransactionSetting fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		AutoRunTransactionSetting other = (AutoRunTransactionSetting) o;
