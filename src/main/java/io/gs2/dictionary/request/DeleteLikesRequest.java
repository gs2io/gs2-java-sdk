...
public class DeleteLikesRequest extends Gs2BasicRequest<DeleteLikesRequest> {
	...
	public DeleteLikesRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteLikesRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public DeleteLikesRequest withEntryModelNames(List<String> entryModelNames) {
		this.entryModelNames = entryModelNames;
		return this;
	}
	...
	public DeleteLikesRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeleteLikesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
