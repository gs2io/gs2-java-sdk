...
public class MarkReceivedResult implements IResult, Serializable {
	...
	public MarkReceivedResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public MarkReceivedResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static MarkReceivedResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
