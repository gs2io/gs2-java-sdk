...
public class CreateClusterRankingModelMasterRequest extends Gs2BasicRequest<CreateClusterRankingModelMasterRequest> {
	...
	public CreateClusterRankingModelMasterRequest withSum(Boolean sum) {
		this.sum = sum;
		return this;
	}
	...
	public CreateClusterRankingModelMasterRequest withRankingRewards(List<RankingReward> rankingRewards) {
		this.rankingRewards = rankingRewards;
		return this;
	}
    ...
    public static CreateClusterRankingModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
