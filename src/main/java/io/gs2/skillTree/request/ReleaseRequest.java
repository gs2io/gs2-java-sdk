...
public class ReleaseRequest extends Gs2BasicRequest<ReleaseRequest> {
	...
	public ReleaseRequest withNodeModelNames(List<String> nodeModelNames) {
		this.nodeModelNames = nodeModelNames;
		return this;
	}
	...
	public ReleaseRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static ReleaseRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
