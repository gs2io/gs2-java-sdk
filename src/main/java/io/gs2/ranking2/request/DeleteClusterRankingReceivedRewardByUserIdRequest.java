...
public class DeleteClusterRankingReceivedRewardByUserIdRequest extends Gs2BasicRequest<DeleteClusterRankingReceivedRewardByUserIdRequest> {
    ...
    public static DeleteClusterRankingReceivedRewardByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
