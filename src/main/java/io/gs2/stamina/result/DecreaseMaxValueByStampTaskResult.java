...
public class DecreaseMaxValueByStampTaskResult implements IResult, Serializable {
	...
	public DecreaseMaxValueByStampTaskResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseMaxValueByStampTaskResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}
	...
	public DecreaseMaxValueByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static DecreaseMaxValueByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
