...
public class QueryAccessLogWithTelemetryRequest extends Gs2BasicRequest<QueryAccessLogWithTelemetryRequest> {
	...
	public QueryAccessLogWithTelemetryRequest withLongTerm(Boolean longTerm) {
		this.longTerm = longTerm;
		return this;
	}
	...
	public QueryAccessLogWithTelemetryRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
    ...
    public static QueryAccessLogWithTelemetryRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
