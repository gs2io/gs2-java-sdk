...
public class GetLastGuildMasterActivityResult implements IResult, Serializable {
	...
	public GetLastGuildMasterActivityResult withItem(LastGuildMasterActivity item) {
		this.item = item;
		return this;
	}
	...
	public GetLastGuildMasterActivityResult withGuild(Guild guild) {
		this.guild = guild;
		return this;
	}

    public static GetLastGuildMasterActivityResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
