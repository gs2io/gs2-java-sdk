...
public class QueryIssueStampSheetLogResult implements IResult, Serializable {
    ...
    public static QueryIssueStampSheetLogResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new QueryIssueStampSheetLogResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<IssueStampSheetLog>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<IssueStampSheetLog>() :
