...
public class SetRankCapByUserIdResult implements IResult, Serializable {
	...
	public SetRankCapByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SetRankCapByUserIdResult withOld(Status old) {
		this.old = old;
		return this;
	}

    public static SetRankCapByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
