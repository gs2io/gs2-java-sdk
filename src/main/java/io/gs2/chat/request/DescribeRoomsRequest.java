...
public class DescribeRoomsRequest extends Gs2BasicRequest<DescribeRoomsRequest> {
	...
	public DescribeRoomsRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeRoomsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeRoomsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
