...
public class ConsumeBigItemByStampTaskResult implements IResult, Serializable {
	...
	public ConsumeBigItemByStampTaskResult withItem(BigItem item) {
		this.item = item;
		return this;
	}
	...
	public ConsumeBigItemByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static ConsumeBigItemByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
