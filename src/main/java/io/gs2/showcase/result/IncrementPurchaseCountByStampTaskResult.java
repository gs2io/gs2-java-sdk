...
public class IncrementPurchaseCountByStampTaskResult implements IResult, Serializable {
	...
	public IncrementPurchaseCountByStampTaskResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}
	...
	public IncrementPurchaseCountByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static IncrementPurchaseCountByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
