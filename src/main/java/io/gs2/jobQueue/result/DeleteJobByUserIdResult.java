...
public class DeleteJobByUserIdResult implements IResult, Serializable {
    private Job item;
	...
	public DeleteJobByUserIdResult withItem(Job item) {
		this.item = item;
		return this;
	}

    public static DeleteJobByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
