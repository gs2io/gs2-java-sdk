...
public class GetGradeModelMasterRequest extends Gs2BasicRequest<GetGradeModelMasterRequest> {
    ...
    public static GetGradeModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
