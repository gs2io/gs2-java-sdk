...
public class GetLevelThresholdMasterRequest extends Gs2BasicRequest<GetLevelThresholdMasterRequest> {

	public static class Constant extends Gs2Level.Constant {
		public static final String FUNCTION = "GetLevelThresholdMaster";
	}
	 ...
	 * @return this
	 */
	public GetLevelThresholdMasterRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public GetLevelThresholdMasterRequest withLevelTableName(String levelTableName) {
	 ...
	 * @return this
	 */
	public GetLevelThresholdMasterRequest withThreshold(Long threshold) {
