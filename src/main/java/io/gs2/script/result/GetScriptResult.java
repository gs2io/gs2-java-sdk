...
public class GetScriptResult implements IResult, Serializable {
    private Script item;
	...
	public GetScriptResult withItem(Script item) {
		this.item = item;
		return this;
	}

    public static GetScriptResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
