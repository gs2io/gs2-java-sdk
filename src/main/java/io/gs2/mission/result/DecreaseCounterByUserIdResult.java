...
public class DecreaseCounterByUserIdResult implements IResult, Serializable {
	...
	public DecreaseCounterByUserIdResult withItem(Counter item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseCounterByUserIdResult withChangedCompletes(List<Complete> changedCompletes) {
		this.changedCompletes = changedCompletes;
		return this;
	}

    public static DecreaseCounterByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
