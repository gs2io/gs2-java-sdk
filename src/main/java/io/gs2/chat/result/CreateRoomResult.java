...
public class CreateRoomResult implements IResult, Serializable {
    private Room item;
	...
	public CreateRoomResult withItem(Room item) {
		this.item = item;
		return this;
	}

    public static CreateRoomResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
