...
public class ExitStateMachineRequest extends Gs2BasicRequest<ExitStateMachineRequest> {
	...
	public ExitStateMachineRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static ExitStateMachineRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
