...
public class ReceiptDomain {
    ...
    public ReceiptDomain getByUserIdAndTransactionId(
        ...
        GetByUserIdAndTransactionIdResult result = this.client.getByUserIdAndTransactionId(
            request
        );
        ...
        if (result.getItem() != null) {
            cache.put(
                ...
                io.gs2.money.domain.model.ReceiptDomain.createCacheKey(
                    request.getTransactionId() != null ? request.getTransactionId().toString() : null
                ),
                result.getItem(),
