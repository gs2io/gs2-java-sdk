...
public class DeleteTakeOverTypeModelMasterResult implements IResult, Serializable {
	...
	public DeleteTakeOverTypeModelMasterResult withItem(TakeOverTypeModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteTakeOverTypeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
