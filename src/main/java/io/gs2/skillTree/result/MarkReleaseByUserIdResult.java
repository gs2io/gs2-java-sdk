...
public class MarkReleaseByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public MarkReleaseByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static MarkReleaseByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
