...
public class GetBalanceParameterModelMasterRequest extends Gs2BasicRequest<GetBalanceParameterModelMasterRequest> {
    ...
    public static GetBalanceParameterModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
