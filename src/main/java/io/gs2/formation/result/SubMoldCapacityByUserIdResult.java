...
public class SubMoldCapacityByUserIdResult implements IResult, Serializable {
    private Mold item;
	...
	public SubMoldCapacityByUserIdResult withItem(Mold item) {
		this.item = item;
		return this;
	}
	...
	public SubMoldCapacityByUserIdResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}

    public static SubMoldCapacityByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
