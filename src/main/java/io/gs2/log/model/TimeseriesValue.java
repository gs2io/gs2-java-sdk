...
public class TimeseriesValue implements IModel, Serializable {
	private String key;
	...
	public TimeseriesValue withKey(String key) {
		this.key = key;
		return this;
	}
	...
	public TimeseriesValue withValue(Double value) {
		this.value = value;
		return this;
	}

    public static TimeseriesValue fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
