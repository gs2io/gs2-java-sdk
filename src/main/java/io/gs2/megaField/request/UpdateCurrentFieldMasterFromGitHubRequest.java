...
import io.gs2.megaField.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentFieldMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentFieldMasterFromGitHubRequest> {
	...
	public UpdateCurrentFieldMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentFieldMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
