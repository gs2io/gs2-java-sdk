...
public class DescribeMessagesByUserIdResult implements IResult, Serializable {
	...
	public DescribeMessagesByUserIdResult withItems(List<Message> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeMessagesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeMessagesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
