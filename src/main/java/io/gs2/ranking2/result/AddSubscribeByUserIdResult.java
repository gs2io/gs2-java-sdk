...
public class AddSubscribeByUserIdResult implements IResult, Serializable {
	...
	public AddSubscribeByUserIdResult withItem(SubscribeUser item) {
		this.item = item;
		return this;
	}

    public static AddSubscribeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
