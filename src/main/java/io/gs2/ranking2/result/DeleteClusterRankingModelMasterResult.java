...
public class DeleteClusterRankingModelMasterResult implements IResult, Serializable {
	...
	public DeleteClusterRankingModelMasterResult withItem(ClusterRankingModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteClusterRankingModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
