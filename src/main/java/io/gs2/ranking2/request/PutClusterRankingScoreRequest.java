...
public class PutClusterRankingScoreRequest extends Gs2BasicRequest<PutClusterRankingScoreRequest> {
    ...
    public static PutClusterRankingScoreRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
