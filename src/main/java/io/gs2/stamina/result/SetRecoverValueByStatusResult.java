...
public class SetRecoverValueByStatusResult implements IResult, Serializable {
	...
	public SetRecoverValueByStatusResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetRecoverValueByStatusResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetRecoverValueByStatusResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetRecoverValueByStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
