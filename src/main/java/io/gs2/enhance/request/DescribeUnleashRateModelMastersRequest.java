...
public class DescribeUnleashRateModelMastersRequest extends Gs2BasicRequest<DescribeUnleashRateModelMastersRequest> {
	...
	public DescribeUnleashRateModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeUnleashRateModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeUnleashRateModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
