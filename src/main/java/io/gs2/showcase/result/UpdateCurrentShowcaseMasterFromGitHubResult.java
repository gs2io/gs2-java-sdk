...
public class UpdateCurrentShowcaseMasterFromGitHubResult implements IResult, Serializable {
    ...
    public static UpdateCurrentShowcaseMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new UpdateCurrentShowcaseMasterFromGitHubResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : CurrentShowcaseMaster.fromJson(data.get("item")));
    }
