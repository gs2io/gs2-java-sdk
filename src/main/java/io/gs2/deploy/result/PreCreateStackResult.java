...
public class PreCreateStackResult implements IResult, Serializable {
	...
	public PreCreateStackResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreCreateStackResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreCreateStackResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
