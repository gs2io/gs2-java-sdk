...
public class ApplyRankCapByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public ApplyRankCapByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public ApplyRankCapByStampSheetResult withExperienceNamespaceName(String experienceNamespaceName) {
		this.experienceNamespaceName = experienceNamespaceName;
		return this;
	}
	...
	public ApplyRankCapByStampSheetResult withExperienceStatus(io.gs2.experience.model.Status experienceStatus) {
		this.experienceStatus = experienceStatus;
		return this;
	}

    public static ApplyRankCapByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
