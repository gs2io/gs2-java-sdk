...
public class PredictionByUserIdRequest extends Gs2BasicRequest<PredictionByUserIdRequest> {
	...
	public PredictionByUserIdRequest withCount(Integer count) {
		this.count = count;
		return this;
	}
    ...
    public static PredictionByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
