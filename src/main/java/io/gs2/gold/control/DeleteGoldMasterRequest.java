...
public class DeleteGoldMasterRequest extends Gs2BasicRequest<DeleteGoldMasterRequest> {

	public static class Constant extends Gs2Gold.Constant {
		public static final String FUNCTION = "DeleteGoldMaster";
	}
	 ...
	 * @return this
	 */
	public DeleteGoldMasterRequest withGoldPoolName(String goldPoolName) {
	 ...
	 * @return this
	 */
	public DeleteGoldMasterRequest withGoldName(String goldName) {
