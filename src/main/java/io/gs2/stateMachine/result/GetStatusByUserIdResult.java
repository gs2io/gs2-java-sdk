...
public class GetStatusByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public GetStatusByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static GetStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
