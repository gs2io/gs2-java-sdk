...
public class DeleteBalanceParameterModelMasterResult implements IResult, Serializable {
	...
	public DeleteBalanceParameterModelMasterResult withItem(BalanceParameterModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteBalanceParameterModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
