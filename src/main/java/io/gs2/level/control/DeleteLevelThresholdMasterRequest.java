...
public class DeleteLevelThresholdMasterRequest extends Gs2BasicRequest<DeleteLevelThresholdMasterRequest> {

	public static class Constant extends Gs2Level.Constant {
		public static final String FUNCTION = "DeleteLevelThresholdMaster";
	}
	 ...
	 * @return this
	 */
	public DeleteLevelThresholdMasterRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public DeleteLevelThresholdMasterRequest withLevelTableName(String levelTableName) {
	 ...
	 * @return this
	 */
	public DeleteLevelThresholdMasterRequest withThreshold(Long threshold) {
