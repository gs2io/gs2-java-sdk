...
public class UpdateMissionGroupModelMasterResult implements IResult, Serializable {
	...
	public UpdateMissionGroupModelMasterResult withItem(MissionGroupModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateMissionGroupModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
