...
public class UpdateDataObjectByUserIdResult implements IResult, Serializable {
	...
	public UpdateDataObjectByUserIdResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static UpdateDataObjectByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
