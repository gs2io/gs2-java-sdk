...
public class DescribeProgressesByUserIdResult implements IResult, Serializable {
	...
	public DescribeProgressesByUserIdResult withItems(List<Progress> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeProgressesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeProgressesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
