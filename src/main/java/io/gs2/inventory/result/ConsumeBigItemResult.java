...
public class ConsumeBigItemResult implements IResult, Serializable {
	...
	public ConsumeBigItemResult withItem(BigItem item) {
		this.item = item;
		return this;
	}

    public static ConsumeBigItemResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
