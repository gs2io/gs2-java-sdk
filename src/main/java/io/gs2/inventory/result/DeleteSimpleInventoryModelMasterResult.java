...
public class DeleteSimpleInventoryModelMasterResult implements IResult, Serializable {
	...
	public DeleteSimpleInventoryModelMasterResult withItem(SimpleInventoryModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteSimpleInventoryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
