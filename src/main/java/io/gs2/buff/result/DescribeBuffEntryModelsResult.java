...
public class DescribeBuffEntryModelsResult implements IResult, Serializable {
	...
	public DescribeBuffEntryModelsResult withItems(List<BuffEntryModel> items) {
		this.items = items;
		return this;
	}

    public static DescribeBuffEntryModelsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
