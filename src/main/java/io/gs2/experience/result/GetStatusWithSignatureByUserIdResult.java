...
public class GetStatusWithSignatureByUserIdResult implements IResult, Serializable {
    private Status item;
    private String body;
	...
	public GetStatusWithSignatureByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public GetStatusWithSignatureByUserIdResult withBody(String body) {
		this.body = body;
		return this;
	}
	...
	public GetStatusWithSignatureByUserIdResult withSignature(String signature) {
		this.signature = signature;
		return this;
	}

    public static GetStatusWithSignatureByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
