...
public class DescribeWalletsByUserIdResult implements IResult, Serializable {
	...
	public DescribeWalletsByUserIdResult withItems(List<Wallet> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeWalletsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeWalletsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
