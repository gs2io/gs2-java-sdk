...
public class AcquireActionsToFormPropertiesResult implements IResult, Serializable {
	...
	public AcquireActionsToFormPropertiesResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public AcquireActionsToFormPropertiesResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}
