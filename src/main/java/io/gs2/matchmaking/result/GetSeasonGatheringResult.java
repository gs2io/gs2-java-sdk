...
public class GetSeasonGatheringResult implements IResult, Serializable {
	...
	public GetSeasonGatheringResult withItem(SeasonGathering item) {
		this.item = item;
		return this;
	}

    public static GetSeasonGatheringResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
