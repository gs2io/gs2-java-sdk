...
public class DescribeAcceptVersionsByUserIdRequest extends Gs2BasicRequest<DescribeAcceptVersionsByUserIdRequest> {
	...
	public DescribeAcceptVersionsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeAcceptVersionsByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeAcceptVersionsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
