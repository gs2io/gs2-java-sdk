...
public class MarkReleaseByUserIdRequest extends Gs2BasicRequest<MarkReleaseByUserIdRequest> {
	...
	public MarkReleaseByUserIdRequest withNodeModelNames(List<String> nodeModelNames) {
		this.nodeModelNames = nodeModelNames;
		return this;
	}
    ...
    public static MarkReleaseByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
