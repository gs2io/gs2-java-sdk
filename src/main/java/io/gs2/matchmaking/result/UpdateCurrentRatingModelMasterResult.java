...
public class UpdateCurrentRatingModelMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentRatingModelMasterResult withItem(CurrentRatingModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentRatingModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
