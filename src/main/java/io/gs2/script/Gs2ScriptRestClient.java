...
import io.gs2.script.model.*;public class Gs2ScriptRestClient extends AbstractGs2Client<Gs2ScriptRestClient> {
    ...
    class CreateScriptFromGitHubTask extends Gs2RestSessionTask<CreateScriptFromGitHubResult> {
    ...
    public CreateScriptFromGitHubResult createScriptFromGitHub(
        ...
        final AsyncResult<CreateScriptFromGitHubResult>[] resultAsyncResult = new AsyncResult[]{null};
    ...
    class UpdateScriptFromGitHubTask extends Gs2RestSessionTask<UpdateScriptFromGitHubResult> {
    ...
    public UpdateScriptFromGitHubResult updateScriptFromGitHub(
        ...
        final AsyncResult<UpdateScriptFromGitHubResult>[] resultAsyncResult = new AsyncResult[]{null};
        updateScriptFromGitHubAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class InvokeScriptTask extends Gs2RestSessionTask<InvokeScriptResult> {
    ...
    public InvokeScriptResult invokeScript(
        ...
        final AsyncResult<InvokeScriptResult>[] resultAsyncResult = new AsyncResult[]{null};
        invokeScriptAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
