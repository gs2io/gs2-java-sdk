...
public class DeleteIgnoreUserResult implements IResult, Serializable {
	...
	public DeleteIgnoreUserResult withItem(IgnoreUser item) {
		this.item = item;
		return this;
	}

    public static DeleteIgnoreUserResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
