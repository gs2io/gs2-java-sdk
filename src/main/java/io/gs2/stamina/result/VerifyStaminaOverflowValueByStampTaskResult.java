...
public class VerifyStaminaOverflowValueByStampTaskResult implements IResult, Serializable {
	...
	public VerifyStaminaOverflowValueByStampTaskResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public VerifyStaminaOverflowValueByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyStaminaOverflowValueByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
