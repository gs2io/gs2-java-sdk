...
public class GetBigItemModelMasterRequest extends Gs2BasicRequest<GetBigItemModelMasterRequest> {
    ...
    public static GetBigItemModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
