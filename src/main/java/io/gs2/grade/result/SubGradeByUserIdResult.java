...
public class SubGradeByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public SubGradeByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SubGradeByUserIdResult withExperienceNamespaceName(String experienceNamespaceName) {
		this.experienceNamespaceName = experienceNamespaceName;
		return this;
	}
	...
	public SubGradeByUserIdResult withExperienceStatus(io.gs2.experience.model.Status experienceStatus) {
		this.experienceStatus = experienceStatus;
		return this;
	}

    public static SubGradeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
