...
public class VerifyStaminaRecoverValueByUserIdRequest extends Gs2BasicRequest<VerifyStaminaRecoverValueByUserIdRequest> {
	...
	public VerifyStaminaRecoverValueByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public VerifyStaminaRecoverValueByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaRecoverValueByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
