...
public class DeleteDataObjectResult implements IResult, Serializable {
	...
	public DeleteDataObjectResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static DeleteDataObjectResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
