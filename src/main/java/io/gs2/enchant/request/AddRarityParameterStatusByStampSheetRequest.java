...
public class AddRarityParameterStatusByStampSheetRequest extends Gs2BasicRequest<AddRarityParameterStatusByStampSheetRequest> {
    ...
    public static AddRarityParameterStatusByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
