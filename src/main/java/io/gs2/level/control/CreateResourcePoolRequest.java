...
public class CreateResourcePoolRequest extends Gs2BasicRequest<CreateResourcePoolRequest> {

	public static class Constant extends Gs2Level.Constant {
		public static final String FUNCTION = "CreateResourcePool";
	}
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withName(String name) {
		setName(name);
		return this;
	}
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withDescription(String description) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withServiceClass(String serviceClass) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withLevelCapScript(String levelCapScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeExperienceTriggerScript(String changeExperienceTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeExperienceDoneTriggerScript(String changeExperienceDoneTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeLevelTriggerScript(String changeLevelTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeLevelDoneTriggerScript(String changeLevelDoneTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeLevelCapTriggerScript(String changeLevelCapTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateResourcePoolRequest withChangeLevelCapDoneTriggerScript(String changeLevelCapDoneTriggerScript) {
