...
public class VerifyCompleteResult implements IResult, Serializable {
	...
	public VerifyCompleteResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static VerifyCompleteResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
