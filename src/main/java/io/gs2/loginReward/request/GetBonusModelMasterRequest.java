...
public class GetBonusModelMasterRequest extends Gs2BasicRequest<GetBonusModelMasterRequest> {
    ...
    public static GetBonusModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
