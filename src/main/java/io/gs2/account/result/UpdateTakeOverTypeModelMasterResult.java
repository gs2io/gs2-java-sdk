...
public class UpdateTakeOverTypeModelMasterResult implements IResult, Serializable {
	...
	public UpdateTakeOverTypeModelMasterResult withItem(TakeOverTypeModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateTakeOverTypeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
