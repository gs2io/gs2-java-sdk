...
public class NamespaceDomain {
    ...
    public NamespaceDomain(
        ...
        this.parentKey = "inventory:Namespace";
    }
    ...
    public InventoryModelMasterDomain createInventoryModelMaster(
        CreateInventoryModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateInventoryModelMasterResult result = this.client.createInventoryModelMaster(
            request
        );
        ...
        InventoryModelMasterDomain domain = new InventoryModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public CurrentItemModelMasterDomain currentItemModelMaster(
    ) {
    ...
    public InventoryModelMasterDomain inventoryModelMaster(
        String inventoryName
    ) {
