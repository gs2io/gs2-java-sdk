...
public class DeleteSubscribeResult implements IResult, Serializable {
	...
	public DeleteSubscribeResult withItem(SubscribeUser item) {
		this.item = item;
		return this;
	}

    public static DeleteSubscribeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
