...
public class ResetBoxByUserIdRequest extends Gs2BasicRequest<ResetBoxByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してボックスをリセット
     */
     ...
     * 排出確率テーブル名を設定
     *
     * @param prizeTableName ユーザIDを指定してボックスをリセット
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザIDを指定してボックスをリセット
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してボックスをリセット
     */
