...
public class UnmarkReceivedByUserIdRequest extends Gs2BasicRequest<UnmarkReceivedByUserIdRequest> {
	...
	public UnmarkReceivedByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public UnmarkReceivedByUserIdRequest withBonusModelName(String bonusModelName) {
		this.bonusModelName = bonusModelName;
		return this;
	}
	...
	public UnmarkReceivedByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public UnmarkReceivedByUserIdRequest withStepNumber(Integer stepNumber) {
		this.stepNumber = stepNumber;
		return this;
	}
	...
	public UnmarkReceivedByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static UnmarkReceivedByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
