...
public class AddGradeByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public AddGradeByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static AddGradeByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
