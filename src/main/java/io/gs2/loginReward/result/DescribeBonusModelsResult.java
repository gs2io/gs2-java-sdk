...
public class DescribeBonusModelsResult implements IResult, Serializable {
	...
	public DescribeBonusModelsResult withItems(List<BonusModel> items) {
		this.items = items;
		return this;
	}

    public static DescribeBonusModelsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
