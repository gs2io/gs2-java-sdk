...
public class DeletePrizeMasterRequest extends Gs2BasicRequest<DeletePrizeMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DeletePrizeMaster";
	}
	 ...
	 * @return this
	 */
	public DeletePrizeMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DeletePrizeMasterRequest withPrizeTableName(String prizeTableName) {
	 ...
	 * @return this
	 */
	public DeletePrizeMasterRequest withRarityName(String rarityName) {
	 ...
	 * @return this
	 */
	public DeletePrizeMasterRequest withResourceId(String resourceId) {
