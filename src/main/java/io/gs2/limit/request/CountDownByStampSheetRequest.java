...
public class CountDownByStampSheetRequest extends Gs2BasicRequest<CountDownByStampSheetRequest> {
    ...
    public static CountDownByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
