...
public class ResetCounterByUserIdResult implements IResult, Serializable {
	...
	public ResetCounterByUserIdResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static ResetCounterByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
