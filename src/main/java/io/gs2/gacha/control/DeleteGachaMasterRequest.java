...
public class DeleteGachaMasterRequest extends Gs2BasicRequest<DeleteGachaMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DeleteGachaMaster";
	}
	 ...
	 * @return this
	 */
	public DeleteGachaMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public DeleteGachaMasterRequest withGachaName(String gachaName) {
