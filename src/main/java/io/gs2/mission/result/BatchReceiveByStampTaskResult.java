...
public class BatchReceiveByStampTaskResult implements IResult, Serializable {
	...
	public BatchReceiveByStampTaskResult withItem(Complete item) {
		this.item = item;
		return this;
	}
	...
	public BatchReceiveByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static BatchReceiveByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
