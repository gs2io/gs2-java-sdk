...
public class UpdateCurrentQuestMasterRequest extends Gs2BasicRequest<UpdateCurrentQuestMasterRequest> {
	...
	public UpdateCurrentQuestMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentQuestMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentQuestMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
