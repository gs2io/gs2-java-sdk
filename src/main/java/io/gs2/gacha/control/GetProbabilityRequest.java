...
public class GetProbabilityRequest extends Gs2BasicRequest<GetProbabilityRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetProbability";
	}
	 ...
	 * @return this
	 */
	public GetProbabilityRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public GetProbabilityRequest withGachaName(String gachaName) {
	 ...
	 * @return this
	 */
	public GetProbabilityRequest withDrawTime(Integer drawTime) {
