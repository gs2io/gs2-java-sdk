...
public class UpdateStatusModelMasterResult implements IResult, Serializable {
	...
	public UpdateStatusModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateStatusModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
