...
public class GetFriendResult implements IResult, Serializable {
	...
	public GetFriendResult withItem(FriendUser item) {
		this.item = item;
		return this;
	}

    public static GetFriendResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
