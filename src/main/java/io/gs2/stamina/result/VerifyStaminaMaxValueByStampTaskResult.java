...
public class VerifyStaminaMaxValueByStampTaskResult implements IResult, Serializable {
	...
	public VerifyStaminaMaxValueByStampTaskResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
    ...
    public static VerifyStaminaMaxValueByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
