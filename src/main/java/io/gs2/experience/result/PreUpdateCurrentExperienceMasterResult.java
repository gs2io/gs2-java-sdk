...
public class PreUpdateCurrentExperienceMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentExperienceMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentExperienceMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentExperienceMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
