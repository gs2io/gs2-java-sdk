...
public class DescribeThresholdMastersRequest extends Gs2BasicRequest<DescribeThresholdMastersRequest> {
	...
	public DescribeThresholdMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeThresholdMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeThresholdMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
