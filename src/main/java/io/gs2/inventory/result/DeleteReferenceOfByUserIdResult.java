...
public class DeleteReferenceOfByUserIdResult implements IResult, Serializable {
	...
	public DeleteReferenceOfByUserIdResult withItem(List<String> item) {
		this.item = item;
		return this;
	}
	...
	public DeleteReferenceOfByUserIdResult withItemSet(ItemSet itemSet) {
		this.itemSet = itemSet;
		return this;
	}
	...
	public DeleteReferenceOfByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public DeleteReferenceOfByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static DeleteReferenceOfByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
