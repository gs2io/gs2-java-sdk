...
public class CreateTakeOverTypeModelMasterRequest extends Gs2BasicRequest<CreateTakeOverTypeModelMasterRequest> {
	...
	public CreateTakeOverTypeModelMasterRequest withType(Integer type) {
		this.type = type;
		return this;
	}
	...
	public CreateTakeOverTypeModelMasterRequest withOpenIdConnectSetting(OpenIdConnectSetting openIdConnectSetting) {
		this.openIdConnectSetting = openIdConnectSetting;
		return this;
	}

    public static CreateTakeOverTypeModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
