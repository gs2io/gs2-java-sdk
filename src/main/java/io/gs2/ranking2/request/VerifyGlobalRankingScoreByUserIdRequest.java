...
public class VerifyGlobalRankingScoreByUserIdRequest extends Gs2BasicRequest<VerifyGlobalRankingScoreByUserIdRequest> {
	...
	public VerifyGlobalRankingScoreByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withRankingName(String rankingName) {
		this.rankingName = rankingName;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withSeason(Long season) {
		this.season = season;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withScore(Long score) {
		this.score = score;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public VerifyGlobalRankingScoreByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyGlobalRankingScoreByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
