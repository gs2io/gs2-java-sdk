...
public class DecrementPurchaseCountByUserIdRequest extends Gs2BasicRequest<DecrementPurchaseCountByUserIdRequest> {
	...
	public DecrementPurchaseCountByUserIdRequest withCount(Integer count) {
		this.count = count;
		return this;
	}
	...
	public DecrementPurchaseCountByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static DecrementPurchaseCountByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
