...
public class MarkReceivedByStampTaskResult implements IResult, Serializable {
	...
	public MarkReceivedByStampTaskResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public MarkReceivedByStampTaskResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}
    ...
    public static MarkReceivedByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
