...
public class VerifyIncludeParticipantByUserIdResult implements IResult, Serializable {
	...
	public VerifyIncludeParticipantByUserIdResult withItem(SeasonGathering item) {
		this.item = item;
		return this;
	}

    public static VerifyIncludeParticipantByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
