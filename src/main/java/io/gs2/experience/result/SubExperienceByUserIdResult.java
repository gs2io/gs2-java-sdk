...
public class SubExperienceByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public SubExperienceByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static SubExperienceByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
