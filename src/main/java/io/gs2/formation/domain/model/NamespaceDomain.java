...
public class NamespaceDomain {
    ...
    public FormModelMasterDomain createFormModelMaster(
        CreateFormModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateFormModelMasterResult result = this.client.createFormModelMaster(
            request
        );
        ...
        FormModelMasterDomain domain = new FormModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public MoldModelMasterDomain createMoldModelMaster(
        CreateMoldModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateMoldModelMasterResult result = this.client.createMoldModelMaster(
            request
        );
        String parentKey = io.gs2.formation.domain.model.NamespaceDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
        ...
        MoldModelMasterDomain domain = new MoldModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public MoldModelDomain moldModel(
        String moldName
    ) {
    ...
    public FormModelMasterDomain formModelMaster(
    ...
    public MoldModelMasterDomain moldModelMaster(
        String moldName
    ) {
