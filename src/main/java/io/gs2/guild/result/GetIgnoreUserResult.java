...
public class GetIgnoreUserResult implements IResult, Serializable {
	...
	public GetIgnoreUserResult withItem(IgnoreUser item) {
		this.item = item;
		return this;
	}

    public static GetIgnoreUserResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
