...
public class DeleteGlobalRankingScoreByUserIdRequest extends Gs2BasicRequest<DeleteGlobalRankingScoreByUserIdRequest> {
    ...
    public static DeleteGlobalRankingScoreByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
