...
public class IncrementalExchangeByUserIdResult implements IResult, Serializable {
	...
	public IncrementalExchangeByUserIdResult withItem(IncrementalRateModel item) {
		this.item = item;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public IncrementalExchangeByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static IncrementalExchangeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
