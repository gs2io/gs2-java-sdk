...
import io.gs2.buff.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentBuffMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentBuffMasterFromGitHubRequest> {
	...
	public UpdateCurrentBuffMasterFromGitHubRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
    ...
    public static UpdateCurrentBuffMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
