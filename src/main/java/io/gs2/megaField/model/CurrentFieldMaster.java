...
public class CurrentFieldMaster implements IModel, Serializable, Comparable<CurrentFieldMaster> {
	...
	public CurrentFieldMaster withNamespaceId(String namespaceId) {
		this.namespaceId = namespaceId;
		return this;
	}
	...
	public CurrentFieldMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentFieldMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentFieldMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentFieldMaster other = (CurrentFieldMaster) o;
		if (namespaceId == null) {
