...
public class GetStaminaResult implements IResult, Serializable {
	...
	public GetStaminaResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public GetStaminaResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static GetStaminaResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
