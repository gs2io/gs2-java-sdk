...
public class ItemSetDomain {
    ...
    private List<ItemSet> get(
        ...
        GetItemSetByUserIdResult result = this.client.getItemSetByUserId(
            request
        );
    ...
    public ItemSetDomain[] getItemWithSignature(
        ...
        request
            ...
            .withItemName(this.itemName)
            .withItemSetName(this.itemSetName);
        GetItemWithSignatureByUserIdResult result = this.client.getItemWithSignatureByUserId(
            request
        );
        String parentKey = io.gs2.inventory.domain.model.InventoryDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
    ...
    public ItemSetDomain[] acquire(
        ...
        request
            ...
            .withItemName(this.itemName)
            .withItemSetName(this.itemSetName);
        AcquireItemSetByUserIdResult result = this.client.acquireItemSetByUserId(
            request
        );
        String parentKey = io.gs2.inventory.domain.model.InventoryDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
    ...
    public ItemSetDomain[] consume(
        ...
        request
            ...
            .withItemName(this.itemName)
            .withItemSetName(this.itemSetName);
        ConsumeItemSetByUserIdResult result = this.client.consumeItemSetByUserId(
            request
        );
        String parentKey = io.gs2.inventory.domain.model.InventoryDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
    ...
    public ItemSetDomain[] delete(
        ...
        try {
            result = this.client.deleteItemSetByUserId(
                request
            );
    ...
    public ReferenceOfDomain[] addReferenceOf(
        ...
        request
            ...
            .withItemName(this.itemName)
            .withItemSetName(this.itemSetName);
        AddReferenceOfByUserIdResult result = this.client.addReferenceOfByUserId(
            request
        );
    ...
    public ReferenceOfDomain referenceOf(
        String referenceOf
    ) {
