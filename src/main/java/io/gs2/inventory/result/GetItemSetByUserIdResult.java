...
public class GetItemSetByUserIdResult implements IResult, Serializable {
	...
	public GetItemSetByUserIdResult withItems(List<ItemSet> items) {
		this.items = items;
		return this;
	}
	...
	public GetItemSetByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public GetItemSetByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static GetItemSetByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
