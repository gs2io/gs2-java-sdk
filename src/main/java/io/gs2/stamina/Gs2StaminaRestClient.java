...
public class Gs2StaminaRestClient extends AbstractGs2Client<Gs2StaminaRestClient> {
    ...
    class PreUpdateCurrentStaminaMasterTask extends Gs2RestSessionTask<PreUpdateCurrentStaminaMasterResult> {
        private PreUpdateCurrentStaminaMasterRequest request;

        public PreUpdateCurrentStaminaMasterTask(
            PreUpdateCurrentStaminaMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentStaminaMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentStaminaMasterResult parse(JsonNode data) {
            return PreUpdateCurrentStaminaMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentStaminaMasterAsync(
            PreUpdateCurrentStaminaMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentStaminaMasterResult>> callback
    ) {
        PreUpdateCurrentStaminaMasterTask task = new PreUpdateCurrentStaminaMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentStaminaMasterResult preUpdateCurrentStaminaMaster(
            PreUpdateCurrentStaminaMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentStaminaMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentStaminaMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentStaminaMasterTask extends Gs2RestSessionTask<UpdateCurrentStaminaMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentStaminaMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentStaminaMasterTask task = new PreUpdateCurrentStaminaMasterTask(
    ...
    class DecreaseMaxValueTask extends Gs2RestSessionTask<DecreaseMaxValueResult> {
        private DecreaseMaxValueRequest request;

        public DecreaseMaxValueTask(
            DecreaseMaxValueRequest request,
            AsyncAction<AsyncResult<DecreaseMaxValueResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public DecreaseMaxValueResult parse(JsonNode data) {
            return DecreaseMaxValueResult.fromJson(data);
        }
    ...
    public void decreaseMaxValueAsync(
            DecreaseMaxValueRequest request,
            AsyncAction<AsyncResult<DecreaseMaxValueResult>> callback
    ) {
        DecreaseMaxValueTask task = new DecreaseMaxValueTask(request, callback);
        session.execute(task);
    }

    public DecreaseMaxValueResult decreaseMaxValue(
            DecreaseMaxValueRequest request
    ) {
        final AsyncResult<DecreaseMaxValueResult>[] resultAsyncResult = new AsyncResult[]{null};
        decreaseMaxValueAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
