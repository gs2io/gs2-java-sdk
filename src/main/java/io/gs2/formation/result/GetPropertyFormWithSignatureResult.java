...
public class GetPropertyFormWithSignatureResult implements IResult, Serializable {
	...
	public GetPropertyFormWithSignatureResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
	...
	public GetPropertyFormWithSignatureResult withBody(String body) {
		this.body = body;
		return this;
	}
	...
	public GetPropertyFormWithSignatureResult withSignature(String signature) {
		this.signature = signature;
		return this;
	}
	...
	public GetPropertyFormWithSignatureResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static GetPropertyFormWithSignatureResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
