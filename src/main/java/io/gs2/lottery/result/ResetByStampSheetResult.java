...
public class ResetByStampSheetResult implements IResult, Serializable {
	...
	public ResetByStampSheetResult withItem(BoxItems item) {
		this.item = item;
		return this;
	}

    public static ResetByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
