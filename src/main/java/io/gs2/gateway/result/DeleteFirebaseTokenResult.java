...
public class DeleteFirebaseTokenResult implements IResult, Serializable {
	...
	public DeleteFirebaseTokenResult withItem(FirebaseToken item) {
		this.item = item;
		return this;
	}

    public static DeleteFirebaseTokenResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
