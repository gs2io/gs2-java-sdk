...
public class DescribeLatestMessagesRequest extends Gs2BasicRequest<DescribeLatestMessagesRequest> {
	...
	public DescribeLatestMessagesRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeLatestMessagesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
