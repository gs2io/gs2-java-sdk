...
public class GetInventoryModelMasterResult implements IResult, Serializable {
	...
	public GetInventoryModelMasterResult withItem(InventoryModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetInventoryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
