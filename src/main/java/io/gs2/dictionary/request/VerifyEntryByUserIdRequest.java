...
public class VerifyEntryByUserIdRequest extends Gs2BasicRequest<VerifyEntryByUserIdRequest> {
    ...
    public static VerifyEntryByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
