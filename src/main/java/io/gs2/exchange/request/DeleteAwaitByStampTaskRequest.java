...
public class DeleteAwaitByStampTaskRequest extends Gs2BasicRequest<DeleteAwaitByStampTaskRequest> {
     ...
     * スタンプタスクを設定
     *
     * @param stampTask スタンプタスクで 交換待機 を削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプタスクで 交換待機 を削除
     */
