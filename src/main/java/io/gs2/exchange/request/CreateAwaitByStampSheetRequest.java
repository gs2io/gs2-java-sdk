...
public class CreateAwaitByStampSheetRequest extends Gs2BasicRequest<CreateAwaitByStampSheetRequest> {
     ...
     * スタンプシートを設定
     *
     * @param stampSheet スタンプシートで交換待機 を作成
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプシートで交換待機 を作成
     */
