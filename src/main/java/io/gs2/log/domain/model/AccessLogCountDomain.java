...
public class AccessLogCountDomain {
    ...
    public AccessLogCount model() {
        AccessLogCount value = cache.get(
            parentKey,
            io.gs2.log.domain.model.AccessLogCountDomain.createCacheKey(
            ),
