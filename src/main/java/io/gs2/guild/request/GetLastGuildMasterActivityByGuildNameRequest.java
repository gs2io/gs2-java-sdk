...
public class GetLastGuildMasterActivityByGuildNameRequest extends Gs2BasicRequest<GetLastGuildMasterActivityByGuildNameRequest> {
	...
	public GetLastGuildMasterActivityByGuildNameRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetLastGuildMasterActivityByGuildNameRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public GetLastGuildMasterActivityByGuildNameRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}

    public static GetLastGuildMasterActivityByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
