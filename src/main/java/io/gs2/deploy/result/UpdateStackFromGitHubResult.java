...
public class UpdateStackFromGitHubResult implements IResult, Serializable {
    private Stack item;
	...
	public UpdateStackFromGitHubResult withItem(Stack item) {
		this.item = item;
		return this;
	}

    public static UpdateStackFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
