...
public class GetStateMachineMasterRequest extends Gs2BasicRequest<GetStateMachineMasterRequest> {
    ...
    public static GetStateMachineMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
