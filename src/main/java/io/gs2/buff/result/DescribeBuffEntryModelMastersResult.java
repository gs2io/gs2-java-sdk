...
import io.gs2.buff.model.BuffEntryModelMaster;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class DescribeBuffEntryModelMastersResult implements IResult, Serializable {
    private List<BuffEntryModelMaster> items;
    private String nextPageToken;

	public List<BuffEntryModelMaster> getItems() {
		return items;
	}

	public void setItems(List<BuffEntryModelMaster> items) {
		this.items = items;
	}

	public DescribeBuffEntryModelMastersResult withItems(List<BuffEntryModelMaster> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeBuffEntryModelMastersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeBuffEntryModelMastersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
