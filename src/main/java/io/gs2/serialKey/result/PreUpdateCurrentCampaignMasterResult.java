...
public class PreUpdateCurrentCampaignMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentCampaignMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentCampaignMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentCampaignMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
