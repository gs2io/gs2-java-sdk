...
public class VerifyCounterValueByUserIdResult implements IResult, Serializable {
	...
	public VerifyCounterValueByUserIdResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static VerifyCounterValueByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
