...
public class DecreaseCounterResult implements IResult, Serializable {
	...
	public DecreaseCounterResult withItem(Counter item) {
		this.item = item;
		return this;
	}
	...
	public DecreaseCounterResult withChangedCompletes(List<Complete> changedCompletes) {
		this.changedCompletes = changedCompletes;
		return this;
	}

    public static DecreaseCounterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
