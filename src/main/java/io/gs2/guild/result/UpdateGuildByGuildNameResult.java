...
public class UpdateGuildByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public UpdateGuildByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static UpdateGuildByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
