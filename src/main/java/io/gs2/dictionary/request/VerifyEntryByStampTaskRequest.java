...
public class VerifyEntryByStampTaskRequest extends Gs2BasicRequest<VerifyEntryByStampTaskRequest> {
	...
	public VerifyEntryByStampTaskRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static VerifyEntryByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
