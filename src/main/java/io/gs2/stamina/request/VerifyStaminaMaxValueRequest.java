...
public class VerifyStaminaMaxValueRequest extends Gs2BasicRequest<VerifyStaminaMaxValueRequest> {
	...
	public VerifyStaminaMaxValueRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaMaxValueRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaMaxValueRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
