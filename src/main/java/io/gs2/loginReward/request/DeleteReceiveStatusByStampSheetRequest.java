...
public class DeleteReceiveStatusByStampSheetRequest extends Gs2BasicRequest<DeleteReceiveStatusByStampSheetRequest> {
    ...
    public static DeleteReceiveStatusByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
