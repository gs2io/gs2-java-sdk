...
public class GetAreaModelRequest extends Gs2BasicRequest<GetAreaModelRequest> {
	...
	public GetAreaModelRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetAreaModelRequest withAreaModelName(String areaModelName) {
		this.areaModelName = areaModelName;
		return this;
	}

    public static GetAreaModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
