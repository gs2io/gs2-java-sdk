...
public class VerifyCounterByStampTaskResult implements IResult, Serializable {
	...
	public VerifyCounterByStampTaskResult withItem(Counter item) {
		this.item = item;
		return this;
	}
	...
	public VerifyCounterByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyCounterByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
