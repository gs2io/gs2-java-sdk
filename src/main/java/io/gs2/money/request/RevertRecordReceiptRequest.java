...
public class RevertRecordReceiptRequest extends Gs2BasicRequest<RevertRecordReceiptRequest> {
    ...
    public static RevertRecordReceiptRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
