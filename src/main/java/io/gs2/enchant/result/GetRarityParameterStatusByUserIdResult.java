...
public class GetRarityParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public GetRarityParameterStatusByUserIdResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}

    public static GetRarityParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
