...
public class DeleteMemberByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public DeleteMemberByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static DeleteMemberByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
