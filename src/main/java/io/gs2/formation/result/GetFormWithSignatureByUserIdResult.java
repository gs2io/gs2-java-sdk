...
public class GetFormWithSignatureByUserIdResult implements IResult, Serializable {
	 ...
	 * フォームを設定
	 *
	 * @param item ユーザIDを指定して署名付きフォームを取得
	 */
	 ...
	 * 署名対象の値を設定
	 *
	 * @param body ユーザIDを指定して署名付きフォームを取得
	 */
	 ...
	 * 署名を設定
	 *
	 * @param signature ユーザIDを指定して署名付きフォームを取得
	 */
	 ...
	 * 保存したフォームを設定
	 *
	 * @param mold ユーザIDを指定して署名付きフォームを取得
	 */
	 ...
	 * フォームの保存領域を設定
	 *
	 * @param moldModel ユーザIDを指定して署名付きフォームを取得
	 */
	 ...
	 * フォームモデルを設定
	 *
	 * @param formModel ユーザIDを指定して署名付きフォームを取得
	 */
