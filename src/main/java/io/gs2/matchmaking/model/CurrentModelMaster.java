...
public class CurrentModelMaster implements IModel, Serializable, Comparable<CurrentModelMaster> {
	...
	public CurrentModelMaster withSettings(String settings) {
		this.settings = settings;
		return this;
	}

    public static CurrentModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentModelMaster other = (CurrentModelMaster) o;
		if (namespaceId == null) {
