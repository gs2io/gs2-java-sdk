...
public class DescribeEventMastersRequest extends Gs2BasicRequest<DescribeEventMastersRequest> {
	...
	public DescribeEventMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeEventMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeEventMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
