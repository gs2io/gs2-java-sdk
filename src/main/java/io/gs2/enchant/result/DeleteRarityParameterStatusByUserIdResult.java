...
public class DeleteRarityParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public DeleteRarityParameterStatusByUserIdResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}

    public static DeleteRarityParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
