...
public class VerifySubscribeRankingScoreResult implements IResult, Serializable {
	...
	public VerifySubscribeRankingScoreResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static VerifySubscribeRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
