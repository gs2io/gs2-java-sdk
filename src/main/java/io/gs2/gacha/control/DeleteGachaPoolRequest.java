...
public class DeleteGachaPoolRequest extends Gs2BasicRequest<DeleteGachaPoolRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "DeleteGachaPool";
	}
	 ...
	 * @return this
	 */
	public DeleteGachaPoolRequest withGachaPoolName(String gachaPoolName) {
