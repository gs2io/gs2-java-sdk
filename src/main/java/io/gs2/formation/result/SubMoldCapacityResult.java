...
public class SubMoldCapacityResult implements IResult, Serializable {
    private Mold item;
	...
	public SubMoldCapacityResult withItem(Mold item) {
		this.item = item;
		return this;
	}
	...
	public SubMoldCapacityResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}

    public static SubMoldCapacityResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
