...
public class DeleteNodeModelMasterRequest extends Gs2BasicRequest<DeleteNodeModelMasterRequest> {
    ...
    public static DeleteNodeModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
