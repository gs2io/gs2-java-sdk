...
public class DescribeInventoriesByUserIdIterator implements Iterator<Inventory>, Iterable<Inventory> {
    CacheDatabase cache;
    ...
    public DescribeInventoriesByUserIdIterator(
        CacheDatabase cache,
        Gs2InventoryRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeInventoriesByUserIdResult r = this.client.describeInventoriesByUserId(
