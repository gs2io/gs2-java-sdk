...
public class IssueOnceByStampSheetResult implements IResult, Serializable {
	...
	public IssueOnceByStampSheetResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}

    public static IssueOnceByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
