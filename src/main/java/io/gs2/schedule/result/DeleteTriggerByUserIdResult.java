...
public class DeleteTriggerByUserIdResult implements IResult, Serializable {
	...
	public DeleteTriggerByUserIdResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static DeleteTriggerByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
