...
public class BatchReadMessagesByUserIdRequest extends Gs2BasicRequest<BatchReadMessagesByUserIdRequest> {
	...
	public BatchReadMessagesByUserIdRequest withMessageNames(List<String> messageNames) {
		this.messageNames = messageNames;
		return this;
	}
	...
	public BatchReadMessagesByUserIdRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static BatchReadMessagesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
