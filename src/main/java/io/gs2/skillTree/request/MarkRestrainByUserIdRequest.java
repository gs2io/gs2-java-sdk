...
public class MarkRestrainByUserIdRequest extends Gs2BasicRequest<MarkRestrainByUserIdRequest> {
	...
	public MarkRestrainByUserIdRequest withNodeModelNames(List<String> nodeModelNames) {
		this.nodeModelNames = nodeModelNames;
		return this;
	}
	...
	public MarkRestrainByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static MarkRestrainByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
