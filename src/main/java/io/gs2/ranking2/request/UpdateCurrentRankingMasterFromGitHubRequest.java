...
import io.gs2.ranking2.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentRankingMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentRankingMasterFromGitHubRequest> {
    ...
    public static UpdateCurrentRankingMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
