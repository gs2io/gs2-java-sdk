...
public class MarkReleaseByStampSheetRequest extends Gs2BasicRequest<MarkReleaseByStampSheetRequest> {
	...
	public MarkReleaseByStampSheetRequest withKeyId(String keyId) {
		this.keyId = keyId;
		return this;
	}

    public static MarkReleaseByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
