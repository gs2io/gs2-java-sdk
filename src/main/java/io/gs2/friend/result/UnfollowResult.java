...
public class UnfollowResult implements IResult, Serializable {
	...
	public UnfollowResult withItem(FollowUser item) {
		this.item = item;
		return this;
	}

    public static UnfollowResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
