...
public class VerifyRankResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyRankResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static VerifyRankResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
