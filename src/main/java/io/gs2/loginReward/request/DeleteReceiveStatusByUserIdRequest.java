...
public class DeleteReceiveStatusByUserIdRequest extends Gs2BasicRequest<DeleteReceiveStatusByUserIdRequest> {
	...
	public DeleteReceiveStatusByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public DeleteReceiveStatusByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeleteReceiveStatusByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
