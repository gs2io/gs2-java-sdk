...
public class AcceptRequestRequest extends Gs2BasicRequest<AcceptRequestRequest> {
	...
	public AcceptRequestRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
    ...
    public static AcceptRequestRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
