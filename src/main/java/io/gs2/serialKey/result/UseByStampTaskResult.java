...
public class UseByStampTaskResult implements IResult, Serializable {
	...
	public UseByStampTaskResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}
	...
	public UseByStampTaskResult withCampaignModel(CampaignModel campaignModel) {
		this.campaignModel = campaignModel;
		return this;
	}
	...
	public UseByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static UseByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
