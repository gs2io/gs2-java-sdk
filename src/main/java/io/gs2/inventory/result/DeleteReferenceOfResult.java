...
public class DeleteReferenceOfResult implements IResult, Serializable {
	...
	public DeleteReferenceOfResult withItem(List<String> item) {
		this.item = item;
		return this;
	}
	...
	public DeleteReferenceOfResult withItemSet(ItemSet itemSet) {
		this.itemSet = itemSet;
		return this;
	}
	...
	public DeleteReferenceOfResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public DeleteReferenceOfResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static DeleteReferenceOfResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
