...
public class AddFriendResult implements IResult, Serializable {
	...
	public AddFriendResult withItem(FriendUser item) {
		this.item = item;
		return this;
	}

    public static AddFriendResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
