...
public class GetIssueRequest extends Gs2BasicRequest<GetIssueRequest> {

	public static class Constant extends Gs2Support.Constant {
		public static final String FUNCTION = "GetIssue";
	}
	 ...
	 * @return this
	 */
	public GetIssueRequest withIssueId(String issueId) {
		setIssueId(issueId);
		return this;
	}
