...
public class SetMaximumIdleMinutesByUserIdResult implements IResult, Serializable {
    private Status item;
    private Status old;
	...
	public SetMaximumIdleMinutesByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SetMaximumIdleMinutesByUserIdResult withOld(Status old) {
		this.old = old;
		return this;
	}

    public static SetMaximumIdleMinutesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
