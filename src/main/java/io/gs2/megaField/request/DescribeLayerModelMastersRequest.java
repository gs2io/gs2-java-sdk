...
public class DescribeLayerModelMastersRequest extends Gs2BasicRequest<DescribeLayerModelMastersRequest> {
	...
	public DescribeLayerModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeLayerModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
