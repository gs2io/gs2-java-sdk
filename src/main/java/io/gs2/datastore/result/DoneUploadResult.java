...
public class DoneUploadResult implements IResult, Serializable {
	...
	public DoneUploadResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static DoneUploadResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
