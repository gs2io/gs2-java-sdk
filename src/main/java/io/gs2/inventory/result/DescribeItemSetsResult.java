...
public class DescribeItemSetsResult implements IResult, Serializable {
	...
	public DescribeItemSetsResult withItems(List<ItemSet> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeItemSetsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeItemSetsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
