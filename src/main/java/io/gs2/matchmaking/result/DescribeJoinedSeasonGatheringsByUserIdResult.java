...
public class DescribeJoinedSeasonGatheringsByUserIdResult implements IResult, Serializable {
	...
	public DescribeJoinedSeasonGatheringsByUserIdResult withItems(List<JoinedSeasonGathering> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeJoinedSeasonGatheringsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeJoinedSeasonGatheringsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
