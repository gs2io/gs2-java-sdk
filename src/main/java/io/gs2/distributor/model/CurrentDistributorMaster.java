...
public class CurrentDistributorMaster implements IModel, Serializable, Comparable<CurrentDistributorMaster> {
    ...
    public static CurrentDistributorMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentDistributorMaster other = (CurrentDistributorMaster) o;
		if (namespaceId == null) {
