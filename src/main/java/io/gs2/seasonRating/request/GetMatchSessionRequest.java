...
public class GetMatchSessionRequest extends Gs2BasicRequest<GetMatchSessionRequest> {
	...
	public GetMatchSessionRequest withSessionName(String sessionName) {
		this.sessionName = sessionName;
		return this;
	}

    public static GetMatchSessionRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
