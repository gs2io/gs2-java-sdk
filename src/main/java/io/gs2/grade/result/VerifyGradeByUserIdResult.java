...
public class VerifyGradeByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyGradeByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static VerifyGradeByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
