...
public class GetRankingByUserIdRequest extends Gs2BasicRequest<GetRankingByUserIdRequest> {
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ランキングを取得
     */
