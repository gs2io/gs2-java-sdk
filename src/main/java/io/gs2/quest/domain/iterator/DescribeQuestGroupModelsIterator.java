...
public class DescribeQuestGroupModelsIterator implements Iterator<QuestGroupModel>, Iterable<QuestGroupModel> {
    CacheDatabase cache;
    ...
    public DescribeQuestGroupModelsIterator(
        CacheDatabase cache,
        Gs2QuestRestClient client,
        String namespaceName
    ) {
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeQuestGroupModelsResult r = this.client.describeQuestGroupModels(
