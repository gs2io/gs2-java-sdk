...
public class DescribeVersionModelMastersRequest extends Gs2BasicRequest<DescribeVersionModelMastersRequest> {
	...
	public DescribeVersionModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeVersionModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeVersionModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
