...
public class DescribeFollowsByUserIdRequest extends Gs2BasicRequest<DescribeFollowsByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定してフォローの一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定してフォローの一覧を取得
     */
     ...
     * プロフィールも一緒に取得するかを設定
     *
     * @param withProfile ユーザーIDを指定してフォローの一覧を取得
     */
     ...
     *
     * @param pageToken ユーザーIDを指定してフォローの一覧を取得
     */
     ...
     * データの取得件数を設定
     *
     * @param limit ユーザーIDを指定してフォローの一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してフォローの一覧を取得
     */
