...
public class VerifyIncludeMemberByStampTaskResult implements IResult, Serializable {
    private Guild item;
	...
	public VerifyIncludeMemberByStampTaskResult withItem(Guild item) {
		this.item = item;
		return this;
	}
    ...
    public static VerifyIncludeMemberByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
