...
public class DecreaseMaximumIdleMinutesByStampTaskRequest extends Gs2BasicRequest<DecreaseMaximumIdleMinutesByStampTaskRequest> {
    ...
    public static DecreaseMaximumIdleMinutesByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
