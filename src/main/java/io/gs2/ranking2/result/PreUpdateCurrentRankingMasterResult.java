...
public class PreUpdateCurrentRankingMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentRankingMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentRankingMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentRankingMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
