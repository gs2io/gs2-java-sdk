...
public class DescribeSerialCodesRequest extends Gs2BasicRequest<DescribeSerialCodesRequest> {
	...
	public DescribeSerialCodesRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DescribeSerialCodesRequest withCampaignModelName(String campaignModelName) {
		this.campaignModelName = campaignModelName;
		return this;
	}
	...
	public DescribeSerialCodesRequest withIssueJobName(String issueJobName) {
		this.issueJobName = issueJobName;
		return this;
	}
	...
	public DescribeSerialCodesRequest withPageToken(String pageToken) {
		this.pageToken = pageToken;
		return this;
	}
	...
	public DescribeSerialCodesRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeSerialCodesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
