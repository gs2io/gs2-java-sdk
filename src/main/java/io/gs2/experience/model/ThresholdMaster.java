...
public class ThresholdMaster implements IModel, Serializable, Comparable<ThresholdMaster> {
    ...
    public static ThresholdMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new ThresholdMaster()
            .withThresholdId(data.get("thresholdId") == null || data.get("thresholdId").isNull() ? null : data.get("thresholdId").asText())
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("thresholdId", getThresholdId());
                put("name", getName());
