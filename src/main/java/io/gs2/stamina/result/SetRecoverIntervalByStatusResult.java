...
public class SetRecoverIntervalByStatusResult implements IResult, Serializable {
	...
	public SetRecoverIntervalByStatusResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetRecoverIntervalByStatusResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetRecoverIntervalByStatusResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetRecoverIntervalByStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
