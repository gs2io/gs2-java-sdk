...
public class CurrentQuestMaster implements IModel, Serializable, Comparable<CurrentQuestMaster> {
    ...
    public static CurrentQuestMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentQuestMaster o) {
