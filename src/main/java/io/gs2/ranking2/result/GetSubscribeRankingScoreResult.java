...
public class GetSubscribeRankingScoreResult implements IResult, Serializable {
	...
	public GetSubscribeRankingScoreResult withItem(SubscribeRankingScore item) {
		this.item = item;
		return this;
	}

    public static GetSubscribeRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
