...
public class UpdateStoreSubscriptionContentModelMasterResult implements IResult, Serializable {
	...
	public UpdateStoreSubscriptionContentModelMasterResult withItem(StoreSubscriptionContentModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateStoreSubscriptionContentModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
