...
public class CreateGuildByUserIdResult implements IResult, Serializable {
    private Guild item;
	...
	public CreateGuildByUserIdResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static CreateGuildByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
