...
public class GetSimpleInventoryModelMasterRequest extends Gs2BasicRequest<GetSimpleInventoryModelMasterRequest> {
    ...
    public static GetSimpleInventoryModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
