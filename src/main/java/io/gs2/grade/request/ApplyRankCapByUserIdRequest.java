...
public class ApplyRankCapByUserIdRequest extends Gs2BasicRequest<ApplyRankCapByUserIdRequest> {
    ...
    public static ApplyRankCapByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
