...
public class GetWalletResult implements IResult, Serializable {
    private Wallet item;
	...
	public GetWalletResult withItem(Wallet item) {
		this.item = item;
		return this;
	}

    public static GetWalletResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
