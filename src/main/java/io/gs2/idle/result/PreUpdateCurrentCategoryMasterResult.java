...
public class PreUpdateCurrentCategoryMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentCategoryMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentCategoryMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentCategoryMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
