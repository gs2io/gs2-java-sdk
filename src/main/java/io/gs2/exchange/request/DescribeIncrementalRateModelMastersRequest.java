...
public class DescribeIncrementalRateModelMastersRequest extends Gs2BasicRequest<DescribeIncrementalRateModelMastersRequest> {
	...
	public DescribeIncrementalRateModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeIncrementalRateModelMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeIncrementalRateModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
