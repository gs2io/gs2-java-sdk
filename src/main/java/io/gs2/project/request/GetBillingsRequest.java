...
public class GetBillingsRequest extends Gs2BasicRequest<GetBillingsRequest> {
	...
	public GetBillingsRequest withYear(Integer year) {
		this.year = year;
		return this;
	}
	...
	public GetBillingsRequest withMonth(Integer month) {
		this.month = month;
		return this;
	}
    ...
    public static GetBillingsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
