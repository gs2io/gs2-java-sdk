...
public class SetTransactionDefaultConfigByUserIdResult implements IResult, Serializable {
	...
	public SetTransactionDefaultConfigByUserIdResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static SetTransactionDefaultConfigByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
