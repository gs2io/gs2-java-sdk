...
public class DescribeAcceptVersionsByUserIdResult implements IResult, Serializable {
	...
	public DescribeAcceptVersionsByUserIdResult withItems(List<AcceptVersion> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeAcceptVersionsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeAcceptVersionsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
