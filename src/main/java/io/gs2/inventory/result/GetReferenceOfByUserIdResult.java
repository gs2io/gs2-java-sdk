...
public class GetReferenceOfByUserIdResult implements IResult, Serializable {
	...
	public GetReferenceOfByUserIdResult withItemSet(ItemSet itemSet) {
		this.itemSet = itemSet;
		return this;
	}
	...
	public GetReferenceOfByUserIdResult withItemModel(ItemModel itemModel) {
		this.itemModel = itemModel;
		return this;
	}
	...
	public GetReferenceOfByUserIdResult withInventory(Inventory inventory) {
		this.inventory = inventory;
		return this;
	}

    public static GetReferenceOfByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
