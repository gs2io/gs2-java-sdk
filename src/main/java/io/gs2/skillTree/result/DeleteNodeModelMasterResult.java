...
public class DeleteNodeModelMasterResult implements IResult, Serializable {
	...
	public DeleteNodeModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteNodeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
