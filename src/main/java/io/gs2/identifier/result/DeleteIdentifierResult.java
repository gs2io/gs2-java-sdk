...
public class DeleteIdentifierResult implements IResult, Serializable {
	...
	public DeleteIdentifierResult withItem(Identifier item) {
		this.item = item;
		return this;
	}

    public static DeleteIdentifierResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
