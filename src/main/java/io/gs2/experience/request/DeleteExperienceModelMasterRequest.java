...
public class DeleteExperienceModelMasterRequest extends Gs2BasicRequest<DeleteExperienceModelMasterRequest> {
    ...
    public static DeleteExperienceModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
