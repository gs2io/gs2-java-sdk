...
public class DescribeRankingsIterator implements Iterator<Ranking>, Iterable<Ranking> {
    CacheDatabase cache;
    ...
    public DescribeRankingsIterator(
        CacheDatabase cache,
        Gs2RankingRestClient client,
        String namespaceName,
        String categoryName,
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeRankingsResult r = this.client.describeRankings(
