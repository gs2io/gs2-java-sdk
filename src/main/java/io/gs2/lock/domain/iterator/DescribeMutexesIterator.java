...
public class DescribeMutexesIterator implements Iterator<Mutex>, Iterable<Mutex> {
    CacheDatabase cache;
    ...
    public DescribeMutexesIterator(
        CacheDatabase cache,
        Gs2LockRestClient client,
        String namespaceName,
        AccessToken accessToken
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeMutexesResult r = this.client.describeMutexes(
