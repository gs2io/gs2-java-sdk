...
public class GetDashboardRequest extends Gs2BasicRequest<GetDashboardRequest> {
	...
	public GetDashboardRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
    ...
    public static GetDashboardRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
