...
public class ExecuteStampTaskLogCount implements IModel, Serializable {
    ...
    public static ExecuteStampTaskLogCount fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		ExecuteStampTaskLogCount other = (ExecuteStampTaskLogCount) o;
		if (service == null) {
