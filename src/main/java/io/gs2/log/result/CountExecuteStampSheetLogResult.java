...
public class CountExecuteStampSheetLogResult implements IResult, Serializable {
	...
	public CountExecuteStampSheetLogResult withItems(List<ExecuteStampSheetLogCount> items) {
		this.items = items;
		return this;
	}
    ...
    public static CountExecuteStampSheetLogResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new CountExecuteStampSheetLogResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<ExecuteStampSheetLogCount>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<ExecuteStampSheetLogCount>() :
