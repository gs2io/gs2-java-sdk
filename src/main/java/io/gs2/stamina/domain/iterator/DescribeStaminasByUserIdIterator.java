...
public class DescribeStaminasByUserIdIterator implements Iterator<Stamina>, Iterable<Stamina> {
    CacheDatabase cache;
    ...
    public DescribeStaminasByUserIdIterator(
        CacheDatabase cache,
        Gs2StaminaRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeStaminasByUserIdResult r = this.client.describeStaminasByUserId(
