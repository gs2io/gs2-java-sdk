...
public class AddExperienceByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public AddExperienceByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static AddExperienceByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
