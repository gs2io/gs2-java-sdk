...
public class PromoteSeniorMemberResult implements IResult, Serializable {
	...
	public PromoteSeniorMemberResult withItem(LastGuildMasterActivity item) {
		this.item = item;
		return this;
	}
	...
	public PromoteSeniorMemberResult withGuild(Guild guild) {
		this.guild = guild;
		return this;
	}

    public static PromoteSeniorMemberResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
