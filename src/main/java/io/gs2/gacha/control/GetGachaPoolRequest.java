...
public class GetGachaPoolRequest extends Gs2BasicRequest<GetGachaPoolRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "GetGachaPool";
	}
	 ...
	 * @return this
	 */
	public GetGachaPoolRequest withGachaPoolName(String gachaPoolName) {
