...
public class TriggerByStampSheetRequest extends Gs2BasicRequest<TriggerByStampSheetRequest> {
    ...
    public static TriggerByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
