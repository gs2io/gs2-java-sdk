...
public class DescribeGlobalMessageMastersRequest extends Gs2BasicRequest<DescribeGlobalMessageMastersRequest> {
	...
	public DescribeGlobalMessageMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeGlobalMessageMastersRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeGlobalMessageMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
