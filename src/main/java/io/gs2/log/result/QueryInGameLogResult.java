...
import io.gs2.log.model.InGameLog;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class QueryInGameLogResult implements IResult, Serializable {
    private List<InGameLog> items;
    private String nextPageToken;
    private Long totalCount;
    private Long scanSize;

	public List<InGameLog> getItems() {
		return items;
	}

	public void setItems(List<InGameLog> items) {
		this.items = items;
	}

	public QueryInGameLogResult withItems(List<InGameLog> items) {
		this.items = items;
		return this;
	}
	...
	public QueryInGameLogResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}
	...
	public QueryInGameLogResult withTotalCount(Long totalCount) {
		this.totalCount = totalCount;
		return this;
	}
	...
	public QueryInGameLogResult withScanSize(Long scanSize) {
		this.scanSize = scanSize;
		return this;
	}

    public static QueryInGameLogResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
