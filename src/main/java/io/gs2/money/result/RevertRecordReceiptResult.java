...
public class RevertRecordReceiptResult implements IResult, Serializable {
	...
	public RevertRecordReceiptResult withItem(Receipt item) {
		this.item = item;
		return this;
	}

    public static RevertRecordReceiptResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
