...
public class PrepareDownloadResult implements IResult, Serializable {
	...
	public PrepareDownloadResult withItem(DataObject item) {
		this.item = item;
		return this;
	}
	...
	public PrepareDownloadResult withFileUrl(String fileUrl) {
		this.fileUrl = fileUrl;
		return this;
	}
	...
	public PrepareDownloadResult withContentLength(Long contentLength) {
		this.contentLength = contentLength;
		return this;
	}

    public static PrepareDownloadResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
