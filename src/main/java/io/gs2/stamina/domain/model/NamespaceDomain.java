...
public class NamespaceDomain {
    ...
    public RecoverIntervalTableMasterDomain createRecoverIntervalTableMaster(
        CreateRecoverIntervalTableMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateRecoverIntervalTableMasterResult result = this.client.createRecoverIntervalTableMaster(
            request
        );
        ...
        RecoverIntervalTableMasterDomain domain = new RecoverIntervalTableMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public MaxStaminaTableMasterDomain createMaxStaminaTableMaster(
        CreateMaxStaminaTableMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateMaxStaminaTableMasterResult result = this.client.createMaxStaminaTableMaster(
            request
        );
        String parentKey = io.gs2.stamina.domain.model.NamespaceDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
        ...
        MaxStaminaTableMasterDomain domain = new MaxStaminaTableMasterDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public RecoverValueTableMasterDomain createRecoverValueTableMaster(
        CreateRecoverValueTableMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateRecoverValueTableMasterResult result = this.client.createRecoverValueTableMaster(
            request
        );
        String parentKey = io.gs2.stamina.domain.model.NamespaceDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
        ...
        RecoverValueTableMasterDomain domain = new RecoverValueTableMasterDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public StaminaModelMasterDomain createStaminaModelMaster(
        CreateStaminaModelMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateStaminaModelMasterResult result = this.client.createStaminaModelMaster(
            request
        );
        String parentKey = io.gs2.stamina.domain.model.NamespaceDomain.createCacheParentKey(
            this.namespaceName != null ? this.namespaceName.toString() : null,
        ...
        StaminaModelMasterDomain domain = new StaminaModelMasterDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public MaxStaminaTableDomain maxStaminaTable(
        String maxStaminaTableName
    ) {
        return new MaxStaminaTableDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public RecoverIntervalTableDomain recoverIntervalTable(
        String recoverIntervalTableName
    ) {
        return new RecoverIntervalTableDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public RecoverValueTableDomain recoverValueTable(
        String recoverValueTableName
    ) {
        return new RecoverValueTableDomain(
            this.cache,
            this.jobQueueDomain,
            this.stampSheetConfiguration,
            this.session,
    ...
    public StaminaModelDomain staminaModel(
        String staminaName
    ) {
    ...
    public RecoverIntervalTableMasterDomain recoverIntervalTableMaster(
        String recoverIntervalTableName
    ) {
    ...
    public MaxStaminaTableMasterDomain maxStaminaTableMaster(
        String maxStaminaTableName
    ) {
    ...
    public RecoverValueTableMasterDomain recoverValueTableMaster(
        String recoverValueTableName
    ) {
    ...
    public StaminaModelMasterDomain staminaModelMaster(
        String staminaName
    ) {
