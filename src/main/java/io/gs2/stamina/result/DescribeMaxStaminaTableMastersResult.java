...
public class DescribeMaxStaminaTableMastersResult implements IResult, Serializable {
	...
	public DescribeMaxStaminaTableMastersResult withItems(List<MaxStaminaTableMaster> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeMaxStaminaTableMastersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeMaxStaminaTableMastersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeMaxStaminaTableMastersResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<MaxStaminaTableMaster>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<MaxStaminaTableMaster>() :
