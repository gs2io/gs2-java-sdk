...
public class RejectResult implements IResult, Serializable {
	...
	public RejectResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static RejectResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
