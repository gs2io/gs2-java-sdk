...
public class CurrentParameterMaster implements IModel, Serializable, Comparable<CurrentParameterMaster> {
    ...
    public static CurrentParameterMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentParameterMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentParameterMaster other = (CurrentParameterMaster) o;
		if (namespaceId == null) {
