...
public class UnleashByUserIdResult implements IResult, Serializable {
	...
	public UnleashByUserIdResult withItem(UnleashRateModel item) {
		this.item = item;
		return this;
	}
	...
	public UnleashByUserIdResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public UnleashByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public UnleashByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static UnleashByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
