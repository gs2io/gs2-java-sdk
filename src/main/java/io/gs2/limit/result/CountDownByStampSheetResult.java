...
public class CountDownByStampSheetResult implements IResult, Serializable {
	...
	public CountDownByStampSheetResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static CountDownByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
