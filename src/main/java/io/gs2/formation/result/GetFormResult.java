...
public class GetFormResult implements IResult, Serializable {
    private Form item;
    private Mold mold;
	...
	public GetFormResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public GetFormResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public GetFormResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public GetFormResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static GetFormResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
