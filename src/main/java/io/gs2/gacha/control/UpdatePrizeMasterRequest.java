...
public class UpdatePrizeMasterRequest extends Gs2BasicRequest<UpdatePrizeMasterRequest> {

	public static class Constant extends Gs2Gacha.Constant {
		public static final String FUNCTION = "UpdatePrizeMaster";
	}
	 ...
	 * @return this
	 */
	public UpdatePrizeMasterRequest withGachaPoolName(String gachaPoolName) {
	 ...
	 * @return this
	 */
	public UpdatePrizeMasterRequest withPrizeTableName(String prizeTableName) {
	 ...
	 * @return this
	 */
	public UpdatePrizeMasterRequest withRarityName(String rarityName) {
	 ...
	 * @return this
	 */
	public UpdatePrizeMasterRequest withResourceId(String resourceId) {
	 ...
	 * @return this
	 */
	public UpdatePrizeMasterRequest withWeight(Integer weight) {
		setWeight(weight);
		return this;
	}
