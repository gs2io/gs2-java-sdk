...
public class GetLimitRequest extends Gs2BasicRequest<GetLimitRequest> {

	public static class Constant extends Gs2Limit.Constant {
		public static final String FUNCTION = "GetLimit";
	}
	 ...
	 * @return this
	 */
	public GetLimitRequest withLimitName(String limitName) {
