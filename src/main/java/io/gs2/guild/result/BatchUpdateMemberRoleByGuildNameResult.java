...
public class BatchUpdateMemberRoleByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public BatchUpdateMemberRoleByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static BatchUpdateMemberRoleByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
