...
public class DescribeSubscribesByCategoryNameResult implements IResult, Serializable {
	...
	public DescribeSubscribesByCategoryNameResult withItems(List<SubscribeUser> items) {
		this.items = items;
		return this;
	}

    public static DescribeSubscribesByCategoryNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
