...
public class VerifyStaminaOverflowValueRequest extends Gs2BasicRequest<VerifyStaminaOverflowValueRequest> {
	...
	public VerifyStaminaOverflowValueRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withStaminaName(String staminaName) {
		this.staminaName = staminaName;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withVerifyType(String verifyType) {
		this.verifyType = verifyType;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
	...
	public VerifyStaminaOverflowValueRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static VerifyStaminaOverflowValueRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
