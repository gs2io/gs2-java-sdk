...
public class GetSimpleItemWithSignatureResult implements IResult, Serializable {
	...
	public GetSimpleItemWithSignatureResult withItem(SimpleItem item) {
		this.item = item;
		return this;
	}
	...
	public GetSimpleItemWithSignatureResult withSimpleItemModel(SimpleItemModel simpleItemModel) {
		this.simpleItemModel = simpleItemModel;
		return this;
	}
	...
	public GetSimpleItemWithSignatureResult withBody(String body) {
		this.body = body;
		return this;
	}
	...
	public GetSimpleItemWithSignatureResult withSignature(String signature) {
		this.signature = signature;
		return this;
	}

    public static GetSimpleItemWithSignatureResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
