...
public class DoSeasonMatchmakingByUserIdResult implements IResult, Serializable {
	...
	public DoSeasonMatchmakingByUserIdResult withItem(SeasonGathering item) {
		this.item = item;
		return this;
	}
    ...
    public static DoSeasonMatchmakingByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
