...
public class GetGoldPoolRequest extends Gs2BasicRequest<GetGoldPoolRequest> {

	public static class Constant extends Gs2Gold.Constant {
		public static final String FUNCTION = "GetGoldPool";
	}
	 ...
	 * @return this
	 */
	public GetGoldPoolRequest withGoldPoolName(String goldPoolName) {
