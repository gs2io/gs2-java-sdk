...
public class DeleteAcceptVersionRequest extends Gs2BasicRequest<DeleteAcceptVersionRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName 承認したバージョンを削除
     */
     ...
     * 承認したバージョン名を設定
     *
     * @param versionName 承認したバージョンを削除
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider 承認したバージョンを削除
     */
