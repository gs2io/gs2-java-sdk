...
public class PutClusterRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public PutClusterRankingScoreByUserIdResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static PutClusterRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
