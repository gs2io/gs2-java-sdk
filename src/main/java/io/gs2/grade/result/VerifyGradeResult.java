...
public class VerifyGradeResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyGradeResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static VerifyGradeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
