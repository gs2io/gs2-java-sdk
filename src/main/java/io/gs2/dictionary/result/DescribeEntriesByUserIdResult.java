...
public class DescribeEntriesByUserIdResult implements IResult, Serializable {
	...
	public DescribeEntriesByUserIdResult withItems(List<Entry> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeEntriesByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeEntriesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
