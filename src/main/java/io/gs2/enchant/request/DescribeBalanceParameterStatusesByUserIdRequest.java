...
public class DescribeBalanceParameterStatusesByUserIdRequest extends Gs2BasicRequest<DescribeBalanceParameterStatusesByUserIdRequest> {
	...
	public DescribeBalanceParameterStatusesByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
	...
	public DescribeBalanceParameterStatusesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}

    public static DescribeBalanceParameterStatusesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
