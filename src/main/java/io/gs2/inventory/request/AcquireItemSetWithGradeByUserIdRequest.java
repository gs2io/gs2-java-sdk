...
public class AcquireItemSetWithGradeByUserIdRequest extends Gs2BasicRequest<AcquireItemSetWithGradeByUserIdRequest> {
    ...
    public static AcquireItemSetWithGradeByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
