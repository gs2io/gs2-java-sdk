...
public class EvaluateCompleteResult implements IResult, Serializable {
	...
	public EvaluateCompleteResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static EvaluateCompleteResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
