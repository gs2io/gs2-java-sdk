...
public class VerifyStaminaValueResult implements IResult, Serializable {
	...
	public VerifyStaminaValueResult withItem(Stamina item) {
		this.item = item;
		return this;
	}

    public static VerifyStaminaValueResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
