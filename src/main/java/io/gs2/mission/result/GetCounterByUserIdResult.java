...
public class GetCounterByUserIdResult implements IResult, Serializable {
	...
	public GetCounterByUserIdResult withItem(Counter item) {
		this.item = item;
		return this;
	}

    public static GetCounterByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
