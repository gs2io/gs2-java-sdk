...
public class SearchGuildsByUserIdResult implements IResult, Serializable {
	...
	public SearchGuildsByUserIdResult withItems(List<Guild> items) {
		this.items = items;
		return this;
	}
	...
	public SearchGuildsByUserIdResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static SearchGuildsByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new SearchGuildsByUserIdResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<Guild>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<Guild>() :
