...
public class UpdateCurrentIdleMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentIdleMasterFromGitHubRequest> {
	...
	public UpdateCurrentIdleMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentIdleMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
