...
public class VerifyBigItemByStampTaskResult implements IResult, Serializable {
	...
	public VerifyBigItemByStampTaskResult withItem(BigItem item) {
		this.item = item;
		return this;
	}
	...
	public VerifyBigItemByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyBigItemByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
