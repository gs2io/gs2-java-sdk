...
public class CreateStackResult implements IResult, Serializable {
    private Stack item;
	...
	public CreateStackResult withItem(Stack item) {
		this.item = item;
		return this;
	}

    public static CreateStackResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
