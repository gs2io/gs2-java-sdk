...
public class UpdateCurrentEntryMasterRequest extends Gs2BasicRequest<UpdateCurrentEntryMasterRequest> {
	...
	public UpdateCurrentEntryMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentEntryMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentEntryMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
