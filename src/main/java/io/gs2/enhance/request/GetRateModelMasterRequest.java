...
public class GetRateModelMasterRequest extends Gs2BasicRequest<GetRateModelMasterRequest> {
    ...
    public static GetRateModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
