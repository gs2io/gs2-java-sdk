...
public class DescribePrizeLimitsRequest extends Gs2BasicRequest<DescribePrizeLimitsRequest> {
	...
	public DescribePrizeLimitsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribePrizeLimitsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
