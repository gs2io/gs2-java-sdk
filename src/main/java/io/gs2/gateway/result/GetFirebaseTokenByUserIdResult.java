...
public class GetFirebaseTokenByUserIdResult implements IResult, Serializable {
	...
	public GetFirebaseTokenByUserIdResult withItem(FirebaseToken item) {
		this.item = item;
		return this;
	}

    public static GetFirebaseTokenByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
