...
public class ScopeValue implements IModel, Serializable {
	private String key;
	...
	public ScopeValue withValue(String value) {
		this.value = value;
		return this;
	}

    public static ScopeValue fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
