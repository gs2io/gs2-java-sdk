...
public class PreValidateResult implements IResult, Serializable {
	...
	public PreValidateResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreValidateResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreValidateResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
