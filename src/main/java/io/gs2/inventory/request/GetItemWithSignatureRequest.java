...
public class GetItemWithSignatureRequest extends Gs2BasicRequest<GetItemWithSignatureRequest> {
    ...
    public static GetItemWithSignatureRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
