...
public class DescribeSubscribesByRoomNameResult implements IResult, Serializable {
    ...
    public static DescribeSubscribesByRoomNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
