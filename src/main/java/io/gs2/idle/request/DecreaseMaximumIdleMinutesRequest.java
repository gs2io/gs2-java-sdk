...
public class DecreaseMaximumIdleMinutesRequest extends Gs2BasicRequest<DecreaseMaximumIdleMinutesRequest> {
	...
	public DecreaseMaximumIdleMinutesRequest withDecreaseMinutes(Integer decreaseMinutes) {
		this.decreaseMinutes = decreaseMinutes;
		return this;
	}
    ...
    public static DecreaseMaximumIdleMinutesRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
