...
public class SubExperienceByStampTaskResult implements IResult, Serializable {
    private Status item;
	...
	public SubExperienceByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
	...
	public SubExperienceByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static SubExperienceByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
