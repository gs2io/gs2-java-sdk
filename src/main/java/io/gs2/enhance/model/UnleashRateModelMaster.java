...
public class UnleashRateModelMaster implements IModel, Serializable, Comparable<UnleashRateModelMaster> {
	...
	public UnleashRateModelMaster withGradeEntries(List<UnleashRateEntryModel> gradeEntries) {
		this.gradeEntries = gradeEntries;
		return this;
	}
    ...
    public static UnleashRateModelMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(UnleashRateModelMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		UnleashRateModelMaster other = (UnleashRateModelMaster) o;
