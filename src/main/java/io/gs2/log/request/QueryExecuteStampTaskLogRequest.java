...
public class QueryExecuteStampTaskLogRequest extends Gs2BasicRequest<QueryExecuteStampTaskLogRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName スタンプタスク実行ログの一覧を取得
     */
     ...
     * マイクロサービスの種類を設定
     *
     * @param service スタンプタスク実行ログの一覧を取得
     */
     ...
     * マイクロサービスのメソッドを設定
     *
     * @param method スタンプタスク実行ログの一覧を取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId スタンプタスク実行ログの一覧を取得
     */
     ...
     * 報酬アクションを設定
     *
     * @param action スタンプタスク実行ログの一覧を取得
     */
     ...
     *
     * @param longTerm スタンプタスク実行ログの一覧を取得
     */
     ...
     * @return this
     */
    public QueryExecuteStampTaskLogRequest withLongTerm(Boolean longTerm) {
     ...
     *
     * @param pageToken スタンプタスク実行ログの一覧を取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプタスク実行ログの一覧を取得
     */
