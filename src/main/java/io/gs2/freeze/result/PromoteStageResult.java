...
public class PromoteStageResult implements IResult, Serializable {
    private Stage item;
	...
	public PromoteStageResult withItem(Stage item) {
		this.item = item;
		return this;
	}

    public static PromoteStageResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
