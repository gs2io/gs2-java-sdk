...
public class DeleteGradeModelMasterResult implements IResult, Serializable {
	...
	public DeleteGradeModelMasterResult withItem(GradeModelMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteGradeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
