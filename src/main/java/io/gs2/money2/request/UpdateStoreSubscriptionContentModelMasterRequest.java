...
public class UpdateStoreSubscriptionContentModelMasterRequest extends Gs2BasicRequest<UpdateStoreSubscriptionContentModelMasterRequest> {
	...
	public UpdateStoreSubscriptionContentModelMasterRequest withTriggerExtendMode(String triggerExtendMode) {
		this.triggerExtendMode = triggerExtendMode;
		return this;
	}
	...
	public UpdateStoreSubscriptionContentModelMasterRequest withRollupHour(Integer rollupHour) {
		this.rollupHour = rollupHour;
		return this;
	}
