...
public class RevertReceiveByStampSheetResult implements IResult, Serializable {
	...
	public RevertReceiveByStampSheetResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static RevertReceiveByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
