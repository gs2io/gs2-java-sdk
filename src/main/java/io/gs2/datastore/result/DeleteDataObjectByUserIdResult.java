...
public class DeleteDataObjectByUserIdResult implements IResult, Serializable {
	...
	public DeleteDataObjectByUserIdResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static DeleteDataObjectByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
