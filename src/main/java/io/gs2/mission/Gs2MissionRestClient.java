...
public class Gs2MissionRestClient extends AbstractGs2Client<Gs2MissionRestClient> {
    ...
    class PreUpdateCurrentMissionMasterTask extends Gs2RestSessionTask<PreUpdateCurrentMissionMasterResult> {
        private PreUpdateCurrentMissionMasterRequest request;

        public PreUpdateCurrentMissionMasterTask(
            PreUpdateCurrentMissionMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentMissionMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentMissionMasterResult parse(JsonNode data) {
            return PreUpdateCurrentMissionMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentMissionMasterAsync(
            PreUpdateCurrentMissionMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentMissionMasterResult>> callback
    ) {
        PreUpdateCurrentMissionMasterTask task = new PreUpdateCurrentMissionMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentMissionMasterResult preUpdateCurrentMissionMaster(
            PreUpdateCurrentMissionMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentMissionMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentMissionMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentMissionMasterTask extends Gs2RestSessionTask<UpdateCurrentMissionMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentMissionMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentMissionMasterTask task = new PreUpdateCurrentMissionMasterTask(
