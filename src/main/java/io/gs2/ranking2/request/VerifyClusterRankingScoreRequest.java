...
public class VerifyClusterRankingScoreRequest extends Gs2BasicRequest<VerifyClusterRankingScoreRequest> {
	...
	public VerifyClusterRankingScoreRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyClusterRankingScoreRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
