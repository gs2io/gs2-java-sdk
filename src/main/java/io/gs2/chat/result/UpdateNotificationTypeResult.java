...
public class UpdateNotificationTypeResult implements IResult, Serializable {
	...
	public UpdateNotificationTypeResult withItem(Subscribe item) {
		this.item = item;
		return this;
	}

    public static UpdateNotificationTypeResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
