...
public class AcquireActionToPropertyFormPropertiesByStampSheetResult implements IResult, Serializable {
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public AcquireActionToPropertyFormPropertiesByStampSheetResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static AcquireActionToPropertyFormPropertiesByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
