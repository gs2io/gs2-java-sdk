...
public class ReceiveGlobalMessageByUserIdRequest extends Gs2BasicRequest<ReceiveGlobalMessageByUserIdRequest> {
	...
	public ReceiveGlobalMessageByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static ReceiveGlobalMessageByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
