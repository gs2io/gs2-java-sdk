...
public class AddRankCapByStampSheetResult implements IResult, Serializable {
    private Status item;
	...
	public AddRankCapByStampSheetResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static AddRankCapByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
