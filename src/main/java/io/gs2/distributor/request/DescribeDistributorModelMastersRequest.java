...
public class DescribeDistributorModelMastersRequest extends Gs2BasicRequest<DescribeDistributorModelMastersRequest> {
	...
	public DescribeDistributorModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
    ...
    public static DescribeDistributorModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
