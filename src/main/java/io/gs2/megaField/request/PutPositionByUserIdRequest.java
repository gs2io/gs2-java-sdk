...
public class PutPositionByUserIdRequest extends Gs2BasicRequest<PutPositionByUserIdRequest> {
	...
	public PutPositionByUserIdRequest withPosition(Position position) {
		this.position = position;
		return this;
	}
	...
	public PutPositionByUserIdRequest withVector(Vector vector) {
		this.vector = vector;
		return this;
	}
	public Float getR() {
    ...
    public static PutPositionByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
