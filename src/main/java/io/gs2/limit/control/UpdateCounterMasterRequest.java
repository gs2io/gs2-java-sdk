...
public class UpdateCounterMasterRequest extends Gs2BasicRequest<UpdateCounterMasterRequest> {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withLimitName(String limitName) {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withCounterName(String counterName) {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withMax(Integer max) {
		setMax(max);
		return this;
	}
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withResetType(String resetType) {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withResetDayOfMonth(Integer resetDayOfMonth) {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withResetDayOfWeek(String resetDayOfWeek) {
	 ...
	 * @return this
	 */
	public UpdateCounterMasterRequest withResetHour(Integer resetHour) {
