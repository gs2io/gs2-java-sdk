...
public class CurrentMissionMaster implements IModel, Serializable, Comparable<CurrentMissionMaster> {
    ...
    public static CurrentMissionMaster fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(CurrentMissionMaster o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		CurrentMissionMaster other = (CurrentMissionMaster) o;
		if (namespaceId == null) {
