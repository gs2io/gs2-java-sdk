...
public class UpdateQuestModelMasterResult implements IResult, Serializable {
	...
	public UpdateQuestModelMasterResult withItem(QuestModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateQuestModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
