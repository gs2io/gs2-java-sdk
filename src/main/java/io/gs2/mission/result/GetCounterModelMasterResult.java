...
public class GetCounterModelMasterResult implements IResult, Serializable {
	...
	public GetCounterModelMasterResult withItem(CounterModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetCounterModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
