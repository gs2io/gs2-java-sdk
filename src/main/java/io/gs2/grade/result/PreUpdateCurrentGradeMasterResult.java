...
public class PreUpdateCurrentGradeMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentGradeMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentGradeMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentGradeMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
