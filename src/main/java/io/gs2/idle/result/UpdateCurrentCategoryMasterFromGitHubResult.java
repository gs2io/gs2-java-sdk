...
public class UpdateCurrentCategoryMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentCategoryMasterFromGitHubResult withItem(CurrentCategoryMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentCategoryMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
