...
public class UpdatePropertyFormModelMasterResult implements IResult, Serializable {
	...
	public UpdatePropertyFormModelMasterResult withItem(PropertyFormModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdatePropertyFormModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
