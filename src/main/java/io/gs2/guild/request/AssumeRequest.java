...
public class AssumeRequest extends Gs2BasicRequest<AssumeRequest> {
	...
	public AssumeRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public AssumeRequest withAccessToken(String accessToken) {
		this.accessToken = accessToken;
		return this;
	}
	...
	public AssumeRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public AssumeRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}
	...
	public AssumeRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static AssumeRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
