...
public class UnleashByUserIdRequest extends Gs2BasicRequest<UnleashByUserIdRequest> {
	...
	public UnleashByUserIdRequest withMaterials(List<String> materials) {
		this.materials = materials;
		return this;
	}
	...
	public UnleashByUserIdRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static UnleashByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
