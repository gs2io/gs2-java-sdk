...
public class UpdateTakeOverByUserIdResult implements IResult, Serializable {
	...
	public UpdateTakeOverByUserIdResult withItem(TakeOver item) {
		this.item = item;
		return this;
	}

    public static UpdateTakeOverByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
