...
public class DeleteDeadLetterJobByUserIdResult implements IResult, Serializable {
	...
	public DeleteDeadLetterJobByUserIdResult withItem(DeadLetterJob item) {
		this.item = item;
		return this;
	}

    public static DeleteDeadLetterJobByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
