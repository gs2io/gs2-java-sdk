...
public class IssueOnceResult implements IResult, Serializable {
	...
	public IssueOnceResult withItem(SerialKey item) {
		this.item = item;
		return this;
	}

    public static IssueOnceResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
