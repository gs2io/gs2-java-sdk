...
public class GetCurrentRatingModelMasterResult implements IResult, Serializable {
	...
	public GetCurrentRatingModelMasterResult withItem(CurrentRatingModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetCurrentRatingModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
