...
public class MarkReceivedRequest extends Gs2BasicRequest<MarkReceivedRequest> {
	...
	public MarkReceivedRequest withStepNumber(Integer stepNumber) {
		this.stepNumber = stepNumber;
		return this;
	}
    ...
    public static MarkReceivedRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
