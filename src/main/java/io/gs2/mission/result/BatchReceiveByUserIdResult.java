...
public class BatchReceiveByUserIdResult implements IResult, Serializable {
	...
	public BatchReceiveByUserIdResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static BatchReceiveByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
