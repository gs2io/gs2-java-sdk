...
public class IncreaseMaximumIdleMinutesByUserIdRequest extends Gs2BasicRequest<IncreaseMaximumIdleMinutesByUserIdRequest> {
	...
	public Integer getIncreaseMinutes() {
		return increaseMinutes;
	}
	public void setIncreaseMinutes(Integer increaseMinutes) {
		this.increaseMinutes = increaseMinutes;
	}
	public IncreaseMaximumIdleMinutesByUserIdRequest withIncreaseMinutes(Integer increaseMinutes) {
		this.increaseMinutes = increaseMinutes;
		return this;
	}
    ...
    public static IncreaseMaximumIdleMinutesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
