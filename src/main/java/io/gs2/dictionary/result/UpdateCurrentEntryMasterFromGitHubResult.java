...
public class UpdateCurrentEntryMasterFromGitHubResult implements IResult, Serializable {
    ...
    public static UpdateCurrentEntryMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
