...
public class GetLevelTableMasterRequest extends Gs2BasicRequest<GetLevelTableMasterRequest> {

	public static class Constant extends Gs2Level.Constant {
		public static final String FUNCTION = "GetLevelTableMaster";
	}
	 ...
	 * @return this
	 */
	public GetLevelTableMasterRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public GetLevelTableMasterRequest withLevelTableName(String levelTableName) {
