...
public class ExecuteStampSheetLogDomain {
    ...
    public ExecuteStampSheetLog model() {
        ExecuteStampSheetLog value = cache.get(
            parentKey,
            io.gs2.log.domain.model.ExecuteStampSheetLogDomain.createCacheKey(
            ),
            ExecuteStampSheetLog.class
        );
        return value;
    }
