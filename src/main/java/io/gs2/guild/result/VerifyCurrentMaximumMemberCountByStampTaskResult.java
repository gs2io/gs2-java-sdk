...
public class VerifyCurrentMaximumMemberCountByStampTaskResult implements IResult, Serializable {
	...
	public VerifyCurrentMaximumMemberCountByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyCurrentMaximumMemberCountByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
