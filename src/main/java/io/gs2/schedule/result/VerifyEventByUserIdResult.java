...
public class VerifyEventByUserIdResult implements IResult, Serializable {
    private Event item;
	...
	public VerifyEventByUserIdResult withItem(Event item) {
		this.item = item;
		return this;
	}
	...
	public VerifyEventByUserIdResult withInSchedule(Boolean inSchedule) {
		this.inSchedule = inSchedule;
		return this;
	}
	...
	public VerifyEventByUserIdResult withScheduleStartAt(Long scheduleStartAt) {
		this.scheduleStartAt = scheduleStartAt;
		return this;
	}
	...
	public VerifyEventByUserIdResult withScheduleEndAt(Long scheduleEndAt) {
		this.scheduleEndAt = scheduleEndAt;
		return this;
	}
	...
	public VerifyEventByUserIdResult withRepeatSchedule(RepeatSchedule repeatSchedule) {
		this.repeatSchedule = repeatSchedule;
		return this;
	}
	...
	public VerifyEventByUserIdResult withIsGlobalSchedule(Boolean isGlobalSchedule) {
		this.isGlobalSchedule = isGlobalSchedule;
		return this;
	}

    public static VerifyEventByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
