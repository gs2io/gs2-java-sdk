...
public class DeleteMessageByStampTaskResult implements IResult, Serializable {
	...
	public DeleteMessageByStampTaskResult withItem(Message item) {
		this.item = item;
		return this;
	}
	...
	public DeleteMessageByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static DeleteMessageByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
