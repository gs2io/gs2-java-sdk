...
public class DeleteGatheringResult implements IResult, Serializable {
	...
	public DeleteGatheringResult withItem(Gathering item) {
		this.item = item;
		return this;
	}

    public static DeleteGatheringResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
