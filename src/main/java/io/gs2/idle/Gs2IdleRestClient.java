...
public class Gs2IdleRestClient extends AbstractGs2Client<Gs2IdleRestClient> {
    ...
    class PreUpdateCurrentCategoryMasterTask extends Gs2RestSessionTask<PreUpdateCurrentCategoryMasterResult> {
        private PreUpdateCurrentCategoryMasterRequest request;

        public PreUpdateCurrentCategoryMasterTask(
            PreUpdateCurrentCategoryMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentCategoryMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentCategoryMasterResult parse(JsonNode data) {
            return PreUpdateCurrentCategoryMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentCategoryMasterAsync(
            PreUpdateCurrentCategoryMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentCategoryMasterResult>> callback
    ) {
        PreUpdateCurrentCategoryMasterTask task = new PreUpdateCurrentCategoryMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentCategoryMasterResult preUpdateCurrentCategoryMaster(
            PreUpdateCurrentCategoryMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentCategoryMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentCategoryMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentCategoryMasterTask extends Gs2RestSessionTask<UpdateCurrentCategoryMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentCategoryMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentCategoryMasterTask task = new PreUpdateCurrentCategoryMasterTask(
