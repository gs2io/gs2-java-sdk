...
public class DeleteMemberByGuildNameRequest extends Gs2BasicRequest<DeleteMemberByGuildNameRequest> {
	...
	public DeleteMemberByGuildNameRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteMemberByGuildNameRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}
	...
	public DeleteMemberByGuildNameRequest withGuildName(String guildName) {
		this.guildName = guildName;
		return this;
	}
	...
	public DeleteMemberByGuildNameRequest withTargetUserId(String targetUserId) {
		this.targetUserId = targetUserId;
		return this;
	}
	...
	public DeleteMemberByGuildNameRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeleteMemberByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
