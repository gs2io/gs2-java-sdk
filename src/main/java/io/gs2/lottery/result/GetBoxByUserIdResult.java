...
public class GetBoxByUserIdResult implements IResult, Serializable {
	...
	public GetBoxByUserIdResult withItem(BoxItems item) {
		this.item = item;
		return this;
	}

    public static GetBoxByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
