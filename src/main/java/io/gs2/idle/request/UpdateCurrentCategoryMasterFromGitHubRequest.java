...
import io.gs2.idle.model.GitHubCheckoutSetting;

@SuppressWarnings("serial")
@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdateCurrentCategoryMasterFromGitHubRequest extends Gs2BasicRequest<UpdateCurrentCategoryMasterFromGitHubRequest> {
	...
	public UpdateCurrentCategoryMasterFromGitHubRequest withCheckoutSetting(GitHubCheckoutSetting checkoutSetting) {
		this.checkoutSetting = checkoutSetting;
		return this;
	}

    public static UpdateCurrentCategoryMasterFromGitHubRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
