...
public class ReDrawRarityParameterStatusByStampSheetResult implements IResult, Serializable {
	...
	public ReDrawRarityParameterStatusByStampSheetResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}
	...
	public ReDrawRarityParameterStatusByStampSheetResult withOld(RarityParameterStatus old) {
		this.old = old;
		return this;
	}

    public static ReDrawRarityParameterStatusByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
