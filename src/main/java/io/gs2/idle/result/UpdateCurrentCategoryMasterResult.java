...
public class UpdateCurrentCategoryMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentCategoryMasterResult withItem(CurrentCategoryMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentCategoryMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
