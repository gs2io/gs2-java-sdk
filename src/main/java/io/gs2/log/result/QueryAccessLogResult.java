...
public class QueryAccessLogResult implements IResult, Serializable {
	...
	public QueryAccessLogResult withItems(List<AccessLog> items) {
		this.items = items;
		return this;
	}
	...
	public QueryAccessLogResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}
	...
	public QueryAccessLogResult withTotalCount(Long totalCount) {
		this.totalCount = totalCount;
		return this;
	}
	...
	public QueryAccessLogResult withScanSize(Long scanSize) {
		this.scanSize = scanSize;
		return this;
	}

    public static QueryAccessLogResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new QueryAccessLogResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<AccessLog>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<AccessLog>() :
