...
package io.gs2.datastore.domain;
...
import io.gs2.datastore.domain.model.*;
...
public class Gs2Datastore {
    ...
    public NamespaceDomain createNamespace(
        ...
        String parentKey = "datastore:Namespace";
                
        if (result.getItem() != null) {
            cache.put(
                parentKey,
                io.gs2.datastore.domain.model.NamespaceDomain.createCacheKey(
