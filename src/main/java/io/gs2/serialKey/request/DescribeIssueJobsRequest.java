...
public class DescribeIssueJobsRequest extends Gs2BasicRequest<DescribeIssueJobsRequest> {
	...
	public DescribeIssueJobsRequest withCampaignModelName(String campaignModelName) {
		this.campaignModelName = campaignModelName;
		return this;
	}
	...
	public DescribeIssueJobsRequest withPageToken(String pageToken) {
		this.pageToken = pageToken;
		return this;
	}
	...
	public DescribeIssueJobsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeIssueJobsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
