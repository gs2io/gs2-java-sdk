...
public class CreateProgressByStampSheetRequest extends Gs2BasicRequest<CreateProgressByStampSheetRequest> {
     ...
     * スタンプシートを設定
     *
     * @param stampSheet スタンプシートでクエストを開始
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider スタンプシートでクエストを開始
     */
