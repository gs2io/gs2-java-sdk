...
public class GetGradeModelRequest extends Gs2BasicRequest<GetGradeModelRequest> {
	...
	public GetGradeModelRequest withGradeName(String gradeName) {
		this.gradeName = gradeName;
		return this;
	}

    public static GetGradeModelRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
