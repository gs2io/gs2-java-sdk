...
public class GetByUserIdAndTransactionIdResult implements IResult, Serializable {
	...
	public GetByUserIdAndTransactionIdResult withItem(Receipt item) {
		this.item = item;
		return this;
	}

    public static GetByUserIdAndTransactionIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
