...
public class GetScoreResult implements IResult, Serializable {
    private Score item;
	...
	public GetScoreResult withItem(Score item) {
		this.item = item;
		return this;
	}

    public static GetScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
