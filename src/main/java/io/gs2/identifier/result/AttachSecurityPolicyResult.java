...
public class AttachSecurityPolicyResult implements IResult, Serializable {
	...
	public AttachSecurityPolicyResult withItems(List<SecurityPolicy> items) {
		this.items = items;
		return this;
	}

    public static AttachSecurityPolicyResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
