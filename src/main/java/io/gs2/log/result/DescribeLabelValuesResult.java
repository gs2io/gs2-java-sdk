...
public class DescribeLabelValuesResult implements IResult, Serializable {
	...
	public DescribeLabelValuesResult withItems(List<Label> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeLabelValuesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeLabelValuesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
