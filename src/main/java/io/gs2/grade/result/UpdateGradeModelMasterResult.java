...
public class UpdateGradeModelMasterResult implements IResult, Serializable {
	...
	public UpdateGradeModelMasterResult withItem(GradeModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateGradeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
