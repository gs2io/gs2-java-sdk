...
public class DescribeBillingMethodsResult implements IResult, Serializable {
	...
	public DescribeBillingMethodsResult withItems(List<BillingMethod> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeBillingMethodsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeBillingMethodsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeBillingMethodsResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<BillingMethod>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<BillingMethod>() :
