...
public class UpdateCategoryModelMasterResult implements IResult, Serializable {
	...
	public UpdateCategoryModelMasterResult withItem(CategoryModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCategoryModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
