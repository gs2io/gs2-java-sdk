...
public class VerifyRankCapByStampTaskResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyRankCapByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
    ...
    public static VerifyRankCapByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
