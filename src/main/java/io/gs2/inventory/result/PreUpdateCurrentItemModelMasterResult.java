...
public class PreUpdateCurrentItemModelMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentItemModelMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentItemModelMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentItemModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
