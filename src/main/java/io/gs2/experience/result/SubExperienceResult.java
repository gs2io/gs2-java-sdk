...
public class SubExperienceResult implements IResult, Serializable {
    private Status item;
	...
	public SubExperienceResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static SubExperienceResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
