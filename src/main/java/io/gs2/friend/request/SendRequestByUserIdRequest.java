...
public class SendRequestByUserIdRequest extends Gs2BasicRequest<SendRequestByUserIdRequest> {
     ...
     * ネームスペース名を取得
     *
     * @return ユーザーIDを指定してフレンドリクエストを送信
     */
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定してフレンドリクエストを送信
     */
     ...
     * リクエストの送信元ユーザIDを設定
     *
     * @param userId ユーザーIDを指定してフレンドリクエストを送信
     */
     ...
     * リクエストの送信先ユーザIDを設定
     *
     * @param targetUserId ユーザーIDを指定してフレンドリクエストを送信
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定してフレンドリクエストを送信
     */
