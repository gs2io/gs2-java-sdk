...
public class DescribeScoresResult implements IResult, Serializable {
	...
	public DescribeScoresResult withItems(List<Score> items) {
		this.items = items;
		return this;
	}
    ...
    public static DescribeScoresResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
