...
public class VerifyTriggerByStampTaskResult implements IResult, Serializable {
	...
	public VerifyTriggerByStampTaskResult withItem(Trigger item) {
		this.item = item;
		return this;
	}
	...
	public VerifyTriggerByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifyTriggerByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
