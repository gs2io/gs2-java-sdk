...
public class SubscribeByUserIdRequest extends Gs2BasicRequest<SubscribeByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザIDを指定してユーザIDを購読
     */
     ...
     * カテゴリ名を設定
     *
     * @param categoryName ユーザIDを指定してユーザIDを購読
     */
     ...
     * 購読するユーザIDを設定
     *
     * @param userId ユーザIDを指定してユーザIDを購読
     */
     ...
     * 購読されるユーザIDを設定
     *
     * @param targetUserId ユーザIDを指定してユーザIDを購読
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザIDを指定してユーザIDを購読
     */
