...
public class RunStampSheetExpressWithoutNamespaceResult implements IResult, Serializable {
	...
	public RunStampSheetExpressWithoutNamespaceResult withVerifyTaskResultCodes(List<Integer> verifyTaskResultCodes) {
		this.verifyTaskResultCodes = verifyTaskResultCodes;
		return this;
	}
	...
	public RunStampSheetExpressWithoutNamespaceResult withVerifyTaskResults(List<String> verifyTaskResults) {
		this.verifyTaskResults = verifyTaskResults;
		return this;
	}
