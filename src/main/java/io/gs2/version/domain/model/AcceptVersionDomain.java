...
public class AcceptVersionDomain {
    ...
    public AcceptVersionDomain accept(
        ...
        AcceptByUserIdResult result = this.client.acceptByUserId(
            request
        );
    ...
    private AcceptVersion get(
        ...
        request
            ...
            .withUserId(this.userId)
            .withVersionName(this.versionName);
        GetAcceptVersionByUserIdResult result = this.client.getAcceptVersionByUserId(
            request
        );
    ...
    public AcceptVersionDomain delete(
        ...
        try {
            result = this.client.deleteAcceptVersionByUserId(
                request
            );
