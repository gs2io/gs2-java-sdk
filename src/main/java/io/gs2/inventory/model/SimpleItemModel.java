...
public class SimpleItemModel implements IModel, Serializable, Comparable<SimpleItemModel> {
    ...
    public static SimpleItemModel fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
	...
	@Override
	public int compareTo(SimpleItemModel o) {
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SimpleItemModel other = (SimpleItemModel) o;
		if (itemModelId == null) {
