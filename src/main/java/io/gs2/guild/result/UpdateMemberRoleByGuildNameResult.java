...
public class UpdateMemberRoleByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public UpdateMemberRoleByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static UpdateMemberRoleByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
