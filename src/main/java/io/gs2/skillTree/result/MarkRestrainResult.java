...
public class MarkRestrainResult implements IResult, Serializable {
    private Status item;
	...
	public MarkRestrainResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static MarkRestrainResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
