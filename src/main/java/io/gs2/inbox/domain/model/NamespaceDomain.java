...
public class NamespaceDomain {
    ...
    public NamespaceDomain(
        ...
        this.parentKey = "inbox:Namespace";
    }
    ...
    public GlobalMessageMasterDomain createGlobalMessageMaster(
        CreateGlobalMessageMasterRequest request
    ) {
        request
            .withNamespaceName(this.namespaceName);
        CreateGlobalMessageMasterResult result = this.client.createGlobalMessageMaster(
            request
        );
        ...
        GlobalMessageMasterDomain domain = new GlobalMessageMasterDomain(
            this.cache,
            this.jobQueueDomain,
    ...
    public CurrentMessageMasterDomain currentMessageMaster(
    ) {
    ...
    public GlobalMessageDomain globalMessage(
    ...
    public GlobalMessageMasterDomain globalMessageMaster(
        String globalMessageName
    ) {
