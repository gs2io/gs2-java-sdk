...
public class MarkReceivedByUserIdResult implements IResult, Serializable {
	...
	public MarkReceivedByUserIdResult withItem(ReceiveStatus item) {
		this.item = item;
		return this;
	}
	...
	public MarkReceivedByUserIdResult withBonusModel(BonusModel bonusModel) {
		this.bonusModel = bonusModel;
		return this;
	}

    public static MarkReceivedByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
