...
public class UpdateCurrentShowcaseMasterRequest extends Gs2BasicRequest<UpdateCurrentShowcaseMasterRequest> {
	...
	public UpdateCurrentShowcaseMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentShowcaseMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentShowcaseMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
