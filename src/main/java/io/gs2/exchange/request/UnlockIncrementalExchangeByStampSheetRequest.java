...
public class UnlockIncrementalExchangeByStampSheetRequest extends Gs2BasicRequest<UnlockIncrementalExchangeByStampSheetRequest> {
    ...
    public static UnlockIncrementalExchangeByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
