...
public class ConsumeStaminaResult implements IResult, Serializable {
	...
	public ConsumeStaminaResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public ConsumeStaminaResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static ConsumeStaminaResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
