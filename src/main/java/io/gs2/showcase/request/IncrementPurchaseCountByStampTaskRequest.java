...
public class IncrementPurchaseCountByStampTaskRequest extends Gs2BasicRequest<IncrementPurchaseCountByStampTaskRequest> {
    ...
    public static IncrementPurchaseCountByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
