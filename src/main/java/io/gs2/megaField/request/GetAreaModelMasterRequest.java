...
public class GetAreaModelMasterRequest extends Gs2BasicRequest<GetAreaModelMasterRequest> {
	...
	public GetAreaModelMasterRequest withAreaModelName(String areaModelName) {
		this.areaModelName = areaModelName;
		return this;
	}

    public static GetAreaModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
