...
public class DeletePropertyFormByUserIdResult implements IResult, Serializable {
	...
	public DeletePropertyFormByUserIdResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
	...
	public DeletePropertyFormByUserIdResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static DeletePropertyFormByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
