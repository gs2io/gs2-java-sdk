...
public class GetCompleteResult implements IResult, Serializable {
	...
	public GetCompleteResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static GetCompleteResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
