...
public class UpdateRandomShowcaseMasterResult implements IResult, Serializable {
	...
	public UpdateRandomShowcaseMasterResult withItem(RandomShowcaseMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateRandomShowcaseMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
