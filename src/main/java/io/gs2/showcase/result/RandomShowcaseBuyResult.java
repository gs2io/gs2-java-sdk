...
public class RandomShowcaseBuyResult implements IResult, Serializable {
	...
	public RandomShowcaseBuyResult withItem(RandomDisplayItem item) {
		this.item = item;
		return this;
	}
	...
	public RandomShowcaseBuyResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public RandomShowcaseBuyResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public RandomShowcaseBuyResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public RandomShowcaseBuyResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public RandomShowcaseBuyResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public RandomShowcaseBuyResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public RandomShowcaseBuyResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static RandomShowcaseBuyResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
