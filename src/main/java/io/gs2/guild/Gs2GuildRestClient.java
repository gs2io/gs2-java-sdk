...
public class Gs2GuildRestClient extends AbstractGs2Client<Gs2GuildRestClient> {
    ...
    class DecreaseMaximumCurrentMaximumMemberCountTask extends Gs2RestSessionTask<DecreaseMaximumCurrentMaximumMemberCountResult> {
        private DecreaseMaximumCurrentMaximumMemberCountRequest request;

        public DecreaseMaximumCurrentMaximumMemberCountTask(
            DecreaseMaximumCurrentMaximumMemberCountRequest request,
            AsyncAction<AsyncResult<DecreaseMaximumCurrentMaximumMemberCountResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public DecreaseMaximumCurrentMaximumMemberCountResult parse(JsonNode data) {
            return DecreaseMaximumCurrentMaximumMemberCountResult.fromJson(data);
        }
    ...
    public void decreaseMaximumCurrentMaximumMemberCountAsync(
            DecreaseMaximumCurrentMaximumMemberCountRequest request,
            AsyncAction<AsyncResult<DecreaseMaximumCurrentMaximumMemberCountResult>> callback
    ) {
        DecreaseMaximumCurrentMaximumMemberCountTask task = new DecreaseMaximumCurrentMaximumMemberCountTask(request, callback);
        session.execute(task);
    }

    public DecreaseMaximumCurrentMaximumMemberCountResult decreaseMaximumCurrentMaximumMemberCount(
            DecreaseMaximumCurrentMaximumMemberCountRequest request
    ) {
        final AsyncResult<DecreaseMaximumCurrentMaximumMemberCountResult>[] resultAsyncResult = new AsyncResult[]{null};
        decreaseMaximumCurrentMaximumMemberCountAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class PreUpdateCurrentGuildMasterTask extends Gs2RestSessionTask<PreUpdateCurrentGuildMasterResult> {
        private PreUpdateCurrentGuildMasterRequest request;

        public PreUpdateCurrentGuildMasterTask(
            PreUpdateCurrentGuildMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentGuildMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentGuildMasterResult parse(JsonNode data) {
            return PreUpdateCurrentGuildMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentGuildMasterAsync(
            PreUpdateCurrentGuildMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentGuildMasterResult>> callback
    ) {
        PreUpdateCurrentGuildMasterTask task = new PreUpdateCurrentGuildMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentGuildMasterResult preUpdateCurrentGuildMaster(
            PreUpdateCurrentGuildMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentGuildMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentGuildMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentGuildMasterTask extends Gs2RestSessionTask<UpdateCurrentGuildMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentGuildMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentGuildMasterTask task = new PreUpdateCurrentGuildMasterTask(
