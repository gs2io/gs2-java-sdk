...
public class DeleteGuildByGuildNameResult implements IResult, Serializable {
    private Guild item;
	...
	public DeleteGuildByGuildNameResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static DeleteGuildByGuildNameResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
