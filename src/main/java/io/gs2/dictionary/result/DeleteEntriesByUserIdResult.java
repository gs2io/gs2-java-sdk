...
public class DeleteEntriesByUserIdResult implements IResult, Serializable {
	...
	public DeleteEntriesByUserIdResult withItems(List<Entry> items) {
		this.items = items;
		return this;
	}

    public static DeleteEntriesByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
