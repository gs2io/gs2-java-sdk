...
public class ApplyStaminaByUserIdResult implements IResult, Serializable {
	...
	public ApplyStaminaByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public ApplyStaminaByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static ApplyStaminaByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
