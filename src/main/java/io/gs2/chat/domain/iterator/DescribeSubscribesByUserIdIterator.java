...
public class DescribeSubscribesByUserIdIterator implements Iterator<Subscribe>, Iterable<Subscribe> {
    CacheDatabase cache;
    ...
    public DescribeSubscribesByUserIdIterator(
        CacheDatabase cache,
        Gs2ChatRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeSubscribesByUserIdResult r = this.client.describeSubscribesByUserId(
