...
public class GetAwaitByUserIdResult implements IResult, Serializable {
    private Await item;
	...
	public GetAwaitByUserIdResult withItem(Await item) {
		this.item = item;
		return this;
	}

    public static GetAwaitByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
