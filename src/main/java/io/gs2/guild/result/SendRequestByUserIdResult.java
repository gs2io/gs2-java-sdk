...
public class SendRequestByUserIdResult implements IResult, Serializable {
    private Guild item;
	...
	public SendRequestByUserIdResult withItem(Guild item) {
		this.item = item;
		return this;
	}
	...
	public SendRequestByUserIdResult withSendMemberRequest(SendMemberRequest sendMemberRequest) {
		this.sendMemberRequest = sendMemberRequest;
		return this;
	}

    public static SendRequestByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new SendRequestByUserIdResult()
            .withItem(data.get("item") == null || data.get("item").isNull() ? null : Guild.fromJson(data.get("item")))
            .withSendMemberRequest(data.get("sendMemberRequest") == null || data.get("sendMemberRequest").isNull() ? null : SendMemberRequest.fromJson(data.get("sendMemberRequest")));
    }
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                ...
                put("sendMemberRequest", getSendMemberRequest() != null ? getSendMemberRequest().toJson() : null);
            }}
        );
    }
}