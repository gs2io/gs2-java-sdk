...
public class TakeoverSubscriptionStatusByUserIdResult implements IResult, Serializable {
	...
	public TakeoverSubscriptionStatusByUserIdResult withItem(SubscriptionStatus item) {
		this.item = item;
		return this;
	}

    public static TakeoverSubscriptionStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
