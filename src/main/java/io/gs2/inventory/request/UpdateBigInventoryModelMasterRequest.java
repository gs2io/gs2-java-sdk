...
public class UpdateBigInventoryModelMasterRequest extends Gs2BasicRequest<UpdateBigInventoryModelMasterRequest> {
    ...
    public static UpdateBigInventoryModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
