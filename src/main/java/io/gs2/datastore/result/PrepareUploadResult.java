...
public class PrepareUploadResult implements IResult, Serializable {
	...
	public PrepareUploadResult withItem(DataObject item) {
		this.item = item;
		return this;
	}
	...
	public PrepareUploadResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PrepareUploadResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
