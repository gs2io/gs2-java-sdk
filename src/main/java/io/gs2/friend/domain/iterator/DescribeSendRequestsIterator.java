...
public class DescribeSendRequestsIterator implements Iterator<FriendRequest>, Iterable<FriendRequest> {
    CacheDatabase cache;
    ...
    public DescribeSendRequestsIterator(
        CacheDatabase cache,
        Gs2FriendRestClient client,
        String namespaceName,
        AccessToken accessToken
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeSendRequestsResult r = this.client.describeSendRequests(
