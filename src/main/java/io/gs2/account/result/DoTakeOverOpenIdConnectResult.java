...
public class DoTakeOverOpenIdConnectResult implements IResult, Serializable {
	...
	public DoTakeOverOpenIdConnectResult withItem(Account item) {
		this.item = item;
		return this;
	}

    public static DoTakeOverOpenIdConnectResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
