...
public class DescribeWebSocketSessionsByUserIdIterator implements Iterator<WebSocketSession>, Iterable<WebSocketSession> {
    CacheDatabase cache;
    ...
    public DescribeWebSocketSessionsByUserIdIterator(
        CacheDatabase cache,
        Gs2GatewayRestClient client,
        String namespaceName,
        String userId
    ...
    private void load() {
        ...
        if (this.cache.isListCached(
            ...
            DescribeWebSocketSessionsByUserIdResult r = this.client.describeWebSocketSessionsByUserId(
