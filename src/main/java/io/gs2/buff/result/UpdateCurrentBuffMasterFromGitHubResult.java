...
public class UpdateCurrentBuffMasterFromGitHubResult implements IResult, Serializable {
	...
	public UpdateCurrentBuffMasterFromGitHubResult withItem(CurrentBuffMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentBuffMasterFromGitHubResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
