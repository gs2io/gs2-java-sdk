...
public class UnregisterBlackListByUserIdRequest extends Gs2BasicRequest<UnregisterBlackListByUserIdRequest> {
	...
	public UnregisterBlackListByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
    ...
    public static UnregisterBlackListByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
