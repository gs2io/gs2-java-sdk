...
public class SetPropertyFormByUserIdResult implements IResult, Serializable {
	...
	public SetPropertyFormByUserIdResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
	...
	public SetPropertyFormByUserIdResult withPropertyFormModel(PropertyFormModel propertyFormModel) {
		this.propertyFormModel = propertyFormModel;
		return this;
	}

    public static SetPropertyFormByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
