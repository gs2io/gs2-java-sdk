...
public class VerifyStaminaRecoverValueRequest extends Gs2BasicRequest<VerifyStaminaRecoverValueRequest> {
	...
	public VerifyStaminaRecoverValueRequest withValue(Integer value) {
		this.value = value;
		return this;
	}
	...
	public VerifyStaminaRecoverValueRequest withMultiplyValueSpecifyingQuantity(Boolean multiplyValueSpecifyingQuantity) {
		this.multiplyValueSpecifyingQuantity = multiplyValueSpecifyingQuantity;
		return this;
	}
    ...
    public static VerifyStaminaRecoverValueRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
