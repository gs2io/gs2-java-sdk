...
public class Gs2FormationRestClient extends AbstractGs2Client<Gs2FormationRestClient> {
    ...
    class PreUpdateCurrentFormMasterTask extends Gs2RestSessionTask<PreUpdateCurrentFormMasterResult> {
        private PreUpdateCurrentFormMasterRequest request;

        public PreUpdateCurrentFormMasterTask(
            PreUpdateCurrentFormMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentFormMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentFormMasterResult parse(JsonNode data) {
            return PreUpdateCurrentFormMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentFormMasterAsync(
            PreUpdateCurrentFormMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentFormMasterResult>> callback
    ) {
        PreUpdateCurrentFormMasterTask task = new PreUpdateCurrentFormMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentFormMasterResult preUpdateCurrentFormMaster(
            PreUpdateCurrentFormMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentFormMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentFormMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentFormMasterTask extends Gs2RestSessionTask<UpdateCurrentFormMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentFormMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentFormMasterTask task = new PreUpdateCurrentFormMasterTask(
