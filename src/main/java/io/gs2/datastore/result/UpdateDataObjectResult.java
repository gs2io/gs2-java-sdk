...
public class UpdateDataObjectResult implements IResult, Serializable {
	...
	public UpdateDataObjectResult withItem(DataObject item) {
		this.item = item;
		return this;
	}

    public static UpdateDataObjectResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
