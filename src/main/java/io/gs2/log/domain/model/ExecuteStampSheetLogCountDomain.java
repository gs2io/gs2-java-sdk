...
public class ExecuteStampSheetLogCountDomain {
    ...
    public ExecuteStampSheetLogCount model() {
        ExecuteStampSheetLogCount value = cache.get(
            parentKey,
            io.gs2.log.domain.model.ExecuteStampSheetLogCountDomain.createCacheKey(
            ),
            ExecuteStampSheetLogCount.class
        );
        return value;
    }
