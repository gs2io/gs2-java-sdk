...
public class PredictionResult implements IResult, Serializable {
	...
	public PredictionResult withItems(List<AcquireAction> items) {
		this.items = items;
		return this;
	}
	...
	public PredictionResult withStatus(Status status) {
		this.status = status;
		return this;
	}

    public static PredictionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
