...
public class VerifyItemSetByStampTaskRequest extends Gs2BasicRequest<VerifyItemSetByStampTaskRequest> {
    ...
    public static VerifyItemSetByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
