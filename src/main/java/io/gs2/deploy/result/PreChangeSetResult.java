...
public class PreChangeSetResult implements IResult, Serializable {
	...
	public PreChangeSetResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreChangeSetResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreChangeSetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
