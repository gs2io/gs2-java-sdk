...
public class RaiseMaxValueByStampSheetResult implements IResult, Serializable {
	...
	public RaiseMaxValueByStampSheetResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public RaiseMaxValueByStampSheetResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static RaiseMaxValueByStampSheetResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
