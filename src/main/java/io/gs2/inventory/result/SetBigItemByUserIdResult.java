...
public class SetBigItemByUserIdResult implements IResult, Serializable {
	...
	public SetBigItemByUserIdResult withItem(BigItem item) {
		this.item = item;
		return this;
	}

    public static SetBigItemByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
