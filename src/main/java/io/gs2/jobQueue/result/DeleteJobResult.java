...
public class DeleteJobResult implements IResult, Serializable {
    private Job item;
	...
	public DeleteJobResult withItem(Job item) {
		this.item = item;
		return this;
	}

    public static DeleteJobResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
