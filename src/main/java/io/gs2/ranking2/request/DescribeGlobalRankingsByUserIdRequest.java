...
public class DescribeGlobalRankingsByUserIdRequest extends Gs2BasicRequest<DescribeGlobalRankingsByUserIdRequest> {
	...
	public DescribeGlobalRankingsByUserIdRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}
    ...
    public static DescribeGlobalRankingsByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
