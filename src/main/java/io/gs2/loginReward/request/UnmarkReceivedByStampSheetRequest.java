...
public class UnmarkReceivedByStampSheetRequest extends Gs2BasicRequest<UnmarkReceivedByStampSheetRequest> {
    ...
    public static UnmarkReceivedByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
