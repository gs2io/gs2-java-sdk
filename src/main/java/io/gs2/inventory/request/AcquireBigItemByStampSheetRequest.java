...
public class AcquireBigItemByStampSheetRequest extends Gs2BasicRequest<AcquireBigItemByStampSheetRequest> {
    ...
    public static AcquireBigItemByStampSheetRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
