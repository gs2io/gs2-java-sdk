...
public class VerifySimpleItemByStampTaskResult implements IResult, Serializable {
	...
	public VerifySimpleItemByStampTaskResult withItem(SimpleItem item) {
		this.item = item;
		return this;
	}
	...
	public VerifySimpleItemByStampTaskResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static VerifySimpleItemByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
