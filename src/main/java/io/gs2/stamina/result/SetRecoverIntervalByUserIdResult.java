...
public class SetRecoverIntervalByUserIdResult implements IResult, Serializable {
	...
	public SetRecoverIntervalByUserIdResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public SetRecoverIntervalByUserIdResult withOld(Stamina old) {
		this.old = old;
		return this;
	}
	...
	public SetRecoverIntervalByUserIdResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static SetRecoverIntervalByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
