...
public class DeleteRecoverValueTableMasterResult implements IResult, Serializable {
	...
	public DeleteRecoverValueTableMasterResult withItem(RecoverValueTableMaster item) {
		this.item = item;
		return this;
	}

    public static DeleteRecoverValueTableMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
