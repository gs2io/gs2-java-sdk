...
public class DeleteGuildByGuildNameRequest extends Gs2BasicRequest<DeleteGuildByGuildNameRequest> {
    ...
    public static DeleteGuildByGuildNameRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
