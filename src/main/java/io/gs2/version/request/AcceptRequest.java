...
public class AcceptRequest extends Gs2BasicRequest<AcceptRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName 現在のバージョンを承認
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider 現在のバージョンを承認
     */
