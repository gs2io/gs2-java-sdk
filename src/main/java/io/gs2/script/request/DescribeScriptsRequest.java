...
public class DescribeScriptsRequest extends Gs2BasicRequest<DescribeScriptsRequest> {
	...
	public DescribeScriptsRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
	...
	public DescribeScriptsRequest withLimit(Integer limit) {
		this.limit = limit;
		return this;
	}

    public static DescribeScriptsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
