...
public class GetTransactionResultResult implements IResult, Serializable {
	...
	public GetTransactionResultResult withItem(TransactionResult item) {
		this.item = item;
		return this;
	}

    public static GetTransactionResultResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
