...
public class GetPropertyFormWithSignatureByUserIdResult implements IResult, Serializable {
	...
	public GetPropertyFormWithSignatureByUserIdResult withItem(PropertyForm item) {
		this.item = item;
		return this;
	}
    ...
    public static GetPropertyFormWithSignatureByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
