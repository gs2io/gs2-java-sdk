...
public class UpdateAreaModelMasterRequest extends Gs2BasicRequest<UpdateAreaModelMasterRequest> {
    ...
    public static UpdateAreaModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
