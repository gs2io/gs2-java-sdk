...
public class BatchReadMessagesResult implements IResult, Serializable {
	...
	public BatchReadMessagesResult withItems(List<Message> items) {
		this.items = items;
		return this;
	}
	...
	public BatchReadMessagesResult withTransactionId(String transactionId) {
		this.transactionId = transactionId;
		return this;
	}
	...
	public BatchReadMessagesResult withStampSheet(String stampSheet) {
		this.stampSheet = stampSheet;
		return this;
	}
	...
	public BatchReadMessagesResult withStampSheetEncryptionKeyId(String stampSheetEncryptionKeyId) {
		this.stampSheetEncryptionKeyId = stampSheetEncryptionKeyId;
		return this;
	}
	...
	public BatchReadMessagesResult withAutoRunStampSheet(Boolean autoRunStampSheet) {
		this.autoRunStampSheet = autoRunStampSheet;
		return this;
	}
	...
	public BatchReadMessagesResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public BatchReadMessagesResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public BatchReadMessagesResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}

    public static BatchReadMessagesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
