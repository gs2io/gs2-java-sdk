...
public class VerifyRankCapByUserIdResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyRankCapByUserIdResult withItem(Status item) {
		this.item = item;
		return this;
	}

    public static VerifyRankCapByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
