...
public class GetClusterRankingModelMasterResult implements IResult, Serializable {
	...
	public GetClusterRankingModelMasterResult withItem(ClusterRankingModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetClusterRankingModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
