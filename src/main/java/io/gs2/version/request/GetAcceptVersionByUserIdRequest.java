...
public class GetAcceptVersionByUserIdRequest extends Gs2BasicRequest<GetAcceptVersionByUserIdRequest> {
     ...
     * ネームスペース名を設定
     *
     * @param namespaceName ユーザーIDを指定して承認したバージョンを取得
     */
     ...
     * ユーザーIDを設定
     *
     * @param userId ユーザーIDを指定して承認したバージョンを取得
     */
     ...
     * 承認したバージョン名を設定
     *
     * @param versionName ユーザーIDを指定して承認したバージョンを取得
     */
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param duplicationAvoider ユーザーIDを指定して承認したバージョンを取得
     */
