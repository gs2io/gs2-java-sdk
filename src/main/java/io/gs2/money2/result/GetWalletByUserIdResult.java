...
public class GetWalletByUserIdResult implements IResult, Serializable {
    private Wallet item;
	...
	public GetWalletByUserIdResult withItem(Wallet item) {
		this.item = item;
		return this;
	}

    public static GetWalletByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
