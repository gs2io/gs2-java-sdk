...
public class VerifyClusterRankingScoreResult implements IResult, Serializable {
	...
	public VerifyClusterRankingScoreResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static VerifyClusterRankingScoreResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
