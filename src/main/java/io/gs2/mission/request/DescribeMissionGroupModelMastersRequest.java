...
public class DescribeMissionGroupModelMastersRequest extends Gs2BasicRequest<DescribeMissionGroupModelMastersRequest> {
	...
	public DescribeMissionGroupModelMastersRequest withNamePrefix(String namePrefix) {
		this.namePrefix = namePrefix;
		return this;
	}
    ...
    public static DescribeMissionGroupModelMastersRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
