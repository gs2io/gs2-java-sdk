...
public class QueryTimeseriesResult implements IResult, Serializable {
	...
	public QueryTimeseriesResult withItems(List<TimeseriesPoint> items) {
		this.items = items;
		return this;
	}
	...
	public QueryTimeseriesResult withTimeseriesMetadata(TimeseriesMetadata timeseriesMetadata) {
		this.timeseriesMetadata = timeseriesMetadata;
		return this;
	}
	...
	public QueryTimeseriesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static QueryTimeseriesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
