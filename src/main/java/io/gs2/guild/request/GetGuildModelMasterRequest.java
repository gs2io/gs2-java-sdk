...
public class GetGuildModelMasterRequest extends Gs2BasicRequest<GetGuildModelMasterRequest> {
	...
	public GetGuildModelMasterRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public GetGuildModelMasterRequest withGuildModelName(String guildModelName) {
		this.guildModelName = guildModelName;
		return this;
	}

    public static GetGuildModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
