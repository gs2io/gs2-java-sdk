...
public class UpdateNodeModelMasterResult implements IResult, Serializable {
	...
	public UpdateNodeModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateNodeModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
