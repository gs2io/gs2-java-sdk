...
public class BuyByUserIdResult implements IResult, Serializable {
	...
	public BuyByUserIdResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public BuyByUserIdResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public BuyByUserIdResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}
