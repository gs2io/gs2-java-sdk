...
public class Gs2BuffRestClient extends AbstractGs2Client<Gs2BuffRestClient> {
    ...
    class PreUpdateCurrentBuffMasterTask extends Gs2RestSessionTask<PreUpdateCurrentBuffMasterResult> {
        private PreUpdateCurrentBuffMasterRequest request;

        public PreUpdateCurrentBuffMasterTask(
            PreUpdateCurrentBuffMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentBuffMasterResult>> userCallback
        ) {
            super(
                    (Gs2RestSession) session,
                    userCallback
        ...
        @Override
        public PreUpdateCurrentBuffMasterResult parse(JsonNode data) {
            return PreUpdateCurrentBuffMasterResult.fromJson(data);
        }
    ...
    public void preUpdateCurrentBuffMasterAsync(
            PreUpdateCurrentBuffMasterRequest request,
            AsyncAction<AsyncResult<PreUpdateCurrentBuffMasterResult>> callback
    ) {
        PreUpdateCurrentBuffMasterTask task = new PreUpdateCurrentBuffMasterTask(request, callback);
        session.execute(task);
    }

    public PreUpdateCurrentBuffMasterResult preUpdateCurrentBuffMaster(
            PreUpdateCurrentBuffMasterRequest request
    ) {
        final AsyncResult<PreUpdateCurrentBuffMasterResult>[] resultAsyncResult = new AsyncResult[]{null};
        preUpdateCurrentBuffMasterAsync(
                request,
                result -> resultAsyncResult[0] = result
        );
        while (resultAsyncResult[0] == null) {
    ...
    class UpdateCurrentBuffMasterTask extends Gs2RestSessionTask<UpdateCurrentBuffMasterResult> {
        ...
        protected void executeImpl() {
            if (request.getSettings() != null) {
                AtomicReference<AsyncResult<PreUpdateCurrentBuffMasterResult>> resultAsyncResult = new AtomicReference<>();
                PreUpdateCurrentBuffMasterTask task = new PreUpdateCurrentBuffMasterTask(
