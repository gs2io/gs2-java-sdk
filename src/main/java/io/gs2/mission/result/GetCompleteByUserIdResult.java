...
public class GetCompleteByUserIdResult implements IResult, Serializable {
	...
	public GetCompleteByUserIdResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static GetCompleteByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
