...
public class PreUpdateCurrentFormMasterResult implements IResult, Serializable {
	...
	public PreUpdateCurrentFormMasterResult withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}
	...
	public PreUpdateCurrentFormMasterResult withUploadUrl(String uploadUrl) {
		this.uploadUrl = uploadUrl;
		return this;
	}

    public static PreUpdateCurrentFormMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
