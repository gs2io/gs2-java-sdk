...
public class DescribeShowcaseMastersResult implements IResult, Serializable {
	...
	public DescribeShowcaseMastersResult withItems(List<ShowcaseMaster> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeShowcaseMastersResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeShowcaseMastersResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
        return new DescribeShowcaseMastersResult()
            .withItems(data.get("items") == null || data.get("items").isNull() ? new ArrayList<ShowcaseMaster>() :
    ...
    public JsonNode toJson() {
        return new ObjectMapper().valueToTree(
            new HashMap<String, Object>() {{
                put("items", getItems() == null ? new ArrayList<ShowcaseMaster>() :
