...
public class MultiplyAcquireActionsByStampSheetResult implements IResult, Serializable {
	...
	public MultiplyAcquireActionsByStampSheetResult withAtomicCommit(Boolean atomicCommit) {
		this.atomicCommit = atomicCommit;
		return this;
	}
	...
	public MultiplyAcquireActionsByStampSheetResult withTransaction(String transaction) {
		this.transaction = transaction;
		return this;
	}
	...
	public MultiplyAcquireActionsByStampSheetResult withTransactionResult(io.gs2.core.model.TransactionResult transactionResult) {
		this.transactionResult = transactionResult;
		return this;
	}
