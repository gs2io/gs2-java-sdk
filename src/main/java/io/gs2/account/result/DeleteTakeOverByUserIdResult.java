...
public class DeleteTakeOverByUserIdResult implements IResult, Serializable {
	...
	public DeleteTakeOverByUserIdResult withItem(TakeOver item) {
		this.item = item;
		return this;
	}

    public static DeleteTakeOverByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
