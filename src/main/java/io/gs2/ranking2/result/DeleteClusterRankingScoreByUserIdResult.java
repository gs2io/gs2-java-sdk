...
public class DeleteClusterRankingScoreByUserIdResult implements IResult, Serializable {
	...
	public DeleteClusterRankingScoreByUserIdResult withItem(ClusterRankingScore item) {
		this.item = item;
		return this;
	}

    public static DeleteClusterRankingScoreByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
