...
public class GetCategoryModelMasterRequest extends Gs2BasicRequest<GetCategoryModelMasterRequest> {
	...
	public GetCategoryModelMasterRequest withCategory(Integer category) {
		this.category = category;
		return this;
	}

    public static GetCategoryModelMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
