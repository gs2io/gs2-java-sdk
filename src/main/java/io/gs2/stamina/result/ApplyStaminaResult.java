...
public class ApplyStaminaResult implements IResult, Serializable {
	...
	public ApplyStaminaResult withItem(Stamina item) {
		this.item = item;
		return this;
	}
	...
	public ApplyStaminaResult withStaminaModel(StaminaModel staminaModel) {
		this.staminaModel = staminaModel;
		return this;
	}

    public static ApplyStaminaResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
