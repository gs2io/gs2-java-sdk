...
public class VerifyRankByStampTaskResult implements IResult, Serializable {
    private Status item;
	...
	public VerifyRankByStampTaskResult withItem(Status item) {
		this.item = item;
		return this;
	}
    ...
    public static VerifyRankByStampTaskResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
