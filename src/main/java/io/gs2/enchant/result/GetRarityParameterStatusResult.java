...
public class GetRarityParameterStatusResult implements IResult, Serializable {
	...
	public GetRarityParameterStatusResult withItem(RarityParameterStatus item) {
		this.item = item;
		return this;
	}

    public static GetRarityParameterStatusResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
