...
public class DeleteLikesByUserIdRequest extends Gs2BasicRequest<DeleteLikesByUserIdRequest> {
	...
	public DeleteLikesByUserIdRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DeleteLikesByUserIdRequest withUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	public DeleteLikesByUserIdRequest withEntryModelNames(List<String> entryModelNames) {
		this.entryModelNames = entryModelNames;
		return this;
	}
	...
	public DeleteLikesByUserIdRequest withTimeOffsetToken(String timeOffsetToken) {
		this.timeOffsetToken = timeOffsetToken;
		return this;
	}
	...
	public DeleteLikesByUserIdRequest withDuplicationAvoider(String duplicationAvoider) {
		this.duplicationAvoider = duplicationAvoider;
		return this;
	}

    public static DeleteLikesByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
