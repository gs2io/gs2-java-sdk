...
public class ReDrawBalanceParameterStatusByUserIdResult implements IResult, Serializable {
	...
	public ReDrawBalanceParameterStatusByUserIdResult withItem(BalanceParameterStatus item) {
		this.item = item;
		return this;
	}
	...
	public ReDrawBalanceParameterStatusByUserIdResult withOld(BalanceParameterStatus old) {
		this.old = old;
		return this;
	}

    public static ReDrawBalanceParameterStatusByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
