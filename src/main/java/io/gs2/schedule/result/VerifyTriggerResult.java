...
public class VerifyTriggerResult implements IResult, Serializable {
	...
	public VerifyTriggerResult withItem(Trigger item) {
		this.item = item;
		return this;
	}

    public static VerifyTriggerResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
