...
public class FreezeMasterDataByUserIdResult implements IResult, Serializable {
	...
	public FreezeMasterDataByUserIdResult withNewContextStack(String newContextStack) {
		this.newContextStack = newContextStack;
		return this;
	}

    public static FreezeMasterDataByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
