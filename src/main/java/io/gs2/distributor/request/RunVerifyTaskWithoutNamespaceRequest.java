...
public class RunVerifyTaskWithoutNamespaceRequest extends Gs2BasicRequest<RunVerifyTaskWithoutNamespaceRequest> {
    ...
    public static RunVerifyTaskWithoutNamespaceRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
