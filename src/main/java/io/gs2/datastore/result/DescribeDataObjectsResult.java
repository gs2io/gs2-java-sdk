...
public class DescribeDataObjectsResult implements IResult, Serializable {
	...
	public DescribeDataObjectsResult withItems(List<DataObject> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeDataObjectsResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeDataObjectsResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
