...
public class AddFriendByUserIdResult implements IResult, Serializable {
	...
	public AddFriendByUserIdResult withItem(FriendUser item) {
		this.item = item;
		return this;
	}

    public static AddFriendByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
