...
public class EvaluateCompleteByUserIdResult implements IResult, Serializable {
	...
	public EvaluateCompleteByUserIdResult withItem(Complete item) {
		this.item = item;
		return this;
	}

    public static EvaluateCompleteByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
