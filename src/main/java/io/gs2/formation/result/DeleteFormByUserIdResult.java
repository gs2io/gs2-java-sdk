...
public class DeleteFormByUserIdResult implements IResult, Serializable {
	...
	public DeleteFormByUserIdResult withItem(Form item) {
		this.item = item;
		return this;
	}
	...
	public DeleteFormByUserIdResult withMold(Mold mold) {
		this.mold = mold;
		return this;
	}
	...
	public DeleteFormByUserIdResult withMoldModel(MoldModel moldModel) {
		this.moldModel = moldModel;
		return this;
	}
	...
	public DeleteFormByUserIdResult withFormModel(FormModel formModel) {
		this.formModel = formModel;
		return this;
	}

    public static DeleteFormByUserIdResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
