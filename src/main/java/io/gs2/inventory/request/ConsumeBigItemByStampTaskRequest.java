...
public class ConsumeBigItemByStampTaskRequest extends Gs2BasicRequest<ConsumeBigItemByStampTaskRequest> {
    ...
    public static ConsumeBigItemByStampTaskRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
