...
public class ReDrawBalanceParameterStatusByUserIdRequest extends Gs2BasicRequest<ReDrawBalanceParameterStatusByUserIdRequest> {
	...
	public ReDrawBalanceParameterStatusByUserIdRequest withFixedParameterNames(List<String> fixedParameterNames) {
		this.fixedParameterNames = fixedParameterNames;
		return this;
	}
    ...
    public static ReDrawBalanceParameterStatusByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
