...
public class RandomShowcaseBuyByUserIdRequest extends Gs2BasicRequest<RandomShowcaseBuyByUserIdRequest> {
	...
	public RandomShowcaseBuyByUserIdRequest withQuantity(Integer quantity) {
		this.quantity = quantity;
		return this;
	}
	...
	public RandomShowcaseBuyByUserIdRequest withConfig(List<Config> config) {
		this.config = config;
		return this;
	}
    ...
    public static RandomShowcaseBuyByUserIdRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
