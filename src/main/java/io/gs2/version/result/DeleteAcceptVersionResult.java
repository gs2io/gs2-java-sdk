...
public class DeleteAcceptVersionResult implements IResult, Serializable {
	...
	public DeleteAcceptVersionResult withItem(AcceptVersion item) {
		this.item = item;
		return this;
	}

    public static DeleteAcceptVersionResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
