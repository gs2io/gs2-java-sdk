...
public class DescribeLayerModelsRequest extends Gs2BasicRequest<DescribeLayerModelsRequest> {
	...
	public DescribeLayerModelsRequest withNamespaceName(String namespaceName) {
		this.namespaceName = namespaceName;
		return this;
	}
	...
	public DescribeLayerModelsRequest withAreaModelName(String areaModelName) {
		this.areaModelName = areaModelName;
		return this;
	}

    public static DescribeLayerModelsRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
