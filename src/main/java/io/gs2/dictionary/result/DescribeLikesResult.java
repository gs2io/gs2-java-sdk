...
public class DescribeLikesResult implements IResult, Serializable {
	...
	public DescribeLikesResult withItems(List<Like> items) {
		this.items = items;
		return this;
	}
	...
	public DescribeLikesResult withNextPageToken(String nextPageToken) {
		this.nextPageToken = nextPageToken;
		return this;
	}

    public static DescribeLikesResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
