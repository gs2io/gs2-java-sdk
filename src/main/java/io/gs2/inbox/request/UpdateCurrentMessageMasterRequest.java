...
public class UpdateCurrentMessageMasterRequest extends Gs2BasicRequest<UpdateCurrentMessageMasterRequest> {
	...
	public UpdateCurrentMessageMasterRequest withMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public UpdateCurrentMessageMasterRequest withUploadToken(String uploadToken) {
		this.uploadToken = uploadToken;
		return this;
	}

    public static UpdateCurrentMessageMasterRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
