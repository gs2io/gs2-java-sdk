...
public class AddBanRequest extends Gs2BasicRequest<AddBanRequest> {
	...
	public AddBanRequest withBanStatus(BanStatus banStatus) {
		this.banStatus = banStatus;
		return this;
	}
    ...
    public static AddBanRequest fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
