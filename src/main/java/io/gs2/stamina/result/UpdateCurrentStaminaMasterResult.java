...
public class UpdateCurrentStaminaMasterResult implements IResult, Serializable {
	...
	public UpdateCurrentStaminaMasterResult withItem(CurrentStaminaMaster item) {
		this.item = item;
		return this;
	}

    public static UpdateCurrentStaminaMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
