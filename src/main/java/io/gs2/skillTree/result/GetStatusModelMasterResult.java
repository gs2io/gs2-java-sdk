...
public class GetStatusModelMasterResult implements IResult, Serializable {
	...
	public GetStatusModelMasterResult withItem(NodeModelMaster item) {
		this.item = item;
		return this;
	}

    public static GetStatusModelMasterResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
