...
public class DeleteGuildResult implements IResult, Serializable {
    private Guild item;
	...
	public DeleteGuildResult withItem(Guild item) {
		this.item = item;
		return this;
	}

    public static DeleteGuildResult fromJson(JsonNode data) {
        if (data == null) {
            return null;
        }
